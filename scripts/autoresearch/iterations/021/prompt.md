# Composite Alpha Researcher — Iteration 21
...
backtester). You are attempt **21** of at most 200.
...
```python
COMPOSITE_ID = "auto_021"      # exact string, do not change
