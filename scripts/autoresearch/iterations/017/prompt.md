# Composite Alpha Researcher — Iteration 17
...
backtester). You are attempt **17** of at most 200.
...
```python
COMPOSITE_ID = "auto_017"      # exact string, do not change
