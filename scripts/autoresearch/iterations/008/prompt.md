# Composite Alpha Researcher — Iteration 8
...
backtester). You are attempt **8** of at most 200.
...
```python
COMPOSITE_ID = "auto_008"      # exact string, do not change
