# Composite Alpha Researcher — Iteration 11
...
backtester). You are attempt **11** of at most 200.
...
```python
COMPOSITE_ID = "auto_011"      # exact string, do not change
