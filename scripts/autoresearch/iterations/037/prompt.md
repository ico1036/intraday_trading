# Composite Alpha Researcher — Iteration 37
...
backtester). You are attempt **37** of at most 200.
...
```python
COMPOSITE_ID = "auto_037"      # exact string, do not change
