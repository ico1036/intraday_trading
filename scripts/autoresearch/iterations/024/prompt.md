# Composite Alpha Researcher — Iteration 24
...
backtester). You are attempt **24** of at most 200.
...
```python
COMPOSITE_ID = "auto_024"      # exact string, do not change
