# Composite Alpha Researcher — Iteration 73
...
backtester). You are attempt **73** of at most 200.
...
```python
COMPOSITE_ID = "auto_073"      # exact string, do not change
