# Composite Alpha Researcher — Iteration 36
...
backtester). You are attempt **36** of at most 200.
...
```python
COMPOSITE_ID = "auto_036"      # exact string, do not change
