# Composite Alpha Researcher — Iteration 97
...
backtester). You are attempt **97** of at most 200.
...
```python
COMPOSITE_ID = "auto_097"      # exact string, do not change
