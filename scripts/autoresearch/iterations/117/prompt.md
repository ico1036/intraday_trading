# Composite Alpha Researcher — Iteration 117
...
backtester). You are attempt **117** of at most 200.
...
```python
COMPOSITE_ID = "auto_117"      # exact string, do not change
