# Composite Alpha Researcher — Iteration 7
...
backtester). You are attempt **7** of at most 200.
...
```python
COMPOSITE_ID = "auto_007"      # exact string, do not change
