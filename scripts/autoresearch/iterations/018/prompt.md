# Composite Alpha Researcher — Iteration 18
...
backtester). You are attempt **18** of at most 200.
...
```python
COMPOSITE_ID = "auto_018"      # exact string, do not change
