# Composite Alpha Researcher — Iteration 26
...
backtester). You are attempt **26** of at most 200.
...
```python
COMPOSITE_ID = "auto_026"      # exact string, do not change
