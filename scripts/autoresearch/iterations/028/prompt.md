# Composite Alpha Researcher — Iteration 28
...
backtester). You are attempt **28** of at most 200.
...
```python
COMPOSITE_ID = "auto_028"      # exact string, do not change
