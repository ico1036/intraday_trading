# Composite Alpha Researcher — Iteration 9
...
backtester). You are attempt **9** of at most 200.
...
```python
COMPOSITE_ID = "auto_009"      # exact string, do not change
