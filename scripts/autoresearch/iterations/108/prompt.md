# Composite Alpha Researcher — Iteration 108
...
backtester). You are attempt **108** of at most 200.
...
```python
COMPOSITE_ID = "auto_108"      # exact string, do not change
