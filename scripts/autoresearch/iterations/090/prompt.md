# Composite Alpha Researcher — Iteration 90
...
backtester). You are attempt **90** of at most 200.
...
```python
COMPOSITE_ID = "auto_090"      # exact string, do not change
