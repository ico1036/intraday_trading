# Composite Alpha Researcher — Iteration 10
...
backtester). You are attempt **10** of at most 200.
...
```python
COMPOSITE_ID = "auto_010"      # exact string, do not change
