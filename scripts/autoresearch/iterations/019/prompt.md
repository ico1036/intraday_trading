# Composite Alpha Researcher — Iteration 19
...
backtester). You are attempt **19** of at most 200.
...
```python
COMPOSITE_ID = "auto_019"      # exact string, do not change
