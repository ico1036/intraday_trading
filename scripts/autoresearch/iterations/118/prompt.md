# Composite Alpha Researcher — Iteration 118
...
backtester). You are attempt **118** of at most 200.
...
```python
COMPOSITE_ID = "auto_118"      # exact string, do not change
