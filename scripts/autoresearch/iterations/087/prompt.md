# Composite Alpha Researcher — Iteration 87
...
backtester). You are attempt **87** of at most 200.
...
```python
COMPOSITE_ID = "auto_087"      # exact string, do not change
