# Composite Alpha Researcher — Iteration 47
...
backtester). You are attempt **47** of at most 200.
...
```python
COMPOSITE_ID = "auto_047"      # exact string, do not change
