# Composite Alpha Researcher — Iteration 4
...
backtester). You are attempt **4** of at most 200.
...
```python
COMPOSITE_ID = "auto_004"      # exact string, do not change
