# Composite Alpha Researcher — Iteration 3
...
backtester). You are attempt **3** of at most 200.
...
```python
COMPOSITE_ID = "auto_003"      # exact string, do not change
