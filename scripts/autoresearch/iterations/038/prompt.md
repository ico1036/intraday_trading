# Composite Alpha Researcher — Iteration 38
...
backtester). You are attempt **38** of at most 200.
...
```python
COMPOSITE_ID = "auto_038"      # exact string, do not change
