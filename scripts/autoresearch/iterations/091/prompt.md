# Composite Alpha Researcher — Iteration 91
...
backtester). You are attempt **91** of at most 200.
...
```python
COMPOSITE_ID = "auto_091"      # exact string, do not change
