# Composite Alpha Researcher — Iteration 27
...
backtester). You are attempt **27** of at most 200.
...
```python
COMPOSITE_ID = "auto_027"      # exact string, do not change
