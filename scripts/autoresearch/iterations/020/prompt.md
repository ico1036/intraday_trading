# Composite Alpha Researcher — Iteration 20
...
backtester). You are attempt **20** of at most 200.
...
```python
COMPOSITE_ID = "auto_020"      # exact string, do not change
