# Composite Alpha Researcher — Iteration 104
...
backtester). You are attempt **104** of at most 200.
...
```python
COMPOSITE_ID = "auto_104"      # exact string, do not change
