# Composite Alpha Researcher — Iteration 23
...
backtester). You are attempt **23** of at most 200.
...
```python
COMPOSITE_ID = "auto_023"      # exact string, do not change
