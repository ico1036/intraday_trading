# Composite Alpha Researcher — Iteration 6
...
backtester). You are attempt **6** of at most 200.
...
```python
COMPOSITE_ID = "auto_006"      # exact string, do not change
