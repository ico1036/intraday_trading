# Composite Alpha Researcher — Iteration 103
...
backtester). You are attempt **103** of at most 200.
...
```python
COMPOSITE_ID = "auto_103"      # exact string, do not change
