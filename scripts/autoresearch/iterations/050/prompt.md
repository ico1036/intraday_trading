# Composite Alpha Researcher — Iteration 50
...
backtester). You are attempt **50** of at most 200.
...
```python
COMPOSITE_ID = "auto_050"      # exact string, do not change
