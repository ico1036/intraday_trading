# Composite Alpha Researcher — Iteration 2
...
backtester). You are attempt **2** of at most 200.
...
```python
COMPOSITE_ID = "auto_002"      # exact string, do not change
