# Composite Alpha Researcher — Iteration 12
...
backtester). You are attempt **12** of at most 200.
...
```python
COMPOSITE_ID = "auto_012"      # exact string, do not change
