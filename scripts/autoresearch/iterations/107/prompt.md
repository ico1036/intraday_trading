# Composite Alpha Researcher — Iteration 107
...
backtester). You are attempt **107** of at most 200.
...
```python
COMPOSITE_ID = "auto_107"      # exact string, do not change
