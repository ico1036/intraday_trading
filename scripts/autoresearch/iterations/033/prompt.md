# Composite Alpha Researcher — Iteration 33
...
backtester). You are attempt **33** of at most 200.
...
```python
COMPOSITE_ID = "auto_033"      # exact string, do not change
