# Composite Alpha Researcher — Iteration 100
...
backtester). You are attempt **100** of at most 200.
...
```python
COMPOSITE_ID = "auto_100"      # exact string, do not change
