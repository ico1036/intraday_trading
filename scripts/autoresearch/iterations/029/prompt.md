# Composite Alpha Researcher — Iteration 29
...
backtester). You are attempt **29** of at most 200.
...
```python
COMPOSITE_ID = "auto_029"      # exact string, do not change
