# Composite Alpha Researcher — Iteration 1
...
backtester). You are attempt **1** of at most 200.
...
```python
COMPOSITE_ID = "auto_001"      # exact string, do not change
