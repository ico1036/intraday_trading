# Composite Alpha Researcher — Iteration 14
...
backtester). You are attempt **14** of at most 200.
...
```python
COMPOSITE_ID = "auto_014"      # exact string, do not change
