# Composite Alpha Researcher — Iteration 96
...
backtester). You are attempt **96** of at most 200.
...
```python
COMPOSITE_ID = "auto_096"      # exact string, do not change
