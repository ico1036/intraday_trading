# Composite Alpha Researcher — Iteration 25
...
backtester). You are attempt **25** of at most 200.
...
```python
COMPOSITE_ID = "auto_025"      # exact string, do not change
