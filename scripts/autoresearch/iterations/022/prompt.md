# Composite Alpha Researcher — Iteration 22
...
backtester). You are attempt **22** of at most 200.
...
```python
COMPOSITE_ID = "auto_022"      # exact string, do not change
