# Composite Alpha Researcher — Iteration 15
...
backtester). You are attempt **15** of at most 200.
...
```python
COMPOSITE_ID = "auto_015"      # exact string, do not change
