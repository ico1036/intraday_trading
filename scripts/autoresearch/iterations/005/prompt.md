# Composite Alpha Researcher — Iteration 5
...
backtester). You are attempt **5** of at most 200.
...
```python
COMPOSITE_ID = "auto_005"      # exact string, do not change
