"""xs_factor_accel20d_fwd_c50 — auto-generated XS factor.

Signal: accel_20d  direction=fwd  concentration=0.5
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_accel_20d_fwd_c50",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorAccel20dFwdC50(XsFactorBase):
