"""is_114_ts_zrevert_240m_240m — extreme z-score mean reversion.
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_zrevert_240m_240m",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_zrevert_240m_240m.md"]


class TsZrevert240m240mStrategy:
    def __init__(self, symbols, window_bars=240, hold_bars=240,
