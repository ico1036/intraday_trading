"""xs_factor_dollarvolume_fwd_c20 — auto-generated XS factor.

Signal: dollar_volume  direction=fwd  concentration=0.2
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_dollar_volume_fwd_c20",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorDollarvolumeFwdC20(XsFactorBase):
