"""Session extreme revert multi_day topk time_stop."""
...
class SextMultidayTopkTsStrategy:
    def __init__(self, symbols, top_k=3, lookback_days=3, max_weight=0.25, hold_bars=180, **_):
