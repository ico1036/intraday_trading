"""xs_factor_revstrength20d_fwd_c40 — auto-generated XS factor.

Signal: rev_strength_20d  direction=fwd  concentration=0.4
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_rev_strength_20d_fwd_c40",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorRevstrength20dFwdC40(XsFactorBase):
