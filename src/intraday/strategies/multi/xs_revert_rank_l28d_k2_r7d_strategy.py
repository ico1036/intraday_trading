"""is_627_xs_revert_rank_l28d_k2_r7d — cross-section past-28d reversal rank, long bottom-2 / short top-2."""
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_revert_rank_l28d_k2_r7d",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_revert_rank.md"]


class XsRevertRankL28dK2R7dStrategy:
