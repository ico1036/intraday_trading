"""xs_factor_momminusrev847_rev_c30 — auto-generated XS factor.

Signal: mom_minus_rev_84_7  direction=rev  concentration=0.3
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_mom_minus_rev_84_7_rev_c30",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorMomminusrev847RevC30(XsFactorBase):
