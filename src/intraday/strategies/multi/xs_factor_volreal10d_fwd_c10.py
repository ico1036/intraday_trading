"""xs_factor_volreal10d_fwd_c10 — auto-generated XS factor.

Signal: vol_real_10d  direction=fwd  concentration=0.1
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_vol_real_10d_fwd_c10",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorVolreal10dFwdC10(XsFactorBase):
