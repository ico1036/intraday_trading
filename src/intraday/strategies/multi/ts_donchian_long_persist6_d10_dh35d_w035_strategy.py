"""is_268_ts_donchian_long_persist_6d10d_h35d_w035 — long-only persist Donchian variant."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_long_persist_6d10d_h35d_w035",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_long_persist_6d10d_h35d_w035.md"]


class TsDonchianLongPersist6D10DH35dW035Strategy:
