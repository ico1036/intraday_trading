"""xs_factor_buyshare20d_rev_c50 — auto-generated XS factor.

Signal: buy_share_20d  direction=rev  concentration=0.5
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_buy_share_20d_rev_c50",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorBuyshare20dRevC50(XsFactorBase):
