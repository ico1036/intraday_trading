"""is_119_ts_zrevert_4h_1d — extreme z-score mean reversion.
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_zrevert_4h_1d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_zrevert_4h_1d.md"]


class TsZrevert4h1dStrategy:
    def __init__(self, symbols, window_bars=240, hold_bars=1440,
