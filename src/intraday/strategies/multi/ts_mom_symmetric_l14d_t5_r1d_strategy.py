"""is_672_ts_mom_symmetric_l14d_t5_r1d — TS-mom symmetric: long if past 14d return > 0.5%, short if < -0.5%."""
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "ts_mom_symmetric_l14d_t5_r1d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_mom_symmetric.md"]


class TsMomSymmetricL14dT5R1dStrategy:
