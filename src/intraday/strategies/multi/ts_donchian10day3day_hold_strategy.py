"""is_032_ts_donchian_10day_3day_hold — Donchian breakout variant."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_10day_3day_hold",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_10day_3day_hold.md"]


class TsDonchian10day3dayHoldStrategy:
    def __init__(self, symbols, channel_bars=14400, rebalance_bars=240, hold_bars=4320, max_weight=0.14, **_):
