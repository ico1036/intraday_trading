"""is_651_ts_mom_symmetric_l5d_t10_r1d — TS-mom symmetric: long if past 5d return > 1.0%, short if < -1.0%."""
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "ts_mom_symmetric_l5d_t10_r1d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_mom_symmetric.md"]


class TsMomSymmetricL5dT10R1dStrategy:
