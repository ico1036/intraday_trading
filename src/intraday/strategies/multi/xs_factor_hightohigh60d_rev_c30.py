"""xs_factor_hightohigh60d_rev_c30 — auto-generated XS factor.

Signal: high_to_high_60d  direction=rev  concentration=0.3
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_high_to_high_60d_rev_c30",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorHightohigh60dRevC30(XsFactorBase):
    HISTORY_FIELDS = ('high',)
    HISTORY_LEN = 80
