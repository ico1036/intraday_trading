"""atr_fade_symmetric_m240_a240_k20_h7200_w040 — ATR-channel fade symmetric (k=2.0 ATRs from EMA mean)."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "atr_fade_symmetric_m240_a240_k20_h7200_w040",
}
SOURCE_NOTES: list[str] = ["research/notes/atr_fade_symmetric.md"]


class AtrFadeSymmetricM240A240K20H7200W040Strategy:
