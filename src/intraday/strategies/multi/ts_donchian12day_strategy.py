"""is_031_ts_donchian_12day — Donchian breakout variant."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_12day",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_12day.md"]


class TsDonchian12dayStrategy:
    def __init__(self, symbols, channel_bars=17280, rebalance_bars=240, hold_bars=17280, max_weight=0.14, **_):
