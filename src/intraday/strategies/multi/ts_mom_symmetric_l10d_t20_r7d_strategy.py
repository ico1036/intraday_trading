"""is_668_ts_mom_symmetric_l10d_t20_r7d — TS-mom symmetric: long if past 10d return > 2.0%, short if < -2.0%."""
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "ts_mom_symmetric_l10d_t20_r7d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_mom_symmetric.md"]


class TsMomSymmetricL10dT20R7dStrategy:
    def __init__(self, symbols, lookback_bars=14400, rebalance_bars=10080,
                 entry_threshold=0.02, exit_threshold=0.006, max_weight=0.3, **_):
