"""xs_factor_buyshare60d_fwd_c05 — auto-generated XS factor.

Signal: buy_share_60d  direction=fwd  concentration=0.05
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_buy_share_60d_fwd_c05",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorBuyshare60dFwdC05(XsFactorBase):
