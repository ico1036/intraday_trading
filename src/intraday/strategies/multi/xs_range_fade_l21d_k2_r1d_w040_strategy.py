"""xs_range_fade_l21d_k2_r1d_w040 — cross-section: rank by close position in N-day range, fade extremes."""
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_range_fade_l21d_k2_r1d_w040",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_range_position_fade.md"]


class XsRangeFadeL21dK2R1dW040Strategy:
