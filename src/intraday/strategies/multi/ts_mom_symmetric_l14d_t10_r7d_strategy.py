"""is_677_ts_mom_symmetric_l14d_t10_r7d — TS-mom symmetric: long if past 14d return > 1.0%, short if < -1.0%."""
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "ts_mom_symmetric_l14d_t10_r7d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_mom_symmetric.md"]


class TsMomSymmetricL14dT10R7dStrategy:
