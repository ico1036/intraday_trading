"""is_572_xs_mom_rank_l14d_k1_r7d — cross-section past-14d return rank, long top-1 / short bottom-1."""
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_mom_rank_l14d_k1_r7d",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_mom_rank.md"]


class XsMomRankL14dK1R7dStrategy:
    def __init__(self, symbols, lookback_bars=20160, rebalance_bars=10080,
