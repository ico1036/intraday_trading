"""is_183_ts_donchian_long_persist_3d14d_h35d_w035 — long-only persist Donchian, extended hold."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_long_persist_3d14d_h35d_w035",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_long_persist_3d14d_h35d_w035.md"]


class TsDonchianLongPersist3d14dH35dW035Strategy:
