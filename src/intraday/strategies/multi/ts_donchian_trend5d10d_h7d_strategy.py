"""is_075_ts_donchian_trend_5d10d_h7d — Donchian trend-filter variant."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_trend_5d10d_h7d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_trend_5d10d_h7d.md"]


class TsDonchianTrend5d10dH7dStrategy:
