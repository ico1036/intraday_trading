"""xs_reg_kitchen_a0p1_t120_fwd_c10 — auto-generated ridge cross-sectional regression alpha.
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_reg_kitchen_a0p1_t120_fwd_c10",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_regression_zoo.md"]


class XsRegKitchenA0p1T120FwdC10(XsRegressionBase):
