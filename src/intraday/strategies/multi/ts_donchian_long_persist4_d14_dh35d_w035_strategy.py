"""is_241_ts_donchian_long_persist_4d14d_h35d_w035 — long-only persist Donchian variant."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_long_persist_4d14d_h35d_w035",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_long_persist_4d14d_h35d_w035.md"]


class TsDonchianLongPersist4D14DH35dW035Strategy:
    def __init__(self, symbols, fast_channel_bars=5760, slow_channel_bars=20160,
                 rebalance_bars=240, hold_bars=50400, max_weight=0.035, **_):
