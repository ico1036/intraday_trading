"""xs_factor_minlottery252d_fwd_c20 — auto-generated XS factor.

Signal: min_lottery_252d  direction=fwd  concentration=0.2
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_min_lottery_252d_fwd_c20",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorMinlottery252dFwdC20(XsFactorBase):
