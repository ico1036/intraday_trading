"""Session extreme revert topk time_stop composite."""
...
class SextTopkTsCompStrategy:
    def __init__(self, symbols, top_k=3, history_size=30, entry_thr=0.3, max_weight=0.25, hold_bars=180, **_):
