"""is_064_ts_donchian_trend_5d10d — Donchian trend-filter: slow regime + fast entry."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_trend_5d10d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_trend_5d10d.md"]


class TsDonchianTrend5d10dStrategy:
