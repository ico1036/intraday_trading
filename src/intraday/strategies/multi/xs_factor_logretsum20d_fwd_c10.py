"""xs_factor_logretsum20d_fwd_c10 — auto-generated XS factor.

Signal: log_ret_sum_20d  direction=fwd  concentration=0.1
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_log_ret_sum_20d_fwd_c10",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorLogretsum20dFwdC10(XsFactorBase):
