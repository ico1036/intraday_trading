"""is_005_ts_weekly_momentum — per-symbol weekly time-series momentum.

Cell distinct from is_002/003/004: idea_family=ts_weekly_momentum, weekly
rebalance keeps total trades to ~170 over 90 days vs ~1100 for the daily
variants — directly testing whether the underlying signal carries any
post-fee edge.
"""
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "ts_weekly_momentum",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_weekly_momentum.md"]


class TsWeeklyMomentumStrategy:
    def __init__(
        self,
        symbols: list[str],
