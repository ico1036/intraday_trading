"""xs_factor_return2d_fwd_c10 — auto-generated XS factor.

Signal: return_2d  direction=fwd  concentration=0.1
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_return_2d_fwd_c10",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorReturn2dFwdC10(XsFactorBase):
