"""xs_factor_revtoma3_rev_c50 — auto-generated XS factor.

Signal: rev_to_ma3  direction=rev  concentration=0.5
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_rev_to_ma3_rev_c50",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorRevtoma3RevC50(XsFactorBase):
