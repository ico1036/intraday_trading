"""xs_factor_volreal5d_rev_c20 — auto-generated XS factor.

Signal: vol_real_5d  direction=rev  concentration=0.2
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_vol_real_5d_rev_c20",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorVolreal5dRevC20(XsFactorBase):
