"""ORB-fade pair neutral_zone ewma_residual."""
...
class OrbFadePairNeutralEwmaStrategy:
    def __init__(self, symbols, pair=("BTCUSDT", "ETHUSDT"), or_minutes=30, alpha=0.1, entry_thr=0.05,
        ...
        self._mag_ewma = {s: None for s in self.pair}
        self._day = None
