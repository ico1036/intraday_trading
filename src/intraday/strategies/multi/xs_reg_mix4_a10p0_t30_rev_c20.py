"""xs_reg_mix4_a10p0_t30_rev_c20 — auto-generated ridge cross-sectional regression alpha.
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_reg_mix4_a10p0_t30_rev_c20",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_regression_zoo.md"]


class XsRegMix4A10p0T30RevC20(XsRegressionBase):
