"""is_601_xs_revert_rank_l5d_k2_r1d — cross-section past-5d reversal rank, long bottom-2 / short top-2."""
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_revert_rank_l5d_k2_r1d",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_revert_rank.md"]


class XsRevertRankL5dK2R1dStrategy:
