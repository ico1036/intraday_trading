"""xs_factor_logvolume_fwd_c50 — auto-generated XS factor.

Signal: log_volume  direction=fwd  concentration=0.5
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_log_volume_fwd_c50",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorLogvolumeFwdC50(XsFactorBase):
