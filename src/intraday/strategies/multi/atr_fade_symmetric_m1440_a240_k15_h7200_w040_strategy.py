"""atr_fade_symmetric_m1440_a240_k15_h7200_w040 — ATR-channel fade symmetric (k=1.5 ATRs from EMA mean)."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "atr_fade_symmetric_m1440_a240_k15_h7200_w040",
}
SOURCE_NOTES: list[str] = ["research/notes/atr_fade_symmetric.md"]


class AtrFadeSymmetricM1440A240K15H7200W040Strategy:
    def __init__(self, symbols, mean_bars=1440, atr_bars=240,
