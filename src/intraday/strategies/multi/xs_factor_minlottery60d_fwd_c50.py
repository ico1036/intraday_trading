"""xs_factor_minlottery60d_fwd_c50 — auto-generated XS factor.

Signal: min_lottery_60d  direction=fwd  concentration=0.5
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_min_lottery_60d_fwd_c50",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorMinlottery60dFwdC50(XsFactorBase):
