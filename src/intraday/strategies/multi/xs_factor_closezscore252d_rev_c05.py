"""xs_factor_closezscore252d_rev_c05 — auto-generated XS factor.

Signal: close_zscore_252d  direction=rev  concentration=0.05
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_close_zscore_252d_rev_c05",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorClosezscore252dRevC05(XsFactorBase):
