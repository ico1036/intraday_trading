"""is_509_xs_donchian_rank_c5d_k1_r3d — cross-section Donchian channel-position rank, long top-K / short bottom-K."""
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_donchian_rank_c5d_k1_r3d",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_donchian_rank.md"]


class XsDonchianRankC5dK1R3dStrategy:
    def __init__(self, symbols, channel_bars=7200, rebalance_bars=4320,
