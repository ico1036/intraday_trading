"""is_030_ts_donchian_8day — Donchian breakout variant."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_8day",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_8day.md"]


class TsDonchian8dayStrategy:
    def __init__(self, symbols, channel_bars=11520, rebalance_bars=240, hold_bars=11520, max_weight=0.14, **_):
