"""ORB-fade with 4-hour resetting OR (intraday horizon).

Same family as is_023 (orb_fade, session horizon, signal_flip exit) but the
opening-range window resets every 4 hours of the day. Cell horizon value
differs (session → intraday).
"""
