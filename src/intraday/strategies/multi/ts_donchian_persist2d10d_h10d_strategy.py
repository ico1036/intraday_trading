"""is_103_ts_donchian_persist_2d10d_h10d — persist Donchian, longer hold."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_persist_2d10d_h10d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_persist_2d10d_h10d.md"]


class TsDonchianPersist2d10dH10dStrategy:
    def __init__(self, symbols, fast_channel_bars=2880, slow_channel_bars=14400,
