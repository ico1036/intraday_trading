"""is_644_ts_lead_lag_btc_lk14d_th05_h21d — long alts if BTC recently up."""
...
ALPHA_CELL = {
    ...
    "idea_family": "ts_lead_lag_btc_lk14d_th05_h21d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_lead_lag_btc_lk14d_th05_h21d.md"]


class TsLeadLagBtcLk14dTh05H21DStrategy:
