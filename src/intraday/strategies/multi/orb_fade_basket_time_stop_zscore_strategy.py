"""ORB-fade basket_full TIME_STOP exit + z_score transform.

Cell exit/transform differ from is_017 (time_stop+raw) and is_023 (signal_flip+raw).
"""
...
class OrbFadeBasketTimeStopZscoreStrategy:
    def __init__(
        self,
        symbols: list[str],
        or_minutes: int = 60,
