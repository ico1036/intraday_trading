"""xs_factor_macd1226_rev_c20 — auto-generated XS factor.

Signal: macd_12_26  direction=rev  concentration=0.2
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_macd_12_26_rev_c20",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorMacd1226RevC20(XsFactorBase):
