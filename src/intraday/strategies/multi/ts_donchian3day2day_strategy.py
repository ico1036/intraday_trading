"""is_047_ts_donchian_3day_2day — Donchian breakout asymmetric variant."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_3day_2day",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_3day_2day.md"]


class TsDonchian3day2dayStrategy:
    def __init__(self, symbols, channel_bars=4320, rebalance_bars=240, hold_bars=2880, max_weight=0.14, **_):
