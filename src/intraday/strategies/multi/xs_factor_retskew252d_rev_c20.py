"""xs_factor_retskew252d_rev_c20 — auto-generated XS factor.

Signal: ret_skew_252d  direction=rev  concentration=0.2
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_ret_skew_252d_rev_c20",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorRetskew252dRevC20(XsFactorBase):
