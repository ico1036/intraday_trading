"""BB band fade multi_day topk ewma_residual."""
...
class BbFadeMultidayTopkEwmaStrategy:
    def __init__(self, symbols, top_k=3, lookback=720, k=2.0, alpha=0.1, entry_thr=0.05, max_weight=0.25, **_):
