"""ATR-band fade with shorter ATR window (fast variant)."""
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "atr_fast_fade",
}
SOURCE_NOTES: list[str] = ["research/notes/atr_band_fade.md"]


class AtrFastFadeBasketStrategy:
    def __init__(self, symbols, atr_window=120, k=3.0, max_weight=0.13, **_):
