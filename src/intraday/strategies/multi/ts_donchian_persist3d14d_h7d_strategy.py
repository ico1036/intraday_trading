"""is_089_ts_donchian_persist_3d14d_h7d — Donchian trend-filter with regime-persistent re-entry.
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_persist_3d14d_h7d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_persist_3d14d_h7d.md"]


class TsDonchianPersist3d14dH7dStrategy:
