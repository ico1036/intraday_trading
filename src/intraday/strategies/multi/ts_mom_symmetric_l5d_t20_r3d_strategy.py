"""is_655_ts_mom_symmetric_l5d_t20_r3d — TS-mom symmetric: long if past 5d return > 2.0%, short if < -2.0%."""
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "ts_mom_symmetric_l5d_t20_r3d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_mom_symmetric.md"]


class TsMomSymmetricL5dT20R3dStrategy:
