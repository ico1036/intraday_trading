"""xs_factor_closezscore10d_rev_c50 — auto-generated XS factor.

Signal: close_zscore_10d  direction=rev  concentration=0.5
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_close_zscore_10d_rev_c50",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorClosezscore10dRevC50(XsFactorBase):
