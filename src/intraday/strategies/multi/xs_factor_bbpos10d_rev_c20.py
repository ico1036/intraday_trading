"""xs_factor_bbpos10d_rev_c20 — auto-generated XS factor.

Signal: bb_pos_10d  direction=rev  concentration=0.2
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_bb_pos_10d_rev_c20",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorBbpos10dRevC20(XsFactorBase):
