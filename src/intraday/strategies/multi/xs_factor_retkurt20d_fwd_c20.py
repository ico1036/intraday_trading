"""xs_factor_retkurt20d_fwd_c20 — auto-generated XS factor.

Signal: ret_kurt_20d  direction=fwd  concentration=0.2
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_ret_kurt_20d_fwd_c20",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorRetkurt20dFwdC20(XsFactorBase):
