"""ORB-fade pair neutral_zone composite."""
...
class OrbFadePairNeutralCompStrategy:
    def __init__(self, symbols, pair=("BTCUSDT", "ETHUSDT"), or_minutes=30, history_size=30, entry_thr=0.4,
