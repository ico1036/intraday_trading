"""is_025_ts_donchian_weekly_fast — Donchian breakout variant."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_weekly_fast",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_weekly_fast.md"]


class TsDonchianWeeklyFastStrategy:
    def __init__(self, symbols, channel_bars=10080, rebalance_bars=60, hold_bars=10080, max_weight=0.14, **_):
