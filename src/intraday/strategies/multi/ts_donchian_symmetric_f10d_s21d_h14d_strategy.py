"""is_346_ts_donchian_symmetric_f10d_s21d_h14d — symmetric Donchian persist (long upper-break + short lower-break)."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_symmetric_f10d_s21d_h14d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_symmetric.md"]


class TsDonchianSymmetricF10dS21dH14dStrategy:
    def __init__(self, symbols, fast_channel_bars=14400, slow_channel_bars=30240,
                 rebalance_bars=240, hold_bars=20160, max_weight=0.2, **_):
