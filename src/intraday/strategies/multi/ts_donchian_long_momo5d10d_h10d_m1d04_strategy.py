"""is_159_ts_donchian_long_momo_5d10d_h10d_m1d_w04 — long-only persist Donchian, momentum-confirmed re-entry."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_long_momo_5d10d_h10d_m1d_w04",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_long_momo_5d10d_h10d_m1d_w04.md"]


class TsDonchianLongMomo5d10dH10dM1d04Strategy:
    def __init__(self, symbols, fast_channel_bars=7200, slow_channel_bars=14400,
                 rebalance_bars=240, hold_bars=14400, max_weight=0.04,
