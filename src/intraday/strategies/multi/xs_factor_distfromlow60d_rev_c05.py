"""xs_factor_distfromlow60d_rev_c05 — auto-generated XS factor.

Signal: dist_from_low_60d  direction=rev  concentration=0.05
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_dist_from_low_60d_rev_c05",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorDistfromlow60dRevC05(XsFactorBase):
