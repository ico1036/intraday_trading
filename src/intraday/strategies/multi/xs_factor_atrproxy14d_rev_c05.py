"""xs_factor_atrproxy14d_rev_c05 — auto-generated XS factor.

Signal: atr_proxy_14d  direction=rev  concentration=0.05
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_atr_proxy_14d_rev_c05",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorAtrproxy14dRevC05(XsFactorBase):
