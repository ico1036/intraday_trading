"""xs_factor_maxlottery60d_rev_c20 — auto-generated XS factor.

Signal: max_lottery_60d  direction=rev  concentration=0.2
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_max_lottery_60d_rev_c20",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorMaxlottery60dRevC20(XsFactorBase):
