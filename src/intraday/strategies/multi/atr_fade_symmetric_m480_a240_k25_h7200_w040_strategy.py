"""atr_fade_symmetric_m480_a240_k25_h7200_w040 — ATR-channel fade symmetric (k=2.5 ATRs from EMA mean)."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "atr_fade_symmetric_m480_a240_k25_h7200_w040",
}
SOURCE_NOTES: list[str] = ["research/notes/atr_fade_symmetric.md"]


class AtrFadeSymmetricM480A240K25H7200W040Strategy:
