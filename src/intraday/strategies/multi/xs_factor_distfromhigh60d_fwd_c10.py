"""xs_factor_distfromhigh60d_fwd_c10 — auto-generated XS factor.

Signal: dist_from_high_60d  direction=fwd  concentration=0.1
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_dist_from_high_60d_fwd_c10",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorDistfromhigh60dFwdC10(XsFactorBase):
