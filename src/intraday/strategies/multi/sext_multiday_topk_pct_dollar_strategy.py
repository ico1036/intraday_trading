"""Session extreme revert multi_day topk percentile."""
...
class SextMultidayTopkPctDollarStrategy:
    def __init__(self, symbols, top_k=3, lookback_days=3, history_size=30, pct=0.5, max_weight=0.25, **_):
