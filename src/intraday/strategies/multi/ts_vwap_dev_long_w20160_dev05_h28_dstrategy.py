"""is_539_ts_vwap_dev_long_w20160_dev05_h28d — VWAP-deviation long, hold 28d."""
...
ALPHA_CELL = {
    ...
    "idea_family": "ts_vwap_dev_long_w20160_dev05_h28d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_vwap_dev_long_w20160_dev05_h28d.md"]


class TsVwapDevLongW20160Dev05H28DStrategy:
    def __init__(self, symbols, window_bars=20160, deviation_pct=0.05,
