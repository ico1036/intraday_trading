"""xs_factor_distfromhigh20d_fwd_c30 — auto-generated XS factor.

Signal: dist_from_high_20d  direction=fwd  concentration=0.3
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_dist_from_high_20d_fwd_c30",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorDistfromhigh20dFwdC30(XsFactorBase):
