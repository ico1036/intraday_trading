"""xs_factor_udvolratio20d_fwd_c05 — auto-generated XS factor.

Signal: ud_vol_ratio_20d  direction=fwd  concentration=0.05
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_ud_vol_ratio_20d_fwd_c05",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorUdvolratio20dFwdC05(XsFactorBase):
