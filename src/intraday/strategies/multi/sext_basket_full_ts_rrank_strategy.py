"""Session extreme revert basket time_stop rolling_rank."""
...
class SextBasketFullTsRrankStrategy:
    def __init__(self, symbols, history_size=30, rank_thr=0.5, max_weight=0.13, hold_bars=180, **_):
