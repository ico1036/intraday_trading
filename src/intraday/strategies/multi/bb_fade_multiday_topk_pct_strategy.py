"""BB band fade multi_day topk percentile."""
...
class BbFadeMultidayTopkPctStrategy:
    def __init__(self, symbols, top_k=3, lookback=720, k=2.0, history_size=30, pct=0.5, max_weight=0.25, **_):
