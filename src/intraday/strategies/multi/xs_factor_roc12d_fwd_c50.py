"""xs_factor_roc12d_fwd_c50 — auto-generated XS factor.

Signal: roc_12d  direction=fwd  concentration=0.5
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_roc_12d_fwd_c50",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorRoc12dFwdC50(XsFactorBase):
