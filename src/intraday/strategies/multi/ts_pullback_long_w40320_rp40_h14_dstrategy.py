"""is_821_ts_pullback_long_w40320_rp40_h14d — pullback-in-uptrend long."""
...
ALPHA_CELL = {
    ...
    "idea_family": "ts_pullback_long_w40320_rp40_h14d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_pullback_long_w40320_rp40_h14d.md"]


class TsPullbackLongW40320Rp40H14DStrategy:
    def __init__(self, symbols, window=40320, range_pct=0.4,
