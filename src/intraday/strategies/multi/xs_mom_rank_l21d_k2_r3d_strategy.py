"""is_580_xs_mom_rank_l21d_k2_r3d — cross-section past-21d return rank, long top-2 / short bottom-2."""
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_mom_rank_l21d_k2_r3d",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_mom_rank.md"]


class XsMomRankL21dK2R3dStrategy:
