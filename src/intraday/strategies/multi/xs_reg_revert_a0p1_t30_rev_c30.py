"""xs_reg_revert_a0p1_t30_rev_c30 — auto-generated ridge cross-sectional regression alpha.

Features: ['rev_ma20', 'dist_hi20', 'ret1d']  ridge α=0.1  train window=30d
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_reg_revert_a0p1_t30_rev_c30",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_regression_zoo.md"]


class XsRegRevertA0p1T30RevC30(XsRegressionBase):
