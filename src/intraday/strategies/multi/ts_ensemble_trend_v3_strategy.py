"""is_106_ts_ensemble_trend_v3 — ensemble of 3 trend-filter slots."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_ensemble_trend_v3",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_ensemble_trend_v3.md"]

_SLOTS = [(4320, 14400, 7200), (4320, 20160, 7200), (4320, 30240, 10080)]  # list of (fast, slow, hold)


class TsEnsembleTrendV3Strategy:
