"""is_330_ts_donchian_symmetric_f5d_s28d_h14d — symmetric Donchian persist (long upper-break + short lower-break)."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_symmetric_f5d_s28d_h14d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_symmetric.md"]


class TsDonchianSymmetricF5dS28dH14dStrategy:
    def __init__(self, symbols, fast_channel_bars=7200, slow_channel_bars=40320,
