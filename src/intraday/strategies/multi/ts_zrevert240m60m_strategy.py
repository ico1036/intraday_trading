"""is_116_ts_zrevert_240m_60m — extreme z-score mean reversion.
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_zrevert_240m_60m",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_zrevert_240m_60m.md"]


class TsZrevert240m60mStrategy:
    def __init__(self, symbols, window_bars=240, hold_bars=60,
