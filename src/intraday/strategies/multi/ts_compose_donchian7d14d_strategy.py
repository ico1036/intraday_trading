"""is_059_ts_compose_donchian_7d14d — composite Donchian: enters only when fast AND slow channel agree."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_compose_donchian_7d14d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_compose_donchian_7d14d.md"]


class TsComposeDonchian7d14dStrategy:
