"""xs_factor_intradaygap1d_fwd_c30 — auto-generated XS factor.

Signal: intraday_gap_1d  direction=fwd  concentration=0.3
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_intraday_gap_1d_fwd_c30",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorIntradaygap1dFwdC30(XsFactorBase):
