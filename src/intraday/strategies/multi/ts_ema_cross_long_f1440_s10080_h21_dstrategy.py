"""is_824_ts_ema_cross_long_f1440_s10080_h21d — EMA cross long."""
...
ALPHA_CELL = {
    ...
    "idea_family": "ts_ema_cross_long_f1440_s10080_h21d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_ema_cross_long_f1440_s10080_h21d.md"]


class TsEmaCrossLongF1440S10080H21DStrategy:
    def __init__(self, symbols, fast_period=1440, slow_period=10080,
