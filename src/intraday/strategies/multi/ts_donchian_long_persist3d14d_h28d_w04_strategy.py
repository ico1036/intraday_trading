"""is_161_ts_donchian_long_persist_3d14d_h28d_w04 — long-only persist Donchian, very long hold."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_long_persist_3d14d_h28d_w04",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_long_persist_3d14d_h28d_w04.md"]


class TsDonchianLongPersist3d14dH28dW04Strategy:
