"""is_660_ts_mom_symmetric_l10d_t5_r1d — TS-mom symmetric: long if past 10d return > 0.5%, short if < -0.5%."""
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "ts_mom_symmetric_l10d_t5_r1d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_mom_symmetric.md"]


class TsMomSymmetricL10dT5R1dStrategy:
