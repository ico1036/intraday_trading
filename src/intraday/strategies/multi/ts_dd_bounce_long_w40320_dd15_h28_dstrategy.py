"""is_518_ts_dd_bounce_long_w40320_dd15_h28d — drawdown bounce long, hold 28d."""
...
ALPHA_CELL = {
    ...
    "idea_family": "ts_dd_bounce_long_w40320_dd15_h28d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_dd_bounce_long_w40320_dd15_h28d.md"]


class TsDdBounceLongW40320Dd15H28DStrategy:
    def __init__(self, symbols, window_bars=40320, dd_threshold=-0.15,
