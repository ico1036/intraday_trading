"""xs_factor_rsi14d_rev_c30 — auto-generated XS factor.

Signal: rsi_14d  direction=rev  concentration=0.3
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_rsi_14d_rev_c30",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorRsi14dRevC30(XsFactorBase):
