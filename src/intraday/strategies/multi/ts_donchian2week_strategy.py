"""is_018_ts_donchian_2week — 14-day Donchian breakout, 14-day hold."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_2week",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_2week.md"]


class TsDonchian2weekStrategy:
    def __init__(self, symbols, channel_bars=20160, rebalance_bars=240, hold_bars=20160, max_weight=0.14, **_):
