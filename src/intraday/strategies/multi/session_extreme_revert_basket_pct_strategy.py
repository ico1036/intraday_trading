"""Session extreme revert basket percentile."""
...
class SessionExtremeRevertBasketPctStrategy:
    def __init__(
        self,
        symbols: list[str],
    ...
    def generate_order(self, state: MarketState) -> PortfolioOrder | None:
        ...
        if self._current_day is None or day != self._current_day:
            # save end-of-day stretches as history
            for s in self.symbols:
        ...
        for s in self.symbols:
            ...
            if close is None or sh is None or sl is None or so is None:
                continue
