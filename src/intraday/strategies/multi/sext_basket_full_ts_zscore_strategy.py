"""Session extreme revert basket time_stop z_score (untried)."""
...
class SextBasketFullTsZscoreStrategy:
    def __init__(self, symbols, history_size=30, entry_z=0.3, max_weight=0.13, hold_bars=180, **_):
