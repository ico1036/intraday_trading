"""xs_factor_intradaygap1d_rev_c50 — auto-generated XS factor.

Signal: intraday_gap_1d  direction=rev  concentration=0.5
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_intraday_gap_1d_rev_c50",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorIntradaygap1dRevC50(XsFactorBase):
