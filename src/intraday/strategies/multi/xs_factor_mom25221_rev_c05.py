"""xs_factor_mom25221_rev_c05 — auto-generated XS factor.

Signal: mom_252_21  direction=rev  concentration=0.05
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_mom_252_21_rev_c05",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorMom25221RevC05(XsFactorBase):
    ...
    def _compute_score(self, hist: dict[str, list[float]]) -> float | None:
        if len(hist['close']) < 253:
            return None
        try:
            return hist['close'][-22]/hist['close'][-253] - 1.0
        except Exception:
            return None
