"""xs_factor_closezscore252d_rev_c10 — auto-generated XS factor.

Signal: close_zscore_252d  direction=rev  concentration=0.1
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_close_zscore_252d_rev_c10",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorClosezscore252dRevC10(XsFactorBase):
