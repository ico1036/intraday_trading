"""is_611_xs_revert_rank_l14d_k1_r3d — cross-section past-14d reversal rank, long bottom-1 / short top-1."""
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_revert_rank_l14d_k1_r3d",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_revert_rank.md"]


class XsRevertRankL14dK1R3dStrategy:
