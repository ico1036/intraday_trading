"""is_800_ts_pullback_long_w4320_rp30_h14d — pullback-in-uptrend long."""
...
ALPHA_CELL = {
    ...
    "idea_family": "ts_pullback_long_w4320_rp30_h14d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_pullback_long_w4320_rp30_h14d.md"]


class TsPullbackLongW4320Rp30H14DStrategy:
    def __init__(self, symbols, window=4320, range_pct=0.3,
