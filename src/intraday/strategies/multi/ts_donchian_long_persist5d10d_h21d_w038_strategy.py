"""is_173_ts_donchian_long_persist_5d10d_h21d_w038 — long-only persist Donchian, smaller weight."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_long_persist_5d10d_h21d_w038",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_long_persist_5d10d_h21d_w038.md"]


class TsDonchianLongPersist5d10dH21dW038Strategy:
    def __init__(self, symbols, fast_channel_bars=7200, slow_channel_bars=14400,
                 rebalance_bars=240, hold_bars=30240, max_weight=0.038, **_):
