"""xs_factor_mom201_rev_c50 — auto-generated XS factor.

Signal: mom_20_1  direction=rev  concentration=0.5
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_mom_20_1_rev_c50",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorMom201RevC50(XsFactorBase):
