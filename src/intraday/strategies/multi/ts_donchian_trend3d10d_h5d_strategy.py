"""is_072_ts_donchian_trend_3d10d_h5d — Donchian trend-filter variant."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_trend_3d10d_h5d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_trend_3d10d_h5d.md"]


class TsDonchianTrend3d10dH5dStrategy:
