"""is_967_ts_disp_low_long_lk10080_dp20_h28d — low-dispersion long basket."""
...
ALPHA_CELL = {
    ...
    "idea_family": "ts_disp_low_long_lk10080_dp20_h28d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_disp_low_long_lk10080_dp20_h28d.md"]


class TsDispLowLongLk10080Dp20H28DStrategy:
    def __init__(self, symbols, lookback=10080, disp_pct=0.2,
