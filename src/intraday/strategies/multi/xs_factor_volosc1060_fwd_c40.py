"""xs_factor_volosc1060_fwd_c40 — auto-generated XS factor.

Signal: vol_osc_10_60  direction=fwd  concentration=0.4
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_vol_osc_10_60_fwd_c40",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorVolosc1060FwdC40(XsFactorBase):
