"""is_523_ts_range_revert_long_w10080_rk20_h28d — range-position mean revert long, hold 28d."""
...
ALPHA_CELL = {
    ...
    "idea_family": "ts_range_revert_long_w10080_rk20_h28d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_range_revert_long_w10080_rk20_h28d.md"]


class TsRangeRevertLongW10080Rk20H28DStrategy:
    def __init__(self, symbols, window_bars=10080, rank_threshold=0.2,
