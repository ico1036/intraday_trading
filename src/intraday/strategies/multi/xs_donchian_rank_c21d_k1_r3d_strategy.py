"""is_527_xs_donchian_rank_c21d_k1_r3d — cross-section Donchian channel-position rank, long top-K / short bottom-K."""
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_donchian_rank_c21d_k1_r3d",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_donchian_rank.md"]


class XsDonchianRankC21dK1R3dStrategy:
    def __init__(self, symbols, channel_bars=30240, rebalance_bars=4320,
