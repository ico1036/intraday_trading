"""xs_reg_kitchen_a1p0_t120_rev_c30 — auto-generated ridge cross-sectional regression alpha.

Features: ['ret1d', 'ret5d', 'ret20d', 'ret60d', 'logvol', 'vol20d', 'rev_ma20', 'dist_hi20', 'maxlot20', 'absret20']  ridge α=1.0  train window=120d
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_reg_kitchen_a1p0_t120_rev_c30",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_regression_zoo.md"]


class XsRegKitchenA1p0T120RevC30(XsRegressionBase):
