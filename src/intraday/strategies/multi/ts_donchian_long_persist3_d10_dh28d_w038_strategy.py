"""is_212_ts_donchian_long_persist_3d10d_h28d_w038 — long-only persist Donchian variant."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_long_persist_3d10d_h28d_w038",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_long_persist_3d10d_h28d_w038.md"]


class TsDonchianLongPersist3D10DH28dW038Strategy:
