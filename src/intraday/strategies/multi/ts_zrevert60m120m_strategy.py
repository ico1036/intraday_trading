"""is_113_ts_zrevert_60m_120m — extreme z-score mean reversion.
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_zrevert_60m_120m",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_zrevert_60m_120m.md"]


class TsZrevert60m120mStrategy:
    def __init__(self, symbols, window_bars=60, hold_bars=120,
                 rebalance_bars=30, entry_z=2.0, max_weight=0.07,
                 history_bars=2880, **_):
