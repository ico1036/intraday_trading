"""is_180_ts_donchian_long_persist_2d14d_h28d_w035 — long-only persist Donchian, extended hold."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_long_persist_2d14d_h28d_w035",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_long_persist_2d14d_h28d_w035.md"]


class TsDonchianLongPersist2d14dH28dW035Strategy:
