"""is_307_ts_donchian_long_persist_r18_a6 — long-only persist Donchian (round 18)."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_long_persist_r18_a6",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_long_persist_r18_a6.md"]


class TsDonchianLongPersistR18A6Strategy:
