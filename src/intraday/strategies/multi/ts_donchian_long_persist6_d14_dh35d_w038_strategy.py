"""is_278_ts_donchian_long_persist_6d14d_h35d_w038 — long-only persist Donchian variant."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_long_persist_6d14d_h35d_w038",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_long_persist_6d14d_h35d_w038.md"]


class TsDonchianLongPersist6D14DH35dW038Strategy:
    def __init__(self, symbols, fast_channel_bars=8640, slow_channel_bars=20160,
                 rebalance_bars=240, hold_bars=50400, max_weight=0.038, **_):
