"""is_028_ts_donchian_4day — Donchian breakout variant."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_4day",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_4day.md"]


class TsDonchian4dayStrategy:
    def __init__(self, symbols, channel_bars=5760, rebalance_bars=240, hold_bars=5760, max_weight=0.14, **_):
