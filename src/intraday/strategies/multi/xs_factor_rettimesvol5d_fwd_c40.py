"""xs_factor_rettimesvol5d_fwd_c40 — auto-generated XS factor.

Signal: ret_times_vol_5d  direction=fwd  concentration=0.4
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_ret_times_vol_5d_fwd_c40",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorRettimesvol5dFwdC40(XsFactorBase):
