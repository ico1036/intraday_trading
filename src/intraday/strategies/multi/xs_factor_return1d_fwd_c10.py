"""xs_factor_return1d_fwd_c10 — auto-generated XS factor.

Signal: return_1d  direction=fwd  concentration=0.1
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_return_1d_fwd_c10",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorReturn1dFwdC10(XsFactorBase):
