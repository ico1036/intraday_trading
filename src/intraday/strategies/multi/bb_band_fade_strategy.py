"""Per-symbol Bollinger Band fade with signal-flip exit.

SHORT when close > upper band (mean + k·sigma); LONG when close < lower band.
Hold until OPPOSITE band touch flips position. Hourly rebalance.
"""
