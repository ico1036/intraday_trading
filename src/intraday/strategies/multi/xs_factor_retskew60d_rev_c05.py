"""xs_factor_retskew60d_rev_c05 — auto-generated XS factor.

Signal: ret_skew_60d  direction=rev  concentration=0.05
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_ret_skew_60d_rev_c05",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorRetskew60dRevC05(XsFactorBase):
