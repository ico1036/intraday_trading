"""is_055_ts_donchian_2week_4day — Donchian breakout asymmetric variant."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_2week_4day",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_2week_4day.md"]


class TsDonchian2week4dayStrategy:
    def __init__(self, symbols, channel_bars=20160, rebalance_bars=240, hold_bars=5760, max_weight=0.14, **_):
