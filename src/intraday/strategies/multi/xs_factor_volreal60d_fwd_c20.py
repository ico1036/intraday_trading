"""xs_factor_volreal60d_fwd_c20 — auto-generated XS factor.

Signal: vol_real_60d  direction=fwd  concentration=0.2
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_vol_real_60d_fwd_c20",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorVolreal60dFwdC20(XsFactorBase):
