"""is_022_ts_donchian_5day — Donchian breakout variant."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_5day",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_5day.md"]


class TsDonchian5dayStrategy:
    def __init__(self, symbols, channel_bars=7200, rebalance_bars=240, hold_bars=7200, max_weight=0.14, **_):
