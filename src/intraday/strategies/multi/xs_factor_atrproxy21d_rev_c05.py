"""xs_factor_atrproxy21d_rev_c05 — auto-generated XS factor.

Signal: atr_proxy_21d  direction=rev  concentration=0.05
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_atr_proxy_21d_rev_c05",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorAtrproxy21dRevC05(XsFactorBase):
