"""xs_factor_volgrowth20d_rev_c40 — auto-generated XS factor.

Signal: vol_growth_20d  direction=rev  concentration=0.4
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_vol_growth_20d_rev_c40",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorVolgrowth20dRevC40(XsFactorBase):
