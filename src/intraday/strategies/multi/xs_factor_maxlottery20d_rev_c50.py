"""xs_factor_maxlottery20d_rev_c50 — auto-generated XS factor.

Signal: max_lottery_20d  direction=rev  concentration=0.5
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_max_lottery_20d_rev_c50",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorMaxlottery20dRevC50(XsFactorBase):
