"""is_063_ts_compose_donchian_2d7d — composite Donchian: enters only when fast AND slow channel agree."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_compose_donchian_2d7d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_compose_donchian_2d7d.md"]


class TsComposeDonchian2d7dStrategy:
