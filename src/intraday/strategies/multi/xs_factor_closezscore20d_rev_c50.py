"""xs_factor_closezscore20d_rev_c50 — auto-generated XS factor.

Signal: close_zscore_20d  direction=rev  concentration=0.5
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_close_zscore_20d_rev_c50",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorClosezscore20dRevC50(XsFactorBase):
