"""xs_reg_kitchen_a0p1_t60_rev_c30 — auto-generated ridge cross-sectional regression alpha.

Features: ['ret1d', 'ret5d', 'ret20d', 'ret60d', 'logvol', 'vol20d', 'rev_ma20', 'dist_hi20', 'maxlot20', 'absret20']  ridge α=0.1  train window=60d
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_reg_kitchen_a0p1_t60_rev_c30",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_regression_zoo.md"]


class XsRegKitchenA0p1T60RevC30(XsRegressionBase):
