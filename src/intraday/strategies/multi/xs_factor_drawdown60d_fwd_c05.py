"""xs_factor_drawdown60d_fwd_c05 — auto-generated XS factor.

Signal: drawdown_60d  direction=fwd  concentration=0.05
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_drawdown_60d_fwd_c05",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorDrawdown60dFwdC05(XsFactorBase):
