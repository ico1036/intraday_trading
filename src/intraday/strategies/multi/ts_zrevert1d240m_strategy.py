"""is_117_ts_zrevert_1d_240m — extreme z-score mean reversion.
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_zrevert_1d_240m",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_zrevert_1d_240m.md"]


class TsZrevert1d240mStrategy:
    def __init__(self, symbols, window_bars=1440, hold_bars=240,
                 rebalance_bars=60, entry_z=2.5, max_weight=0.07,
                 history_bars=2880, **_):
