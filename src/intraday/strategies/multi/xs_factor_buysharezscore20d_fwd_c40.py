"""xs_factor_buysharezscore20d_fwd_c40 — auto-generated XS factor.

Signal: buy_share_zscore_20d  direction=fwd  concentration=0.4
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_buy_share_zscore_20d_fwd_c40",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorBuysharezscore20dFwdC40(XsFactorBase):
