"""xs_factor_drawdown120d_rev_c05 — auto-generated XS factor.

Signal: drawdown_120d  direction=rev  concentration=0.05
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_drawdown_120d_rev_c05",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorDrawdown120dRevC05(XsFactorBase):
