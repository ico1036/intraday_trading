"""xs_factor_volreal252d_fwd_c30 — auto-generated XS factor.

Signal: vol_real_252d  direction=fwd  concentration=0.3
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_vol_real_252d_fwd_c30",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorVolreal252dFwdC30(XsFactorBase):
