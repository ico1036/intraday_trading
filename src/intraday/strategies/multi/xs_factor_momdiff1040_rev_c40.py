"""xs_factor_momdiff1040_rev_c40 — auto-generated XS factor.

Signal: mom_diff_10_40  direction=rev  concentration=0.4
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_mom_diff_10_40_rev_c40",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorMomdiff1040RevC40(XsFactorBase):
