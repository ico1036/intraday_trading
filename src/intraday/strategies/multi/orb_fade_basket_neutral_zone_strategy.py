"""ORB-fade basket_full with NEUTRAL_ZONE exit (raw transform).

Cell exit value differs from is_017 (time_stop) and is_023 (signal_flip).
Closes positions when close re-enters the OR range.
"""
...
class OrbFadeBasketNeutralZoneStrategy:
    def __init__(
        self,
        symbols: list[str],
        or_minutes: int = 60,
