"""rsi_fade_symmetric_r480_l15h85_h2880_w060 — RSI extreme fade (long RSI<15, short RSI>85)."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "rsi_fade_symmetric_r480_l15h85_h2880_w060",
}
SOURCE_NOTES: list[str] = ["research/notes/rsi_fade_symmetric.md"]


class RsiFadeSymmetricR480L15h85H2880W060Strategy:
    def __init__(self, symbols, rsi_bars=480, rebalance_bars=60,
