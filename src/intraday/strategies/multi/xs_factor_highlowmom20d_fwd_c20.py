"""xs_factor_highlowmom20d_fwd_c20 — auto-generated XS factor.

Signal: high_low_mom_20d  direction=fwd  concentration=0.2
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_high_low_mom_20d_fwd_c20",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorHighlowmom20dFwdC20(XsFactorBase):
