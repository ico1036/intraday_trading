"""xs_factor_sharpeproxy60d_fwd_c20 — auto-generated XS factor.

Signal: sharpe_proxy_60d  direction=fwd  concentration=0.2
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_sharpe_proxy_60d_fwd_c20",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorSharpeproxy60dFwdC20(XsFactorBase):
