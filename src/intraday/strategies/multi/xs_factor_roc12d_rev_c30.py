"""xs_factor_roc12d_rev_c30 — auto-generated XS factor.

Signal: roc_12d  direction=rev  concentration=0.3
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_roc_12d_rev_c30",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorRoc12dRevC30(XsFactorBase):
