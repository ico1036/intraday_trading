"""ts_donchian_symmetric_v3_f2d_s18d_h63d_w030 — symmetric Donchian persist (v3 fine-tune around v2 working zone)."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_symmetric_v3_f2d_s18d_h63d_w030",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_symmetric.md"]


class TsDonchianSymmetricV3F2dS18dH63dW030Strategy:
