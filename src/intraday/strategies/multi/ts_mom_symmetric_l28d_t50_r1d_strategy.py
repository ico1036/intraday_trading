"""is_705_ts_mom_symmetric_l28d_t50_r1d — TS-mom symmetric: long if past 28d return > 5.0%, short if < -5.0%."""
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "ts_mom_symmetric_l28d_t50_r1d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_mom_symmetric.md"]


class TsMomSymmetricL28dT50R1dStrategy:
