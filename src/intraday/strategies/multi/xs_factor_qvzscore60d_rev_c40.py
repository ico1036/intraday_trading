"""xs_factor_qvzscore60d_rev_c40 — auto-generated XS factor.

Signal: qv_zscore_60d  direction=rev  concentration=0.4
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_qv_zscore_60d_rev_c40",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorQvzscore60dRevC40(XsFactorBase):
