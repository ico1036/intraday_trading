"""LR residual fade topk z_score (untried for lr_residual family)."""
...
class LrResidualTopkZscoreStrategy:
    def __init__(self, symbols, top_k=3, lookback=120, history_size=30, entry_z=1.0, max_weight=0.25, **_):
