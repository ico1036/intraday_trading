"""is_502_ts_atr_break_long_w240_m20_h21d — ATR-band breakout long, hold 21d."""
...
ALPHA_CELL = {
    ...
    "idea_family": "ts_atr_break_long_w240_m20_h21d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_atr_break_long_w240_m20_h21d.md"]


class TsAtrBreakLongW240m20H21DStrategy:
    def __init__(self, symbols, atr_window=240, atr_mult=2.0, ma_window=7200,
