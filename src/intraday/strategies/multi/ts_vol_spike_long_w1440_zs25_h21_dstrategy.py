"""is_529_ts_vol_spike_long_w1440_zs25_h21d — volume-spike long, hold 21d."""
...
ALPHA_CELL = {
    ...
    "idea_family": "ts_vol_spike_long_w1440_zs25_h21d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_vol_spike_long_w1440_zs25_h21d.md"]


class TsVolSpikeLongW1440Zs25H21DStrategy:
    def __init__(self, symbols, vol_window=1440, vol_zscore=2.5,
