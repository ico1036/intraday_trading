"""is_251_ts_donchian_long_persist_5d10d_h35d_w038 — long-only persist Donchian variant."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_long_persist_5d10d_h35d_w038",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_long_persist_5d10d_h35d_w038.md"]


class TsDonchianLongPersist5D10DH35dW038Strategy:
