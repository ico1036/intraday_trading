"""xs_factor_momratio1060_rev_c50 — auto-generated XS factor.

Signal: mom_ratio_10_60  direction=rev  concentration=0.5
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_mom_ratio_10_60_rev_c50",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorMomratio1060RevC50(XsFactorBase):
