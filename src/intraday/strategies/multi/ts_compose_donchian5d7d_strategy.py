"""is_057_ts_compose_donchian_5d7d — composite Donchian: enters only when fast AND slow channel agree."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_compose_donchian_5d7d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_compose_donchian_5d7d.md"]


class TsComposeDonchian5d7dStrategy:
    def __init__(self, symbols, fast_channel_bars=7200, slow_channel_bars=10080,
                 rebalance_bars=240, hold_bars=5760, max_weight=0.14, **_):
