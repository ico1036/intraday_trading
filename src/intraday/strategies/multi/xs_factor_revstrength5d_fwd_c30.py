"""xs_factor_revstrength5d_fwd_c30 — auto-generated XS factor.

Signal: rev_strength_5d  direction=fwd  concentration=0.3
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_rev_strength_5d_fwd_c30",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorRevstrength5dFwdC30(XsFactorBase):
