"""bb_fade_symmetric_l60_z25_h240_w060 — BB-band fade symmetric (Z>τ short, Z<-τ long), hold N bars."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "bb_fade_symmetric_l60_z25_h240_w060",
}
SOURCE_NOTES: list[str] = ["research/notes/bb_fade_symmetric.md"]


class BbFadeSymmetricL60Z25H240W060Strategy:
