"""BB-fade basket_topk time_stop percentile."""
...
class BbFadeBasketTopkTsPctStrategy:
    def __init__(self, symbols, window=1440, top_k=2, history_size=30, entry_pctile=0.30, flat_at_minute=1410, rebalance_bars=60, max_weight=0.20, **_):
    ...
    def generate_order(self, state):
        ...
        for s in self.symbols:
            ...
            if len(hist) >= 5:
                ...
                if absz < hist_sorted[idx]: continue
            else:
