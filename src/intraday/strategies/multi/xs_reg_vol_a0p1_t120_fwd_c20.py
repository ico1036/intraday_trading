"""xs_reg_vol_a0p1_t120_fwd_c20 — auto-generated ridge cross-sectional regression alpha.
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_reg_vol_a0p1_t120_fwd_c20",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_regression_zoo.md"]


class XsRegVolA0p1T120FwdC20(XsRegressionBase):
