"""xs_factor_retskew252d_rev_c30 — auto-generated XS factor.

Signal: ret_skew_252d  direction=rev  concentration=0.3
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_ret_skew_252d_rev_c30",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorRetskew252dRevC30(XsFactorBase):
