"""is_541_ts_vol_regime_long_vw1440_e40_h28d — low-vol regime long, hold 28d."""
...
ALPHA_CELL = {
    ...
    "idea_family": "ts_vol_regime_long_vw1440_e40_h28d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_vol_regime_long_vw1440_e40_h28d.md"]


class TsVolRegimeLongVw1440E40H28DStrategy:
    def __init__(self, symbols, vol_window=1440, norm_window=43200,
                 vol_pct_entry=0.4, vol_pct_exit=0.85,
