"""xs_factor_closezscore252d_rev_c40 — auto-generated XS factor.

Signal: close_zscore_252d  direction=rev  concentration=0.4
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_close_zscore_252d_rev_c40",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorClosezscore252dRevC40(XsFactorBase):
