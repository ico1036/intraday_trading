"""xs_factor_retsignstreak5d_fwd_c10 — auto-generated XS factor.

Signal: ret_sign_streak_5d  direction=fwd  concentration=0.1
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_ret_sign_streak_5d_fwd_c10",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorRetsignstreak5dFwdC10(XsFactorBase):
