"""Session extreme revert multi_day basket z_score."""
...
class SextMultidayBasketZscoreDollarStrategy:
    def __init__(self, symbols, lookback_days=3, history_size=30, entry_z=0.4, max_weight=0.13, **_):
