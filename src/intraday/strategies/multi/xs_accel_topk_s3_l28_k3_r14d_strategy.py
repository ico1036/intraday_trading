"""is_923_xs_accel_topk_s3_l28_k3_r14d — basket-relative accel long top-K."""
...
ALPHA_CELL = {
    ...
    "idea_family": "xs_accel_topk_s3_l28_k3_r14d",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_accel_topk_s3_l28_k3_r14d.md"]


class XsAccelTopkS3L28K3R14dStrategy:
    def __init__(self, symbols, short_w=4320, long_w=40320, top_k=3,
