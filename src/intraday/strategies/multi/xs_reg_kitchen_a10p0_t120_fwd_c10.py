"""xs_reg_kitchen_a10p0_t120_fwd_c10 — auto-generated ridge cross-sectional regression alpha.
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_reg_kitchen_a10p0_t120_fwd_c10",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_regression_zoo.md"]


class XsRegKitchenA10p0T120FwdC10(XsRegressionBase):
