"""xs_factor_volreal5d_fwd_c30 — auto-generated XS factor.

Signal: vol_real_5d  direction=fwd  concentration=0.3
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_vol_real_5d_fwd_c30",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorVolreal5dFwdC30(XsFactorBase):
