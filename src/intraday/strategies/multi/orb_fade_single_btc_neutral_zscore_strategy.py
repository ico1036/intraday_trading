"""ORB-fade single BTC neutral_zone z_score."""
...
class OrbFadeSingleBtcNeutralZscoreStrategy:
    def __init__(self, symbols, target="BTCUSDT", or_minutes=30, history_size=30, entry_z=0.5,
                 neutral_band=0.4, max_weight=0.5, **_):
