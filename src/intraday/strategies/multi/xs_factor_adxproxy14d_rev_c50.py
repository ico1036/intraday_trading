"""xs_factor_adxproxy14d_rev_c50 — auto-generated XS factor.

Signal: adx_proxy_14d  direction=rev  concentration=0.5
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_adx_proxy_14d_rev_c50",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorAdxproxy14dRevC50(XsFactorBase):
