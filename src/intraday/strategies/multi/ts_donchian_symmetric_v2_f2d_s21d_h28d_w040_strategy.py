"""ts_donchian_symmetric_v2_f2d_s21d_h28d_w040 — symmetric Donchian persist (long upper + short lower), tuned position sizing."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_symmetric_v2_f2d_s21d_h28d_w040",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_symmetric.md"]


class TsDonchianSymmetricV2F2dS21dH28dW040Strategy:
