"""is_624_ts_accel_long_s3_l28_h21d — return acceleration long."""
...
ALPHA_CELL = {
    ...
    "idea_family": "ts_accel_long_s3_l28_h21d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_accel_long_s3_l28_h21d.md"]


class TsAccelLongS3L28H21DStrategy:
    def __init__(self, symbols, short_window=4320, long_window=40320,
