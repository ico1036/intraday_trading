"""is_565_xs_mom_rank_l10d_k1_r3d — cross-section past-10d return rank, long top-1 / short bottom-1."""
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_mom_rank_l10d_k1_r3d",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_mom_rank.md"]


class XsMomRankL10dK1R3dStrategy:
    def __init__(self, symbols, lookback_bars=14400, rebalance_bars=4320,
