"""is_293_ts_donchian_long_persist_1d10d_h35d_w042 — long-only persist Donchian variant (round 17)."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_long_persist_1d10d_h35d_w042",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_long_persist_1d10d_h35d_w042.md"]


class TsDonchianLongPersistR171D10DH35dW042Strategy:
