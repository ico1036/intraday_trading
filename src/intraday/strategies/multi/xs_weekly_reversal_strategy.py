"""is_007_xs_weekly_reversal — cross-sectional 7-day return reversal.

Slower-cadence sibling of is_003_xs_daily_reversal. Same XS reversal
direction (long the worst, short the best of the trailing 7d), but only
~12 rebalance events over 90 days → roughly 10x lower fee drag.
"""
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_weekly_reversal",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_weekly_reversal.md"]


class XsWeeklyReversalStrategy:
    def __init__(
        self,
        symbols: list[str],
