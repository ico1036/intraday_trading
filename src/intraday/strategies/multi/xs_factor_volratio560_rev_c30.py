"""xs_factor_volratio560_rev_c30 — auto-generated XS factor.

Signal: vol_ratio_5_60  direction=rev  concentration=0.3
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_vol_ratio_5_60_rev_c30",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorVolratio560RevC30(XsFactorBase):
