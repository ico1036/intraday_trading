"""xs_factor_logdollarvolume_rev_c10 — auto-generated XS factor.

Signal: log_dollar_volume  direction=rev  concentration=0.1
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_log_dollar_volume_rev_c10",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorLogdollarvolumeRevC10(XsFactorBase):
