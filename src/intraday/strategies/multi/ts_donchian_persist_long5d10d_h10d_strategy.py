"""is_137_ts_donchian_persist_long5d10d_h10d — long-only persist Donchian (no shorts)."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_persist_long5d10d_h10d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_persist_long5d10d_h10d.md"]


class TsDonchianPersistLong5d10dH10dStrategy:
    def __init__(self, symbols, fast_channel_bars=7200, slow_channel_bars=14400,
                 rebalance_bars=240, hold_bars=14400, max_weight=0.07, **_):
    ...
    def generate_order(self, state):
        ...
        if self._bar_count % self.rebalance_bars == 0:
            ...
            for s in self.symbols:
                ...
                # LONG-ONLY: enter only when regime LONG, no SHORT side.
