"""is_167_ts_donchian_long_persist_5d3week_h21d_w04 — long-only persist Donchian, very long hold."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_long_persist_5d3week_h21d_w04",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_long_persist_5d3week_h21d_w04.md"]


class TsDonchianLongPersist5d3weekH21dW04Strategy:
