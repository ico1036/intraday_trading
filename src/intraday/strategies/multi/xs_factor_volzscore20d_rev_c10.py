"""xs_factor_volzscore20d_rev_c10 — auto-generated XS factor.

Signal: vol_zscore_20d  direction=rev  concentration=0.1
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_vol_zscore_20d_rev_c10",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorVolzscore20dRevC10(XsFactorBase):
