"""xs_factor_volreal5d_fwd_c10 — auto-generated XS factor.

Signal: vol_real_5d  direction=fwd  concentration=0.1
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_vol_real_5d_fwd_c10",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorVolreal5dFwdC10(XsFactorBase):
