"""is_756_ts_new_high_long_w14400_h28d_r1d — new-high follow-through long."""
...
ALPHA_CELL = {
    ...
    "idea_family": "ts_new_high_long_w14400_h28d_r1d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_new_high_long_w14400_h28d_r1d.md"]


class TsNewHighLongW14400H28DR1DStrategy:
    def __init__(self, symbols, window=14400,
                 rebalance_bars=1440, hold_bars=40320, max_weight=0.035, **_):
