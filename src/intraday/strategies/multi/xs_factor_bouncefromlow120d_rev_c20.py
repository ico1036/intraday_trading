"""xs_factor_bouncefromlow120d_rev_c20 — auto-generated XS factor.

Signal: bounce_from_low_120d  direction=rev  concentration=0.2
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_bounce_from_low_120d_rev_c20",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorBouncefromlow120dRevC20(XsFactorBase):
