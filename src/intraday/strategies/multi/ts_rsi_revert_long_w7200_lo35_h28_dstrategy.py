"""is_513_ts_rsi_revert_long_w7200_lo35_h28d — RSI oversold long, hold 28d."""
...
ALPHA_CELL = {
    ...
    "idea_family": "ts_rsi_revert_long_w7200_lo35_h28d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_rsi_revert_long_w7200_lo35_h28d.md"]


class TsRsiRevertLongW7200Lo35H28DStrategy:
    def __init__(self, symbols, rsi_window=7200, rsi_lower=35,
