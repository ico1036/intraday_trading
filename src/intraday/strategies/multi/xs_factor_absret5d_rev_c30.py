"""xs_factor_absret5d_rev_c30 — auto-generated XS factor.

Signal: abs_ret_5d  direction=rev  concentration=0.3
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_abs_ret_5d_rev_c30",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorAbsret5dRevC30(XsFactorBase):
