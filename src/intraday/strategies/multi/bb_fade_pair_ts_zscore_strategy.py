"""BB-fade pair time_stop z_score."""
...
class BbFadePairTsZscoreStrategy:
    def __init__(self, symbols, leg_a="BTCUSDT", leg_b="ETHUSDT", window=1440, k=2.0, flat_at_minute=1410, rebalance_bars=60, max_weight=0.30, **_):
