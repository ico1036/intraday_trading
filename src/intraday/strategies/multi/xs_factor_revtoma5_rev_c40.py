"""xs_factor_revtoma5_rev_c40 — auto-generated XS factor.

Signal: rev_to_ma5  direction=rev  concentration=0.4
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_rev_to_ma5_rev_c40",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorRevtoma5RevC40(XsFactorBase):
