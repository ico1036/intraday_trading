"""xs_factor_mom121_rev_c30 — auto-generated XS factor.

Signal: mom_12_1  direction=rev  concentration=0.3
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_mom_12_1_rev_c30",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorMom121RevC30(XsFactorBase):
