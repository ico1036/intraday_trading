"""xs_factor_retskew252d_rev_c10 — auto-generated XS factor.

Signal: ret_skew_252d  direction=rev  concentration=0.1
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_ret_skew_252d_rev_c10",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorRetskew252dRevC10(XsFactorBase):
