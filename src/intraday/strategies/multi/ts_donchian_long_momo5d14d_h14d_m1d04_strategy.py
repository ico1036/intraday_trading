"""is_156_ts_donchian_long_momo_5d14d_h14d_m1d_w04 — long-only persist Donchian, momentum-confirmed re-entry."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_long_momo_5d14d_h14d_m1d_w04",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_long_momo_5d14d_h14d_m1d_w04.md"]


class TsDonchianLongMomo5d14dH14dM1d04Strategy:
