"""is_961_ts_disp_low_long_lk4320_dp20_h28d — low-dispersion long basket."""
...
ALPHA_CELL = {
    ...
    "idea_family": "ts_disp_low_long_lk4320_dp20_h28d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_disp_low_long_lk4320_dp20_h28d.md"]


class TsDispLowLongLk4320Dp20H28DStrategy:
    def __init__(self, symbols, lookback=4320, disp_pct=0.2,
