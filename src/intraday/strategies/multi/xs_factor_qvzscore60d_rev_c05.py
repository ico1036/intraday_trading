"""xs_factor_qvzscore60d_rev_c05 — auto-generated XS factor.

Signal: qv_zscore_60d  direction=rev  concentration=0.05
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_qv_zscore_60d_rev_c05",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorQvzscore60dRevC05(XsFactorBase):
