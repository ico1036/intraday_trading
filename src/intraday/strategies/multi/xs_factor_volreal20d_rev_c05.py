"""xs_factor_volreal20d_rev_c05 — auto-generated XS factor.

Signal: vol_real_20d  direction=rev  concentration=0.05
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_vol_real_20d_rev_c05",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorVolreal20dRevC05(XsFactorBase):
