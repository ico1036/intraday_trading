"""xs_factor_closezscore10d_fwd_c20 — auto-generated XS factor.

Signal: close_zscore_10d  direction=fwd  concentration=0.2
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_close_zscore_10d_fwd_c20",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorClosezscore10dFwdC20(XsFactorBase):
