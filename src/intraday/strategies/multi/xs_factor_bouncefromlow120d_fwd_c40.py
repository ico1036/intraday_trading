"""xs_factor_bouncefromlow120d_fwd_c40 — auto-generated XS factor.

Signal: bounce_from_low_120d  direction=fwd  concentration=0.4
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_bounce_from_low_120d_fwd_c40",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorBouncefromlow120dFwdC40(XsFactorBase):
