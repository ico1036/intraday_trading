"""LR residual fade basket composite."""
...
class LrResidualBasketCompStrategy:
    def __init__(self, symbols, lookback=120, history_size=30, entry_thr=0.5, max_weight=0.13, **_):
