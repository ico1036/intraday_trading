"""xs_factor_bbpos20d_fwd_c30 — auto-generated XS factor.

Signal: bb_pos_20d  direction=fwd  concentration=0.3
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_bb_pos_20d_fwd_c30",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorBbpos20dFwdC30(XsFactorBase):
