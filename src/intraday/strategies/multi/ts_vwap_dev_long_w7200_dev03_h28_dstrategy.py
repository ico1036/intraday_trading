"""is_536_ts_vwap_dev_long_w7200_dev03_h28d — VWAP-deviation long, hold 28d."""
...
ALPHA_CELL = {
    ...
    "idea_family": "ts_vwap_dev_long_w7200_dev03_h28d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_vwap_dev_long_w7200_dev03_h28d.md"]


class TsVwapDevLongW7200Dev03H28DStrategy:
    def __init__(self, symbols, window_bars=7200, deviation_pct=0.03,
