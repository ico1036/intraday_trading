"""xs_factor_return126d_rev_c20 — auto-generated XS factor.

Signal: return_126d  direction=rev  concentration=0.2
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_return_126d_rev_c20",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorReturn126dRevC20(XsFactorBase):
