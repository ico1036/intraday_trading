"""is_624_xs_revert_rank_l28d_k1_r7d — cross-section past-28d reversal rank, long bottom-1 / short top-1."""
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_revert_rank_l28d_k1_r7d",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_revert_rank.md"]


class XsRevertRankL28dK1R7dStrategy:
