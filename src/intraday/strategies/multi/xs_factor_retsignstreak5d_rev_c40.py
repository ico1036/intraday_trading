"""xs_factor_retsignstreak5d_rev_c40 — auto-generated XS factor.

Signal: ret_sign_streak_5d  direction=rev  concentration=0.4
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_ret_sign_streak_5d_rev_c40",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorRetsignstreak5dRevC40(XsFactorBase):
