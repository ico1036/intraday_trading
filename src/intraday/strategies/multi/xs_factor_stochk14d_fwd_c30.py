"""xs_factor_stochk14d_fwd_c30 — auto-generated XS factor.

Signal: stoch_k_14d  direction=fwd  concentration=0.3
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_stoch_k_14d_fwd_c30",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorStochk14dFwdC30(XsFactorBase):
