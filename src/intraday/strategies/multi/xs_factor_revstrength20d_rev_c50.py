"""xs_factor_revstrength20d_rev_c50 — auto-generated XS factor.

Signal: rev_strength_20d  direction=rev  concentration=0.5
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_rev_strength_20d_rev_c50",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorRevstrength20dRevC50(XsFactorBase):
