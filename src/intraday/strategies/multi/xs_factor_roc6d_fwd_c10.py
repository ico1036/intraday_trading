"""xs_factor_roc6d_fwd_c10 — auto-generated XS factor.

Signal: roc_6d  direction=fwd  concentration=0.1
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_roc_6d_fwd_c10",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorRoc6dFwdC10(XsFactorBase):
