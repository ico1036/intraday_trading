"""xs_range_fade_l5d_k1_r7d_w060 — cross-section: rank by close position in N-day range, fade extremes."""
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_range_fade_l5d_k1_r7d_w060",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_range_position_fade.md"]


class XsRangeFadeL5dK1R7dW060Strategy:
