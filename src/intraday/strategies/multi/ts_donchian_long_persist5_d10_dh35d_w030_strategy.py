"""is_249_ts_donchian_long_persist_5d10d_h35d_w030 — long-only persist Donchian variant."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_long_persist_5d10d_h35d_w030",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_long_persist_5d10d_h35d_w030.md"]


class TsDonchianLongPersist5D10DH35dW030Strategy:
