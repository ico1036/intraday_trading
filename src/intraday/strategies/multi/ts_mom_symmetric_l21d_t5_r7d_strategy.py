"""is_686_ts_mom_symmetric_l21d_t5_r7d — TS-mom symmetric: long if past 21d return > 0.5%, short if < -0.5%."""
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "ts_mom_symmetric_l21d_t5_r7d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_mom_symmetric.md"]


class TsMomSymmetricL21dT5R7dStrategy:
