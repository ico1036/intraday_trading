"""is_745_ts_new_high_long_w4320_h28d_r7d — new-high follow-through long."""
...
ALPHA_CELL = {
    ...
    "idea_family": "ts_new_high_long_w4320_h28d_r7d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_new_high_long_w4320_h28d_r7d.md"]


class TsNewHighLongW4320H28DR7DStrategy:
    def __init__(self, symbols, window=4320,
