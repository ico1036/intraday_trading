"""Session extreme revert multi_day basket percentile."""
...
class SextMultidayBasketPctDollarStrategy:
    def __init__(self, symbols, lookback_days=3, history_size=30, pct=0.5, max_weight=0.13, **_):
