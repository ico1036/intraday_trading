"""ORB-fade session single ETH z_score (different from BTC variant)."""
...
class OrbFadeSingleEthZscoreStrategy:
    def __init__(self, symbols, target="ETHUSDT", or_minutes=30, history_size=30, entry_z=0.7, max_weight=0.5, **_):
