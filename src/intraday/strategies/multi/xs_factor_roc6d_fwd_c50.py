"""xs_factor_roc6d_fwd_c50 — auto-generated XS factor.

Signal: roc_6d  direction=fwd  concentration=0.5
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_roc_6d_fwd_c50",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorRoc6dFwdC50(XsFactorBase):
