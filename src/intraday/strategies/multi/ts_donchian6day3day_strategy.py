"""is_050_ts_donchian_6day_3day — Donchian breakout asymmetric variant."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_6day_3day",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_6day_3day.md"]


class TsDonchian6day3dayStrategy:
    def __init__(self, symbols, channel_bars=8640, rebalance_bars=240, hold_bars=4320, max_weight=0.14, **_):
