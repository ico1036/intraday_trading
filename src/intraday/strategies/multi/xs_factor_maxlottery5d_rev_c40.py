"""xs_factor_maxlottery5d_rev_c40 — auto-generated XS factor.

Signal: max_lottery_5d  direction=rev  concentration=0.4
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_max_lottery_5d_rev_c40",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorMaxlottery5dRevC40(XsFactorBase):
