"""xs_factor_logretsum20d_rev_c30 — auto-generated XS factor.

Signal: log_ret_sum_20d  direction=rev  concentration=0.3
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_log_ret_sum_20d_rev_c30",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorLogretsum20dRevC30(XsFactorBase):
