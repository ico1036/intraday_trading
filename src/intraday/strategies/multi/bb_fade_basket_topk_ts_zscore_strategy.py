"""BB-fade basket_topk time_stop z_score."""
...
class BbFadeBasketTopkTsZscoreStrategy:
    def __init__(self, symbols, window=1440, k=2.0, top_k=2, flat_at_minute=1410, rebalance_bars=60, max_weight=0.20, **_):
