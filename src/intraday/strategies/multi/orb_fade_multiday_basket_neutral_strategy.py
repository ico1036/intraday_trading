"""ORB-fade multi_day basket neutral_zone."""
...
class OrbFadeMultidayBasketNeutralStrategy:
    def __init__(self, symbols, or_minutes=30, lookback_days=3, neutral_band=0.4, max_weight=0.13, **_):
    ...
    def generate_order(self, state):
        ...
        for s in self.symbols:
            ...
            mid = (multi_hi + multi_lo) / 2
            cur = self._current_side(state, s)
            if cur in {"LONG", "SHORT"} and abs(cl - mid) <= self.neutral_band * mw:
