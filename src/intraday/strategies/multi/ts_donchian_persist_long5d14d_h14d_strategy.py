"""is_135_ts_donchian_persist_long5d14d_h14d — long-only persist Donchian (no shorts)."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_persist_long5d14d_h14d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_persist_long5d14d_h14d.md"]


class TsDonchianPersistLong5d14dH14dStrategy:
