"""ts_mom_symmetric_v2_l14d_t10_r7d_w040 — TS-mom symmetric (v2), tuned position sizing."""
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "ts_mom_symmetric_v2_l14d_t10_r7d_w040",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_mom_symmetric.md"]


class TsMomSymmetricV2L14dT10R7dW040Strategy:
    def __init__(self, symbols, lookback_bars=20160, rebalance_bars=10080,
                 entry_threshold=0.01, exit_threshold=0.003, max_weight=0.04, **_):
