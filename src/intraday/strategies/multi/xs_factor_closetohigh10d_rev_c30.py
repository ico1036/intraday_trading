"""xs_factor_closetohigh10d_rev_c30 — auto-generated XS factor.

Signal: close_to_high_10d  direction=rev  concentration=0.3
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_close_to_high_10d_rev_c30",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorClosetohigh10dRevC30(XsFactorBase):
