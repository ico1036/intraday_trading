"""xs_factor_stochk14d_fwd_c40 — auto-generated XS factor.

Signal: stoch_k_14d  direction=fwd  concentration=0.4
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_stoch_k_14d_fwd_c40",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorStochk14dFwdC40(XsFactorBase):
