"""is_647_ts_lead_lag_btc_lk14d_th10_h28d — long alts if BTC recently up."""
...
ALPHA_CELL = {
    ...
    "idea_family": "ts_lead_lag_btc_lk14d_th10_h28d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_lead_lag_btc_lk14d_th10_h28d.md"]


class TsLeadLagBtcLk14dTh10H28DStrategy:
    def __init__(self, symbols, btc_lookback=20160, btc_threshold=0.1,
