"""xs_factor_volratio520_fwd_c50 — auto-generated XS factor.

Signal: vol_ratio_5_20  direction=fwd  concentration=0.5
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_vol_ratio_5_20_fwd_c50",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorVolratio520FwdC50(XsFactorBase):
