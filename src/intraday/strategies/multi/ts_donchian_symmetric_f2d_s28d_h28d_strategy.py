"""is_319_ts_donchian_symmetric_f2d_s28d_h28d — symmetric Donchian persist (long upper-break + short lower-break)."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_symmetric_f2d_s28d_h28d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_symmetric.md"]


class TsDonchianSymmetricF2dS28dH28dStrategy:
    def __init__(self, symbols, fast_channel_bars=2880, slow_channel_bars=40320,
