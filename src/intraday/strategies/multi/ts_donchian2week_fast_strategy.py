"""is_026_ts_donchian_2week_fast — Donchian breakout variant."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_2week_fast",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_2week_fast.md"]


class TsDonchian2weekFastStrategy:
    def __init__(self, symbols, channel_bars=20160, rebalance_bars=60, hold_bars=20160, max_weight=0.14, **_):
