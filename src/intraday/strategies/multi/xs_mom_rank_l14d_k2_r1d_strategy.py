"""is_573_xs_mom_rank_l14d_k2_r1d — cross-section past-14d return rank, long top-2 / short bottom-2."""
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_mom_rank_l14d_k2_r1d",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_mom_rank.md"]


class XsMomRankL14dK2R1dStrategy:
