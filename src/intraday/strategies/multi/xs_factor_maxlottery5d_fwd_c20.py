"""xs_factor_maxlottery5d_fwd_c20 — auto-generated XS factor.

Signal: max_lottery_5d  direction=fwd  concentration=0.2
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_max_lottery_5d_fwd_c20",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorMaxlottery5dFwdC20(XsFactorBase):
