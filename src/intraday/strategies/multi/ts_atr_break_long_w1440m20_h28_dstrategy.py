"""is_507_ts_atr_break_long_w1440_m20_h28d — ATR-band breakout long, hold 28d."""
...
ALPHA_CELL = {
    ...
    "idea_family": "ts_atr_break_long_w1440_m20_h28d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_atr_break_long_w1440_m20_h28d.md"]


class TsAtrBreakLongW1440m20H28DStrategy:
    def __init__(self, symbols, atr_window=1440, atr_mult=2.0, ma_window=7200,
