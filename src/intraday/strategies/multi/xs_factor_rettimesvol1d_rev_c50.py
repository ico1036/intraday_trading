"""xs_factor_rettimesvol1d_rev_c50 — auto-generated XS factor.

Signal: ret_times_vol_1d  direction=rev  concentration=0.5
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_ret_times_vol_1d_rev_c50",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorRettimesvol1dRevC50(XsFactorBase):
