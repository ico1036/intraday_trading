"""xs_factor_closetohigh60d_rev_c05 — auto-generated XS factor.

Signal: close_to_high_60d  direction=rev  concentration=0.05
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_close_to_high_60d_rev_c05",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorClosetohigh60dRevC05(XsFactorBase):
