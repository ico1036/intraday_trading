"""xs_factor_return28d_fwd_c30 — auto-generated XS factor.

Signal: return_28d  direction=fwd  concentration=0.3
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_return_28d_fwd_c30",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorReturn28dFwdC30(XsFactorBase):
