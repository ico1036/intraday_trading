"""xs_factor_volreal60d_rev_c10 — auto-generated XS factor.

Signal: vol_real_60d  direction=rev  concentration=0.1
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_vol_real_60d_rev_c10",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorVolreal60dRevC10(XsFactorBase):
