"""is_806_ts_pullback_long_w10080_rp30_h14d — pullback-in-uptrend long."""
...
ALPHA_CELL = {
    ...
    "idea_family": "ts_pullback_long_w10080_rp30_h14d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_pullback_long_w10080_rp30_h14d.md"]


class TsPullbackLongW10080Rp30H14DStrategy:
    def __init__(self, symbols, window=10080, range_pct=0.3,
                 rebalance_bars=240, hold_bars=20160, max_weight=0.035, **_):
