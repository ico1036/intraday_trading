"""xs_factor_adxproxy14d_fwd_c05 — auto-generated XS factor.

Signal: adx_proxy_14d  direction=fwd  concentration=0.05
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_adx_proxy_14d_fwd_c05",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorAdxproxy14dFwdC05(XsFactorBase):
