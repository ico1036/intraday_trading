"""xs_factor_logretsum20d_rev_c40 — auto-generated XS factor.

Signal: log_ret_sum_20d  direction=rev  concentration=0.4
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_log_ret_sum_20d_rev_c40",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorLogretsum20dRevC40(XsFactorBase):
