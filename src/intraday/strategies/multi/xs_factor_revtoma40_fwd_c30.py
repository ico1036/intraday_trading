"""xs_factor_revtoma40_fwd_c30 — auto-generated XS factor.

Signal: rev_to_ma40  direction=fwd  concentration=0.3
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_rev_to_ma40_fwd_c30",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorRevtoma40FwdC30(XsFactorBase):
