"""xs_factor_volgrowth20d_fwd_c05 — auto-generated XS factor.

Signal: vol_growth_20d  direction=fwd  concentration=0.05
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_vol_growth_20d_fwd_c05",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorVolgrowth20dFwdC05(XsFactorBase):
