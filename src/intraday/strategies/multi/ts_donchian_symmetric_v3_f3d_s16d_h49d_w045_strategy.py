"""ts_donchian_symmetric_v3_f3d_s16d_h49d_w045 — symmetric Donchian persist (v3 fine-tune around v2 working zone)."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_symmetric_v3_f3d_s16d_h49d_w045",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_symmetric.md"]


class TsDonchianSymmetricV3F3dS16dH49dW045Strategy:
    def __init__(self, symbols, fast_channel_bars=4320, slow_channel_bars=23040,
                 rebalance_bars=240, hold_bars=70560, max_weight=0.045, **_):
