"""is_305_ts_donchian_long_persist_r18_a4 — long-only persist Donchian (round 18)."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_long_persist_r18_a4",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_long_persist_r18_a4.md"]


class TsDonchianLongPersistR18A4Strategy:
