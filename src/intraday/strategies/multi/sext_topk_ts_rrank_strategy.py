"""Session extreme revert topk time_stop rolling_rank."""
...
class SextTopkTsRrankStrategy:
    def __init__(self, symbols, top_k=3, history_size=30, rank_thr=0.5, max_weight=0.25, hold_bars=180, **_):
