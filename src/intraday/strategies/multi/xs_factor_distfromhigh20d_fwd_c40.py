"""xs_factor_distfromhigh20d_fwd_c40 — auto-generated XS factor.

Signal: dist_from_high_20d  direction=fwd  concentration=0.4
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_dist_from_high_20d_fwd_c40",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorDistfromhigh20dFwdC40(XsFactorBase):
