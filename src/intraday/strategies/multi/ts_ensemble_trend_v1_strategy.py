"""is_104_ts_ensemble_trend_v1 — ensemble of 3 trend-filter slots."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_ensemble_trend_v1",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_ensemble_trend_v1.md"]

_SLOTS = [(7200, 14400, 7200), (4320, 14400, 4320), (7200, 20160, 7200)]  # list of (fast, slow, hold)


class TsEnsembleTrendV1Strategy:
