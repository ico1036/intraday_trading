"""is_099_ts_donchian_persist_5d14d_h14d — persist Donchian, longer hold."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_persist_5d14d_h14d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_persist_5d14d_h14d.md"]


class TsDonchianPersist5d14dH14dStrategy:
