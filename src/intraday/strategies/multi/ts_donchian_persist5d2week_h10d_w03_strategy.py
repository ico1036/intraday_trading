"""is_129_ts_donchian_persist_5d2week_h10d_w03 — persist Donchian, smaller position."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_persist_5d2week_h10d_w03",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_persist_5d2week_h10d_w03.md"]


class TsDonchianPersist5d2weekH10dW03Strategy:
