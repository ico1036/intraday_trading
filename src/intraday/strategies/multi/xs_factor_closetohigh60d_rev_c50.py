"""xs_factor_closetohigh60d_rev_c50 — auto-generated XS factor.

Signal: close_to_high_60d  direction=rev  concentration=0.5
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_close_to_high_60d_rev_c50",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorClosetohigh60dRevC50(XsFactorBase):
