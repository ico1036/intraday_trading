"""xs_factor_atrproxy21d_fwd_c30 — auto-generated XS factor.

Signal: atr_proxy_21d  direction=fwd  concentration=0.3
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_atr_proxy_21d_fwd_c30",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorAtrproxy21dFwdC30(XsFactorBase):
