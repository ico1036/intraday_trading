"""BB band fade multi_day basket rolling_rank."""
...
class BbFadeMultidayBasketRrankStrategy:
    def __init__(self, symbols, lookback=720, k=2.0, history_size=30, rank_thr=0.6, max_weight=0.13, **_):
