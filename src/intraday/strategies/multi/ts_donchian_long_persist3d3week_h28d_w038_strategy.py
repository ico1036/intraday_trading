"""is_191_ts_donchian_long_persist_3d3week_h28d_w038 — long-only persist Donchian, extended hold."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_long_persist_3d3week_h28d_w038",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_long_persist_3d3week_h28d_w038.md"]


class TsDonchianLongPersist3d3weekH28dW038Strategy:
    def __init__(self, symbols, fast_channel_bars=4320, slow_channel_bars=30240,
                 rebalance_bars=240, hold_bars=40320, max_weight=0.038, **_):
