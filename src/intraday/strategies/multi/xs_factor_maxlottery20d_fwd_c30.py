"""xs_factor_maxlottery20d_fwd_c30 — auto-generated XS factor.

Signal: max_lottery_20d  direction=fwd  concentration=0.3
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_max_lottery_20d_fwd_c30",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorMaxlottery20dFwdC30(XsFactorBase):
