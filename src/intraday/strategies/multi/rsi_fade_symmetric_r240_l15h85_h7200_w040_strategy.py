"""rsi_fade_symmetric_r240_l15h85_h7200_w040 — RSI extreme fade (long RSI<15, short RSI>85)."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "rsi_fade_symmetric_r240_l15h85_h7200_w040",
}
SOURCE_NOTES: list[str] = ["research/notes/rsi_fade_symmetric.md"]


class RsiFadeSymmetricR240L15h85H7200W040Strategy:
    def __init__(self, symbols, rsi_bars=240, rebalance_bars=60,
