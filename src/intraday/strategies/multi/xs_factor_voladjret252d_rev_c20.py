"""xs_factor_voladjret252d_rev_c20 — auto-generated XS factor.

Signal: vol_adj_ret_252d  direction=rev  concentration=0.2
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_vol_adj_ret_252d_rev_c20",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorVoladjret252dRevC20(XsFactorBase):
