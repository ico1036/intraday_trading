"""is_671_ts_mom_symmetric_l10d_t50_r7d — TS-mom symmetric: long if past 10d return > 5.0%, short if < -5.0%."""
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "ts_mom_symmetric_l10d_t50_r7d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_mom_symmetric.md"]


class TsMomSymmetricL10dT50R7dStrategy:
