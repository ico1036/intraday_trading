"""is_753_ts_new_high_long_w7200_h42d_r7d — new-high follow-through long."""
...
ALPHA_CELL = {
    ...
    "idea_family": "ts_new_high_long_w7200_h42d_r7d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_new_high_long_w7200_h42d_r7d.md"]


class TsNewHighLongW7200H42DR7DStrategy:
