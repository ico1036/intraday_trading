"""is_851_ts_skew_long_w4320_st05_h28d — negative skew capitulation long."""
...
ALPHA_CELL = {
    ...
    "idea_family": "ts_skew_long_w4320_st05_h28d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_skew_long_w4320_st05_h28d.md"]


class TsSkewLongW4320St05H28DStrategy:
    def __init__(self, symbols, window=4320, skew_threshold=-0.5,
