"""ts_donchian_symmetric_v3_f3d_s18d_h49d_w045 — symmetric Donchian persist (v3 fine-tune around v2 working zone)."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_symmetric_v3_f3d_s18d_h49d_w045",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_symmetric.md"]


class TsDonchianSymmetricV3F3dS18dH49dW045Strategy:
