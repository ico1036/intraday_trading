"""is_123_ts_donchian_persist_3d14d_h14d_w05 — persist Donchian, smaller position."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_persist_3d14d_h14d_w05",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_persist_3d14d_h14d_w05.md"]


class TsDonchianPersist3d14dH14dW05Strategy:
    def __init__(self, symbols, fast_channel_bars=4320, slow_channel_bars=20160,
                 rebalance_bars=240, hold_bars=20160, max_weight=0.05, **_):
