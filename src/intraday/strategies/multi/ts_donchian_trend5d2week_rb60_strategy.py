"""is_082_ts_donchian_trend_5d2week_rb60 — Donchian trend-filter variant."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_trend_5d2week_rb60",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_trend_5d2week_rb60.md"]


class TsDonchianTrend5d2weekRb60Strategy:
    def __init__(self, symbols, fast_channel_bars=7200, slow_channel_bars=20160,
                 rebalance_bars=60, hold_bars=7200, max_weight=0.14, **_):
