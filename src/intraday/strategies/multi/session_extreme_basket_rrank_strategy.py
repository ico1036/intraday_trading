"""Session extreme revert basket rolling_rank transform."""
...
class SessionExtremeBasketRrankStrategy:
    def __init__(self, symbols, history_size=30, rank_thr=0.65, max_weight=0.13, **_):
    ...
    def generate_order(self, state):
        ...
        for s in self.symbols:
            ...
            if len(hist) >= 5:
                ...
                idx = sum(1 for h in sorted_h if h <= mag)
                rank = idx / len(sorted_h)
