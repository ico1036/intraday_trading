"""atr_fade_symmetric_m480_a240_k30_h480_w040 — ATR-channel fade symmetric (k=3.0 ATRs from EMA mean)."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "atr_fade_symmetric_m480_a240_k30_h480_w040",
}
SOURCE_NOTES: list[str] = ["research/notes/atr_fade_symmetric.md"]


class AtrFadeSymmetricM480A240K30H480W040Strategy:
