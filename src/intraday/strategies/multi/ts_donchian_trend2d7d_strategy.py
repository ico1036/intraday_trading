"""is_067_ts_donchian_trend_2d7d — Donchian trend-filter: slow regime + fast entry."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_trend_2d7d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_trend_2d7d.md"]


class TsDonchianTrend2d7dStrategy:
    def __init__(self, symbols, fast_channel_bars=2880, slow_channel_bars=10080,
