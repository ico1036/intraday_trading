"""is_092_ts_donchian_persist_5d2week_h3d — Donchian trend-filter with regime-persistent re-entry.
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_persist_5d2week_h3d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_persist_5d2week_h3d.md"]


class TsDonchianPersist5d2weekH3dStrategy:
