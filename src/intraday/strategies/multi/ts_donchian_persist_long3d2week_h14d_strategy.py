"""is_141_ts_donchian_persist_long3d2week_h14d — long-only persist Donchian (no shorts)."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_persist_long3d2week_h14d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_persist_long3d2week_h14d.md"]


class TsDonchianPersistLong3d2weekH14dStrategy:
    def __init__(self, symbols, fast_channel_bars=4320, slow_channel_bars=20160,
                 rebalance_bars=240, hold_bars=20160, max_weight=0.07, **_):
