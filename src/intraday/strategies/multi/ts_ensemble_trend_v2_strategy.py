"""is_105_ts_ensemble_trend_v2 — ensemble of 3 trend-filter slots."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_ensemble_trend_v2",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_ensemble_trend_v2.md"]

_SLOTS = [(7200, 14400, 10080), (4320, 20160, 10080), (7200, 20160, 7200)]  # list of (fast, slow, hold)


class TsEnsembleTrendV2Strategy:
