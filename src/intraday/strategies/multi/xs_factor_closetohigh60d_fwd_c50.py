"""xs_factor_closetohigh60d_fwd_c50 — auto-generated XS factor.

Signal: close_to_high_60d  direction=fwd  concentration=0.5
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_close_to_high_60d_fwd_c50",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorClosetohigh60dFwdC50(XsFactorBase):
