"""xs_factor_mom18021_rev_c20 — auto-generated XS factor.

Signal: mom_180_21  direction=rev  concentration=0.2
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_mom_180_21_rev_c20",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorMom18021RevC20(XsFactorBase):
