"""xs_factor_absret20d_rev_c05 — auto-generated XS factor.

Signal: abs_ret_20d  direction=rev  concentration=0.05
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_abs_ret_20d_rev_c05",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorAbsret20dRevC05(XsFactorBase):
