"""is_043_ts_donchian_7day_5day_hold — Donchian breakout variant."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_7day_5day_hold",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_7day_5day_hold.md"]


class TsDonchian7day5dayHoldStrategy:
    def __init__(self, symbols, channel_bars=10080, rebalance_bars=240, hold_bars=7200, max_weight=0.14, **_):
