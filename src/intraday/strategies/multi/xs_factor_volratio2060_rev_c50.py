"""xs_factor_volratio2060_rev_c50 — auto-generated XS factor.

Signal: vol_ratio_20_60  direction=rev  concentration=0.5
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_vol_ratio_20_60_rev_c50",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorVolratio2060RevC50(XsFactorBase):
