"""is_035_ts_donchian_2week_3day_hold — Donchian breakout variant."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_2week_3day_hold",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_2week_3day_hold.md"]


class TsDonchian2week3dayHoldStrategy:
    def __init__(self, symbols, channel_bars=20160, rebalance_bars=240, hold_bars=4320, max_weight=0.14, **_):
