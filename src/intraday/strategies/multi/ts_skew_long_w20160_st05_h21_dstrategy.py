"""is_862_ts_skew_long_w20160_st05_h21d — negative skew capitulation long."""
...
ALPHA_CELL = {
    ...
    "idea_family": "ts_skew_long_w20160_st05_h21d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_skew_long_w20160_st05_h21d.md"]


class TsSkewLongW20160St05H21DStrategy:
    def __init__(self, symbols, window=20160, skew_threshold=-0.5,
