"""xs_factor_vwapdist5d_rev_c50 — auto-generated XS factor.

Signal: vwap_dist_5d  direction=rev  concentration=0.5
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_vwap_dist_5d_rev_c50",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorVwapdist5dRevC50(XsFactorBase):
