"""ts_mom_symmetric_v2_l28d_t5_r7d_w040 — TS-mom symmetric (v2), tuned position sizing."""
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "ts_mom_symmetric_v2_l28d_t5_r7d_w040",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_mom_symmetric.md"]


class TsMomSymmetricV2L28dT5R7dW040Strategy:
    def __init__(self, symbols, lookback_bars=40320, rebalance_bars=10080,
                 entry_threshold=0.005, exit_threshold=0.0015, max_weight=0.04, **_):
