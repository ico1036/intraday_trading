"""is_070_ts_donchian_trend_2d10d — Donchian trend-filter: slow regime + fast entry."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_trend_2d10d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_trend_2d10d.md"]


class TsDonchianTrend2d10dStrategy:
    def __init__(self, symbols, fast_channel_bars=2880, slow_channel_bars=14400,
                 rebalance_bars=240, hold_bars=2880, max_weight=0.14, **_):
