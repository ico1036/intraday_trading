"""is_081_ts_donchian_trend_5d10d_rb60 — Donchian trend-filter variant."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_trend_5d10d_rb60",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_trend_5d10d_rb60.md"]


class TsDonchianTrend5d10dRb60Strategy:
    def __init__(self, symbols, fast_channel_bars=7200, slow_channel_bars=14400,
                 rebalance_bars=60, hold_bars=4320, max_weight=0.14, **_):
