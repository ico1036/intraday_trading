"""xs_factor_macd1226_fwd_c40 — auto-generated XS factor.

Signal: macd_12_26  direction=fwd  concentration=0.4
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_macd_12_26_fwd_c40",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorMacd1226FwdC40(XsFactorBase):
