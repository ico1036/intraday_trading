"""is_128_ts_donchian_persist_2d14d_h10d_w04 — persist Donchian, smaller position."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_persist_2d14d_h10d_w04",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_persist_2d14d_h10d_w04.md"]


class TsDonchianPersist2d14dH10dW04Strategy:
    def __init__(self, symbols, fast_channel_bars=2880, slow_channel_bars=20160,
                 rebalance_bars=240, hold_bars=14400, max_weight=0.04, **_):
