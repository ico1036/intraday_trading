"""is_723_ts_bull_frac_long_w10080_f55_h28d — bullish-bar fraction long."""
...
ALPHA_CELL = {
    ...
    "idea_family": "ts_bull_frac_long_w10080_f55_h28d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_bull_frac_long_w10080_f55_h28d.md"]


class TsBullFracLongW10080F55H28DStrategy:
    def __init__(self, symbols, window=10080, frac=0.55,
