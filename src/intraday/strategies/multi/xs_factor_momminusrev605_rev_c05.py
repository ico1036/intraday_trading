"""xs_factor_momminusrev605_rev_c05 — auto-generated XS factor.

Signal: mom_minus_rev_60_5  direction=rev  concentration=0.05
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_mom_minus_rev_60_5_rev_c05",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorMomminusrev605RevC05(XsFactorBase):
