"""is_071_ts_donchian_trend_2d2week — Donchian trend-filter: slow regime + fast entry."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_trend_2d2week",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_trend_2d2week.md"]


class TsDonchianTrend2d2weekStrategy:
