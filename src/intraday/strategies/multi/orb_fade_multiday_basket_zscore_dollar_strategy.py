"""ORB-fade multi_day basket z_score."""
...
class OrbFadeMultidayBasketZscoreDollarStrategy:
    def __init__(self, symbols, or_minutes=30, lookback_days=3, history_size=30, entry_z=0.4,
                 max_weight=0.13, **_):
