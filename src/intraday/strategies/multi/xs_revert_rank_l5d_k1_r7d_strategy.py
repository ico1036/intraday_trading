"""is_600_xs_revert_rank_l5d_k1_r7d — cross-section past-5d reversal rank, long bottom-1 / short top-1."""
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_revert_rank_l5d_k1_r7d",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_revert_rank.md"]


class XsRevertRankL5dK1R7dStrategy:
