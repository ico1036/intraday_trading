"""is_208_ts_donchian_long_persist_2d14d_h42d_w035 — long-only persist Donchian variant."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_long_persist_2d14d_h42d_w035",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_long_persist_2d14d_h42d_w035.md"]


class TsDonchianLongPersist2D14DH42dW035Strategy:
