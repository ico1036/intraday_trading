"""BB band fade multi_day basket percentile."""
...
class BbFadeMultidayBasketPctStrategy:
    def __init__(self, symbols, lookback=720, k=2.0, history_size=30, pct=0.6, max_weight=0.13, **_):
