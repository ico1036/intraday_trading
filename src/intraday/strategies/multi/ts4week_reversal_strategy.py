"""is_013_ts_4week_reversal — per-symbol monthly mean reversion, biweekly rebalance."""
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "ts_4week_reversal",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_4week_reversal.md"]


class Ts4weekReversalStrategy:
    def __init__(
        self,
        symbols: list[str],
        ...
        **_: Any,
        ...
        self._return_history = {s: deque(maxlen=self.history_window) for s in self.symbols}
        self._bar_count = 0
    ...
    def _z(self, s):
        ...
        return -(r - mu) / sigma  # reversal: invert sign
