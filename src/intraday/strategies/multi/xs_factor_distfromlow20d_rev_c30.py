"""xs_factor_distfromlow20d_rev_c30 — auto-generated XS factor.

Signal: dist_from_low_20d  direction=rev  concentration=0.3
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_dist_from_low_20d_rev_c30",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorDistfromlow20dRevC30(XsFactorBase):
