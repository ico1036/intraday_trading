"""xs_factor_retskew20d_fwd_c20 — auto-generated XS factor.

Signal: ret_skew_20d  direction=fwd  concentration=0.2
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_ret_skew_20d_fwd_c20",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorRetskew20dFwdC20(XsFactorBase):
