"""xs_factor_closezscore60d_fwd_c40 — auto-generated XS factor.

Signal: close_zscore_60d  direction=fwd  concentration=0.4
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_close_zscore_60d_fwd_c40",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorClosezscore60dFwdC40(XsFactorBase):
