"""xs_factor_retskew20d_fwd_c10 — auto-generated XS factor.

Signal: ret_skew_20d  direction=fwd  concentration=0.1
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_ret_skew_20d_fwd_c10",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorRetskew20dFwdC10(XsFactorBase):
