"""is_078_ts_donchian_trend_3d14d_h7d — Donchian trend-filter variant."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_trend_3d14d_h7d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_trend_3d14d_h7d.md"]


class TsDonchianTrend3d14dH7dStrategy:
