"""xs_factor_return10d_fwd_c30 — auto-generated XS factor.

Signal: return_10d  direction=fwd  concentration=0.3
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_return_10d_fwd_c30",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorReturn10dFwdC30(XsFactorBase):
