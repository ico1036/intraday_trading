"""xs_factor_volume_fwd_c05 — auto-generated XS factor.

Signal: volume  direction=fwd  concentration=0.05
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_volume_fwd_c05",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorVolumeFwdC05(XsFactorBase):
