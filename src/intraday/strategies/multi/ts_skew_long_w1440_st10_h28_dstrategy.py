"""is_847_ts_skew_long_w1440_st10_h28d — negative skew capitulation long."""
...
ALPHA_CELL = {
    ...
    "idea_family": "ts_skew_long_w1440_st10_h28d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_skew_long_w1440_st10_h28d.md"]


class TsSkewLongW1440St10H28DStrategy:
    def __init__(self, symbols, window=1440, skew_threshold=-1.0,
