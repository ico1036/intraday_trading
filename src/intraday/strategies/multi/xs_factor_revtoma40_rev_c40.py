"""xs_factor_revtoma40_rev_c40 — auto-generated XS factor.

Signal: rev_to_ma40  direction=rev  concentration=0.4
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_rev_to_ma40_rev_c40",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorRevtoma40RevC40(XsFactorBase):
