"""bb_fade_symmetric_l120_z30_h240_w040 — BB-band fade symmetric (Z>τ short, Z<-τ long), hold N bars."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "bb_fade_symmetric_l120_z30_h240_w040",
}
SOURCE_NOTES: list[str] = ["research/notes/bb_fade_symmetric.md"]


class BbFadeSymmetricL120Z30H240W040Strategy:
    def __init__(self, symbols, lookback_bars=120, rebalance_bars=60,
                 entry_z=3.0, hold_bars=240, max_weight=0.04, **_):
