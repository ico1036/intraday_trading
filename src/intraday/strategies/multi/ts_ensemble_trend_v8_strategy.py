"""is_111_ts_ensemble_trend_v8 — ensemble of 4 trend-filter slots."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_ensemble_trend_v8",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_ensemble_trend_v8.md"]

_SLOTS = [(7200, 20160, 7200), (4320, 20160, 7200), (4320, 14400, 7200), (7200, 14400, 7200)]  # list of (fast, slow, hold)


class TsEnsembleTrendV8Strategy:
