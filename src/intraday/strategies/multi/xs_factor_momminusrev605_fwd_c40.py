"""xs_factor_momminusrev605_fwd_c40 — auto-generated XS factor.

Signal: mom_minus_rev_60_5  direction=fwd  concentration=0.4
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_mom_minus_rev_60_5_fwd_c40",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorMomminusrev605FwdC40(XsFactorBase):
