"""is_210_ts_donchian_long_persist_3d10d_h28d_w030 — long-only persist Donchian variant."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_long_persist_3d10d_h28d_w030",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_long_persist_3d10d_h28d_w030.md"]


class TsDonchianLongPersist3D10DH28dW030Strategy:
