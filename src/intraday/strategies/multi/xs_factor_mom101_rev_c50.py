"""xs_factor_mom101_rev_c50 — auto-generated XS factor.

Signal: mom_10_1  direction=rev  concentration=0.5
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_mom_10_1_rev_c50",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorMom101RevC50(XsFactorBase):
