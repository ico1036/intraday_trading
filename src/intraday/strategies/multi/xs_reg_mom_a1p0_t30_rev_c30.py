"""xs_reg_mom_a1p0_t30_rev_c30 — auto-generated ridge cross-sectional regression alpha.

Features: ['ret1d', 'ret5d', 'ret20d', 'ret60d']  ridge α=1.0  train window=30d
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_reg_mom_a1p0_t30_rev_c30",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_regression_zoo.md"]


class XsRegMomA1p0T30RevC30(XsRegressionBase):
