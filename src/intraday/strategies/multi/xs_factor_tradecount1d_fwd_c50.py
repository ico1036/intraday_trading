"""xs_factor_tradecount1d_fwd_c50 — auto-generated XS factor.

Signal: trade_count_1d  direction=fwd  concentration=0.5
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_trade_count_1d_fwd_c50",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorTradecount1dFwdC50(XsFactorBase):
