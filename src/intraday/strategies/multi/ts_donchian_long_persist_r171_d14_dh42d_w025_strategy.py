"""is_298_ts_donchian_long_persist_1d14d_h42d_w025 — long-only persist Donchian variant (round 17)."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_long_persist_1d14d_h42d_w025",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_long_persist_1d14d_h42d_w025.md"]


class TsDonchianLongPersistR171D14DH42dW025Strategy:
    def __init__(self, symbols, fast_channel_bars=1440, slow_channel_bars=20160,
                 rebalance_bars=240, hold_bars=60480, max_weight=0.025, **_):
