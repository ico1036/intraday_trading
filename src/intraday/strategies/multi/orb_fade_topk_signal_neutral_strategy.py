"""ORB-fade topk neutral_zone exit (cell variant)."""
...
class OrbFadeTopkSignalNeutralStrategy:
    def __init__(self, symbols, top_k=3, or_minutes=30, history_size=30, entry_z=0.0, neutral_band=0.3,
                 max_weight=0.25, **_):
    ...
    def generate_order(self, state):
        ...
        # close existing positions in neutral band
        if state.positions:
