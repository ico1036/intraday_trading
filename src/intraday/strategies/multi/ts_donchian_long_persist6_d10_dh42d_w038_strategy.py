"""is_272_ts_donchian_long_persist_6d10d_h42d_w038 — long-only persist Donchian variant."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_long_persist_6d10d_h42d_w038",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_long_persist_6d10d_h42d_w038.md"]


class TsDonchianLongPersist6D10DH42dW038Strategy:
