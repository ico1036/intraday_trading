"""xs_factor_vwapdist5d_fwd_c10 — auto-generated XS factor.

Signal: vwap_dist_5d  direction=fwd  concentration=0.1
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_vwap_dist_5d_fwd_c10",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorVwapdist5dFwdC10(XsFactorBase):
