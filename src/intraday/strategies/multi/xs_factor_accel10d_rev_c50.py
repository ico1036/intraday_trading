"""xs_factor_accel10d_rev_c50 — auto-generated XS factor.

Signal: accel_10d  direction=rev  concentration=0.5
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_accel_10d_rev_c50",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorAccel10dRevC50(XsFactorBase):
