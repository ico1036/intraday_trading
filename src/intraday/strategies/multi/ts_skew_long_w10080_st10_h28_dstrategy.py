"""is_859_ts_skew_long_w10080_st10_h28d — negative skew capitulation long."""
...
ALPHA_CELL = {
    ...
    "idea_family": "ts_skew_long_w10080_st10_h28d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_skew_long_w10080_st10_h28d.md"]


class TsSkewLongW10080St10H28DStrategy:
    def __init__(self, symbols, window=10080, skew_threshold=-1.0,
