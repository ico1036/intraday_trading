"""is_712_ts_bull_frac_long_w1440_f52_h21d — bullish-bar fraction long."""
...
ALPHA_CELL = {
    ...
    "idea_family": "ts_bull_frac_long_w1440_f52_h21d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_bull_frac_long_w1440_f52_h21d.md"]


class TsBullFracLongW1440F52H21DStrategy:
    def __init__(self, symbols, window=1440, frac=0.52,
