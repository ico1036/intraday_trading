"""xs_factor_revtoma20_rev_c20 — auto-generated XS factor.

Signal: rev_to_ma20  direction=rev  concentration=0.2
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_rev_to_ma20_rev_c20",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorRevtoma20RevC20(XsFactorBase):
