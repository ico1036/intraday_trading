"""xs_factor_rettimesvol1d_fwd_c20 — auto-generated XS factor.

Signal: ret_times_vol_1d  direction=fwd  concentration=0.2
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_ret_times_vol_1d_fwd_c20",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorRettimesvol1dFwdC20(XsFactorBase):
