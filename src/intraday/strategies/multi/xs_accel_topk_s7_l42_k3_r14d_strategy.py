"""is_935_xs_accel_topk_s7_l42_k3_r14d — basket-relative accel long top-K."""
...
ALPHA_CELL = {
    ...
    "idea_family": "xs_accel_topk_s7_l42_k3_r14d",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_accel_topk_s7_l42_k3_r14d.md"]


class XsAccelTopkS7L42K3R14dStrategy:
    def __init__(self, symbols, short_w=10080, long_w=60480, top_k=3,
