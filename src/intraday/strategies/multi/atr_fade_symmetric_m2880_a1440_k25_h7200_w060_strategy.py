"""atr_fade_symmetric_m2880_a1440_k25_h7200_w060 — ATR-channel fade symmetric (k=2.5 ATRs from EMA mean)."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "atr_fade_symmetric_m2880_a1440_k25_h7200_w060",
}
SOURCE_NOTES: list[str] = ["research/notes/atr_fade_symmetric.md"]


class AtrFadeSymmetricM2880A1440K25H7200W060Strategy:
    def __init__(self, symbols, mean_bars=2880, atr_bars=1440,
                 k_atr=2.5, rebalance_bars=60,
