"""xs_factor_bouncefromlow60d_rev_c40 — auto-generated XS factor.

Signal: bounce_from_low_60d  direction=rev  concentration=0.4
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_bounce_from_low_60d_rev_c40",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorBouncefromlow60dRevC40(XsFactorBase):
