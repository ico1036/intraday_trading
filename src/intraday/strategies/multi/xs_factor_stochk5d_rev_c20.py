"""xs_factor_stochk5d_rev_c20 — auto-generated XS factor.

Signal: stoch_k_5d  direction=rev  concentration=0.2
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_stoch_k_5d_rev_c20",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorStochk5dRevC20(XsFactorBase):
