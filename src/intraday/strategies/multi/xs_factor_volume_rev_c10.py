"""xs_factor_volume_rev_c10 — auto-generated XS factor.

Signal: volume  direction=rev  concentration=0.1
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_volume_rev_c10",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorVolumeRevC10(XsFactorBase):
