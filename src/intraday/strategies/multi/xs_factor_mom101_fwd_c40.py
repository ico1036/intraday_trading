"""xs_factor_mom101_fwd_c40 — auto-generated XS factor.

Signal: mom_10_1  direction=fwd  concentration=0.4
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_mom_10_1_fwd_c40",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorMom101FwdC40(XsFactorBase):
