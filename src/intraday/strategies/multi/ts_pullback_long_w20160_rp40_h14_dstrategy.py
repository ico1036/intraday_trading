"""is_815_ts_pullback_long_w20160_rp40_h14d — pullback-in-uptrend long."""
...
ALPHA_CELL = {
    ...
    "idea_family": "ts_pullback_long_w20160_rp40_h14d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_pullback_long_w20160_rp40_h14d.md"]


class TsPullbackLongW20160Rp40H14DStrategy:
    def __init__(self, symbols, window=20160, range_pct=0.4,
