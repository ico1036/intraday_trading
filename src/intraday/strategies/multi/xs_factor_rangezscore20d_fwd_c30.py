"""xs_factor_rangezscore20d_fwd_c30 — auto-generated XS factor.

Signal: range_zscore_20d  direction=fwd  concentration=0.3
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_range_zscore_20d_fwd_c30",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorRangezscore20dFwdC30(XsFactorBase):
