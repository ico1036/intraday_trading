"""xs_factor_amihud60d_fwd_c50 — auto-generated XS factor.

Signal: amihud_60d  direction=fwd  concentration=0.5
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_amihud_60d_fwd_c50",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorAmihud60dFwdC50(XsFactorBase):
