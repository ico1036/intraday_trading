"""ORB-fade multi_day basket ewma_residual."""
...
class OrbFadeMultidayBasketEwmaStrategy:
    def __init__(self, symbols, or_minutes=30, lookback_days=3, alpha=0.1, entry_thr=0.05,
                 max_weight=0.13, **_):
