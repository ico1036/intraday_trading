"""is_705_ts_range_exp_long_w1440_m25_h28d — HL range expansion long."""
...
ALPHA_CELL = {
    ...
    "idea_family": "ts_range_exp_long_w1440_m25_h28d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_range_exp_long_w1440_m25_h28d.md"]


class TsRangeExpLongW1440M25H28DStrategy:
    def __init__(self, symbols, window=1440, mult=2.5,
