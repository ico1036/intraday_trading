"""is_528_xs_donchian_rank_c21d_k1_r7d — cross-section Donchian channel-position rank, long top-K / short bottom-K."""
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_donchian_rank_c21d_k1_r7d",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_donchian_rank.md"]


class XsDonchianRankC21dK1R7dStrategy:
    def __init__(self, symbols, channel_bars=30240, rebalance_bars=10080,
