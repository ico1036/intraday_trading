"""ORB-fade multi_day topk z_score."""
...
class OrbFadeMultidayTopkZscoreDollarStrategy:
    def __init__(self, symbols, top_k=3, or_minutes=30, lookback_days=3, history_size=30, entry_z=0.4,
                 max_weight=0.25, **_):
