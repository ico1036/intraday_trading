"""xs_factor_closezscore20d_fwd_c05 — auto-generated XS factor.

Signal: close_zscore_20d  direction=fwd  concentration=0.05
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_close_zscore_20d_fwd_c05",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorClosezscore20dFwdC05(XsFactorBase):
