"""xs_factor_roc35d_fwd_c10 — auto-generated XS factor.

Signal: roc_35d  direction=fwd  concentration=0.1
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_roc_35d_fwd_c10",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorRoc35dFwdC10(XsFactorBase):
