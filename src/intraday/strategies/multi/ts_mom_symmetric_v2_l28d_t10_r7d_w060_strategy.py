"""ts_mom_symmetric_v2_l28d_t10_r7d_w060 — TS-mom symmetric (v2), tuned position sizing."""
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "ts_mom_symmetric_v2_l28d_t10_r7d_w060",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_mom_symmetric.md"]


class TsMomSymmetricV2L28dT10R7dW060Strategy:
    def __init__(self, symbols, lookback_bars=40320, rebalance_bars=10080,
                 entry_threshold=0.01, exit_threshold=0.003, max_weight=0.06, **_):
