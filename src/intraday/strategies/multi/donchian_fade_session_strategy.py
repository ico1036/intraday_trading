"""Donchian channel fade with SESSION horizon (cell variant).

Same family as is_027 (donchian_fade) but Donchian window is 1 trading day
of bars; cell horizon=session.
"""
...
class DonchianFadeSessionStrategy:
    def __init__(
        self,
        symbols: list[str],
