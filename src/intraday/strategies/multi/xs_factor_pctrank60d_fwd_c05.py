"""xs_factor_pctrank60d_fwd_c05 — auto-generated XS factor.

Signal: pct_rank_60d  direction=fwd  concentration=0.05
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_pct_rank_60d_fwd_c05",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorPctrank60dFwdC05(XsFactorBase):
