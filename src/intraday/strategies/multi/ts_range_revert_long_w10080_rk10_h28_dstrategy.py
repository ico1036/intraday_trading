"""is_522_ts_range_revert_long_w10080_rk10_h28d — range-position mean revert long, hold 28d."""
...
ALPHA_CELL = {
    ...
    "idea_family": "ts_range_revert_long_w10080_rk10_h28d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_range_revert_long_w10080_rk10_h28d.md"]


class TsRangeRevertLongW10080Rk10H28DStrategy:
    def __init__(self, symbols, window_bars=10080, rank_threshold=0.1,
