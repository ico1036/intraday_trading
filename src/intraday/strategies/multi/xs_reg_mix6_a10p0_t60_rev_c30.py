"""xs_reg_mix6_a10p0_t60_rev_c30 — auto-generated ridge cross-sectional regression alpha.

Features: ['ret1d', 'ret5d', 'ret20d', 'vol20d', 'rev_ma20', 'logvol']  ridge α=10.0  train window=60d
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_reg_mix6_a10p0_t60_rev_c30",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_regression_zoo.md"]


class XsRegMix6A10p0T60RevC30(XsRegressionBase):
