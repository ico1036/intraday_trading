"""xs_factor_tradecount1d_rev_c30 — auto-generated XS factor.

Signal: trade_count_1d  direction=rev  concentration=0.3
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_trade_count_1d_rev_c30",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorTradecount1dRevC30(XsFactorBase):
