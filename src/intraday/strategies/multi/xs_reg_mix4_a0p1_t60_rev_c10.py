"""xs_reg_mix4_a0p1_t60_rev_c10 — auto-generated ridge cross-sectional regression alpha.
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_reg_mix4_a0p1_t60_rev_c10",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_regression_zoo.md"]


class XsRegMix4A0p1T60RevC10(XsRegressionBase):
