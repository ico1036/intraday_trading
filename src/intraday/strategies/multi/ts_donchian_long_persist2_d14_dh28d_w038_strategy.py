"""is_203_ts_donchian_long_persist_2d14d_h28d_w038 — long-only persist Donchian variant."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_long_persist_2d14d_h28d_w038",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_long_persist_2d14d_h28d_w038.md"]


class TsDonchianLongPersist2D14DH28dW038Strategy:
