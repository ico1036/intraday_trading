"""is_844_ts_skew_long_w1440_st05_h21d — negative skew capitulation long."""
...
ALPHA_CELL = {
    ...
    "idea_family": "ts_skew_long_w1440_st05_h21d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_skew_long_w1440_st05_h21d.md"]


class TsSkewLongW1440St05H21DStrategy:
    def __init__(self, symbols, window=1440, skew_threshold=-0.5,
