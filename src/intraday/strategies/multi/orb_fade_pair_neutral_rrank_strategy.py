"""ORB-fade pair neutral_zone rolling_rank."""
...
class OrbFadePairNeutralRrankStrategy:
    def __init__(self, symbols, pair=("BTCUSDT", "ETHUSDT"), or_minutes=30, history_size=30, rank_thr=0.5,
