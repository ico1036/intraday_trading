"""is_500_ts_atr_break_long_w240_m15_h21d — ATR-band breakout long, hold 21d."""
...
ALPHA_CELL = {
    ...
    "idea_family": "ts_atr_break_long_w240_m15_h21d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_atr_break_long_w240_m15_h21d.md"]


class TsAtrBreakLongW240m15H21DStrategy:
    def __init__(self, symbols, atr_window=240, atr_mult=1.5, ma_window=7200,
