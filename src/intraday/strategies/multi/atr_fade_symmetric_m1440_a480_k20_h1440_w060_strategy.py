"""atr_fade_symmetric_m1440_a480_k20_h1440_w060 — ATR-channel fade symmetric (k=2.0 ATRs from EMA mean)."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "atr_fade_symmetric_m1440_a480_k20_h1440_w060",
}
SOURCE_NOTES: list[str] = ["research/notes/atr_fade_symmetric.md"]


class AtrFadeSymmetricM1440A480K20H1440W060Strategy:
    def __init__(self, symbols, mean_bars=1440, atr_bars=480,
