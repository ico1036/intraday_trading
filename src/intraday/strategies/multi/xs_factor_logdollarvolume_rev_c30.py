"""xs_factor_logdollarvolume_rev_c30 — auto-generated XS factor.

Signal: log_dollar_volume  direction=rev  concentration=0.3
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_log_dollar_volume_rev_c30",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorLogdollarvolumeRevC30(XsFactorBase):
