"""xs_factor_overnightgap1d_fwd_c10 — auto-generated XS factor.

Signal: overnight_gap_1d  direction=fwd  concentration=0.1
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_overnight_gap_1d_fwd_c10",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorOvernightgap1dFwdC10(XsFactorBase):
