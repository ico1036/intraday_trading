"""xs_factor_vwapdist5d_fwd_c30 — auto-generated XS factor.

Signal: vwap_dist_5d  direction=fwd  concentration=0.3
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_vwap_dist_5d_fwd_c30",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorVwapdist5dFwdC30(XsFactorBase):
