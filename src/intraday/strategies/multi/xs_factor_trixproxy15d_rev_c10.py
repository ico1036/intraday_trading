"""xs_factor_trixproxy15d_rev_c10 — auto-generated XS factor.

Signal: trix_proxy_15d  direction=rev  concentration=0.1
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_trix_proxy_15d_rev_c10",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorTrixproxy15dRevC10(XsFactorBase):
