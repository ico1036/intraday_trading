"""xs_factor_udvolratio20d_rev_c40 — auto-generated XS factor.

Signal: ud_vol_ratio_20d  direction=rev  concentration=0.4
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_ud_vol_ratio_20d_rev_c40",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorUdvolratio20dRevC40(XsFactorBase):
