"""xs_factor_tradecountlog1d_fwd_c05 — auto-generated XS factor.

Signal: trade_count_log_1d  direction=fwd  concentration=0.05
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_trade_count_log_1d_fwd_c05",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorTradecountlog1dFwdC05(XsFactorBase):
