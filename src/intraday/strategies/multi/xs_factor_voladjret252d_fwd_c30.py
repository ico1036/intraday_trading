"""xs_factor_voladjret252d_fwd_c30 — auto-generated XS factor.

Signal: vol_adj_ret_252d  direction=fwd  concentration=0.3
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_vol_adj_ret_252d_fwd_c30",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorVoladjret252dFwdC30(XsFactorBase):
