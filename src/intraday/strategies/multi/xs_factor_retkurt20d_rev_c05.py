"""xs_factor_retkurt20d_rev_c05 — auto-generated XS factor.

Signal: ret_kurt_20d  direction=rev  concentration=0.05
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_ret_kurt_20d_rev_c05",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorRetkurt20dRevC05(XsFactorBase):
