"""xs_factor_revstrength20d_rev_c30 — auto-generated XS factor.

Signal: rev_strength_20d  direction=rev  concentration=0.3
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_rev_strength_20d_rev_c30",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorRevstrength20dRevC30(XsFactorBase):
