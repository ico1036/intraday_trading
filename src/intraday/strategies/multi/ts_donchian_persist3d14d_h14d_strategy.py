"""is_096_ts_donchian_persist_3d14d_h14d — persist Donchian, longer hold."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_persist_3d14d_h14d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_persist_3d14d_h14d.md"]


class TsDonchianPersist3d14dH14dStrategy:
    def __init__(self, symbols, fast_channel_bars=4320, slow_channel_bars=20160,
                 rebalance_bars=240, hold_bars=20160, max_weight=0.14, **_):
