"""ts_donchian_symmetric_v2_f2d_s10d_h42d_w060 — symmetric Donchian persist (long upper + short lower), tuned position sizing."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_symmetric_v2_f2d_s10d_h42d_w060",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_symmetric.md"]


class TsDonchianSymmetricV2F2dS10dH42dW060Strategy:
    def __init__(self, symbols, fast_channel_bars=2880, slow_channel_bars=14400,
                 rebalance_bars=240, hold_bars=60480, max_weight=0.06, **_):
