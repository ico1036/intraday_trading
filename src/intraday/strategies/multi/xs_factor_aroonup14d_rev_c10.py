"""xs_factor_aroonup14d_rev_c10 — auto-generated XS factor.

Signal: aroon_up_14d  direction=rev  concentration=0.1
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_aroon_up_14d_rev_c10",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorAroonup14dRevC10(XsFactorBase):
