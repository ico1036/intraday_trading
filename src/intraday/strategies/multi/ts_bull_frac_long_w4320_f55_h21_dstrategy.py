"""is_718_ts_bull_frac_long_w4320_f55_h21d — bullish-bar fraction long."""
...
ALPHA_CELL = {
    ...
    "idea_family": "ts_bull_frac_long_w4320_f55_h21d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_bull_frac_long_w4320_f55_h21d.md"]


class TsBullFracLongW4320F55H21DStrategy:
    def __init__(self, symbols, window=4320, frac=0.55,
