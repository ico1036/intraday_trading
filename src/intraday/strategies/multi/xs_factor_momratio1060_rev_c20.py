"""xs_factor_momratio1060_rev_c20 — auto-generated XS factor.

Signal: mom_ratio_10_60  direction=rev  concentration=0.2
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_mom_ratio_10_60_rev_c20",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorMomratio1060RevC20(XsFactorBase):
