"""BB-band fade SESSION horizon basket_full (cell variant).

Cell horizon differs from is_028 (intraday → session). Uses 24h rolling
mean/sigma (per-symbol) so band touches are sparser.
"""
...
class BbBandFadeSessionBasketStrategy:
    def __init__(
        self,
        symbols: list[str],
        window: int = 1440,   # 24h
