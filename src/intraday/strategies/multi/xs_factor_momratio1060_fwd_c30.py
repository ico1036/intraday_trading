"""xs_factor_momratio1060_fwd_c30 — auto-generated XS factor.

Signal: mom_ratio_10_60  direction=fwd  concentration=0.3
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_mom_ratio_10_60_fwd_c30",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorMomratio1060FwdC30(XsFactorBase):
