"""ORB-fade single BTC with TIME_STOP exit (cell variant of is_040).

Same family/universe/horizon as is_040 but exit value differs (signal_flip → time_stop).
"""
...
class OrbFadeSingleBtcTimeStopStrategy:
    def __init__(
        self,
        symbols: list[str],
        target: str = "BTCUSDT",
