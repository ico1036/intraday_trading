"""is_110_ts_ensemble_trend_v7 — ensemble of 4 trend-filter slots."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_ensemble_trend_v7",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_ensemble_trend_v7.md"]

_SLOTS = [(7200, 14400, 7200), (7200, 14400, 10080), (4320, 14400, 7200), (4320, 14400, 10080)]  # list of (fast, slow, hold)


class TsEnsembleTrendV7Strategy:
