"""is_182_ts_donchian_long_persist_7d14d_h28d_w035 — long-only persist Donchian, extended hold."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_long_persist_7d14d_h28d_w035",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_long_persist_7d14d_h28d_w035.md"]


class TsDonchianLongPersist7d14dH28dW035Strategy:
    def __init__(self, symbols, fast_channel_bars=10080, slow_channel_bars=20160,
