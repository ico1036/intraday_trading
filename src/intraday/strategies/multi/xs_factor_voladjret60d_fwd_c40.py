"""xs_factor_voladjret60d_fwd_c40 — auto-generated XS factor.

Signal: vol_adj_ret_60d  direction=fwd  concentration=0.4
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_vol_adj_ret_60d_fwd_c40",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorVoladjret60dFwdC40(XsFactorBase):
