"""Session extreme revert basket time_stop ewma_residual."""
...
class SextBasketFullTsEwmaStrategy:
    def __init__(self, symbols, alpha=0.1, entry_thr=0.05, max_weight=0.13, hold_bars=180, **_):
