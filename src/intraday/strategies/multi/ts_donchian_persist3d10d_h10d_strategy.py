"""is_094_ts_donchian_persist_3d10d_h10d — persist Donchian, longer hold."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_persist_3d10d_h10d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_persist_3d10d_h10d.md"]


class TsDonchianPersist3d10dH10dStrategy:
