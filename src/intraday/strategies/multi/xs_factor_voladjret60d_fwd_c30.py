"""xs_factor_voladjret60d_fwd_c30 — auto-generated XS factor.

Signal: vol_adj_ret_60d  direction=fwd  concentration=0.3
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_vol_adj_ret_60d_fwd_c30",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorVoladjret60dFwdC30(XsFactorBase):
