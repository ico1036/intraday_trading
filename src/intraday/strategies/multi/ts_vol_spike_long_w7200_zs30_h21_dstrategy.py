"""is_533_ts_vol_spike_long_w7200_zs30_h21d — volume-spike long, hold 21d."""
...
ALPHA_CELL = {
    ...
    "idea_family": "ts_vol_spike_long_w7200_zs30_h21d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_vol_spike_long_w7200_zs30_h21d.md"]


class TsVolSpikeLongW7200Zs30H21DStrategy:
    def __init__(self, symbols, vol_window=7200, vol_zscore=3.0,
