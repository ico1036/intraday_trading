"""xs_factor_williamsr14d_fwd_c05 — auto-generated XS factor.

Signal: williams_r_14d  direction=fwd  concentration=0.05
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_williams_r_14d_fwd_c05",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorWilliamsr14dFwdC05(XsFactorBase):
