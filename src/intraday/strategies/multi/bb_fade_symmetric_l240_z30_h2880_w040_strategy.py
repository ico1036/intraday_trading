"""bb_fade_symmetric_l240_z30_h2880_w040 — BB-band fade symmetric (Z>τ short, Z<-τ long), hold N bars."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "bb_fade_symmetric_l240_z30_h2880_w040",
}
SOURCE_NOTES: list[str] = ["research/notes/bb_fade_symmetric.md"]


class BbFadeSymmetricL240Z30H2880W040Strategy:
