"""is_143_ts_donchian_persist_long3d14d_h7d — long-only persist Donchian (no shorts)."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_persist_long3d14d_h7d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_persist_long3d14d_h7d.md"]


class TsDonchianPersistLong3d14dH7dStrategy:
