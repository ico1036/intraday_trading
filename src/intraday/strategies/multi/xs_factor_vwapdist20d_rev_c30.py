"""xs_factor_vwapdist20d_rev_c30 — auto-generated XS factor.

Signal: vwap_dist_20d  direction=rev  concentration=0.3
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_vwap_dist_20d_rev_c30",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorVwapdist20dRevC30(XsFactorBase):
