"""xs_factor_momminusrev847_fwd_c50 — auto-generated XS factor.

Signal: mom_minus_rev_84_7  direction=fwd  concentration=0.5
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_mom_minus_rev_84_7_fwd_c50",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorMomminusrev847FwdC50(XsFactorBase):
