"""is_052_ts_donchian_8day_5day — Donchian breakout asymmetric variant."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_8day_5day",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_8day_5day.md"]


class TsDonchian8day5dayStrategy:
    def __init__(self, symbols, channel_bars=11520, rebalance_bars=240, hold_bars=7200, max_weight=0.14, **_):
