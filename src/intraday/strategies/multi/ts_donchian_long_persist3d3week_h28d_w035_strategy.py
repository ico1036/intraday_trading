"""is_176_ts_donchian_long_persist_3d3week_h28d_w035 — long-only persist Donchian, smaller weight."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_long_persist_3d3week_h28d_w035",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_long_persist_3d3week_h28d_w035.md"]


class TsDonchianLongPersist3d3weekH28dW035Strategy:
