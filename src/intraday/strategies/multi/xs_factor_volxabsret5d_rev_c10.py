"""xs_factor_volxabsret5d_rev_c10 — auto-generated XS factor.

Signal: vol_x_absret_5d  direction=rev  concentration=0.1
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_vol_x_absret_5d_rev_c10",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorVolxabsret5dRevC10(XsFactorBase):
