"""xs_factor_retsign1d_fwd_c50 — auto-generated XS factor.

Signal: ret_sign_1d  direction=fwd  concentration=0.5
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_ret_sign_1d_fwd_c50",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorRetsign1dFwdC50(XsFactorBase):
