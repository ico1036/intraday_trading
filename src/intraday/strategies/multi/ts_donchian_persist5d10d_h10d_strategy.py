"""is_097_ts_donchian_persist_5d10d_h10d — persist Donchian, longer hold."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_persist_5d10d_h10d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_persist_5d10d_h10d.md"]


class TsDonchianPersist5d10dH10dStrategy:
    def __init__(self, symbols, fast_channel_bars=7200, slow_channel_bars=14400,
                 rebalance_bars=240, hold_bars=14400, max_weight=0.14, **_):
