"""is_024_ts_donchian_3week — Donchian breakout variant."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_3week",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_3week.md"]


class TsDonchian3weekStrategy:
    def __init__(self, symbols, channel_bars=30240, rebalance_bars=240, hold_bars=30240, max_weight=0.14, **_):
