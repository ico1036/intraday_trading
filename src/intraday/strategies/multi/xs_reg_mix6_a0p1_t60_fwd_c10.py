"""xs_reg_mix6_a0p1_t60_fwd_c10 — auto-generated ridge cross-sectional regression alpha.
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_reg_mix6_a0p1_t60_fwd_c10",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_regression_zoo.md"]


class XsRegMix6A0p1T60FwdC10(XsRegressionBase):
