"""xs_range_fade_l14d_k1_r3d_w060 — cross-section: rank by close position in N-day range, fade extremes."""
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_range_fade_l14d_k1_r3d_w060",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_range_position_fade.md"]


class XsRangeFadeL14dK1R3dW060Strategy:
