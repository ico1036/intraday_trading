"""is_759_ts_new_high_long_w14400_h42d_r7d — new-high follow-through long."""
...
ALPHA_CELL = {
    ...
    "idea_family": "ts_new_high_long_w14400_h42d_r7d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_new_high_long_w14400_h42d_r7d.md"]


class TsNewHighLongW14400H42DR7DStrategy:
    def __init__(self, symbols, window=14400,
                 rebalance_bars=10080, hold_bars=60480, max_weight=0.035, **_):
