"""xs_factor_revstrength20d_rev_c20 — auto-generated XS factor.

Signal: rev_strength_20d  direction=rev  concentration=0.2
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_rev_strength_20d_rev_c20",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorRevstrength20dRevC20(XsFactorBase):
