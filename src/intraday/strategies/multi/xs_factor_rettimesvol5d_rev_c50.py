"""xs_factor_rettimesvol5d_rev_c50 — auto-generated XS factor.

Signal: ret_times_vol_5d  direction=rev  concentration=0.5
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_ret_times_vol_5d_rev_c50",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorRettimesvol5dRevC50(XsFactorBase):
