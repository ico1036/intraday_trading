"""is_236_ts_donchian_long_persist_4d10d_h42d_w038 — long-only persist Donchian variant."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_long_persist_4d10d_h42d_w038",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_long_persist_4d10d_h42d_w038.md"]


class TsDonchianLongPersist4D10DH42dW038Strategy:
    def __init__(self, symbols, fast_channel_bars=5760, slow_channel_bars=14400,
                 rebalance_bars=240, hold_bars=60480, max_weight=0.038, **_):
