"""xs_factor_rangeratio20d_fwd_c30 — auto-generated XS factor.

Signal: range_ratio_20d  direction=fwd  concentration=0.3
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_range_ratio_20d_fwd_c30",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorRangeratio20dFwdC30(XsFactorBase):
