"""xs_factor_closezscore20d_rev_c10 — auto-generated XS factor.

Signal: close_zscore_20d  direction=rev  concentration=0.1
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_close_zscore_20d_rev_c10",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorClosezscore20dRevC10(XsFactorBase):
