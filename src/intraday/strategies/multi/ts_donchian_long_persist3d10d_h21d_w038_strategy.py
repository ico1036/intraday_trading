"""is_172_ts_donchian_long_persist_3d10d_h21d_w038 — long-only persist Donchian, smaller weight."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_long_persist_3d10d_h21d_w038",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_long_persist_3d10d_h21d_w038.md"]


class TsDonchianLongPersist3d10dH21dW038Strategy:
