"""is_267_ts_donchian_long_persist_6d10d_h35d_w030 — long-only persist Donchian variant."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_long_persist_6d10d_h35d_w030",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_long_persist_6d10d_h35d_w030.md"]


class TsDonchianLongPersist6D10DH35dW030Strategy:
    def __init__(self, symbols, fast_channel_bars=8640, slow_channel_bars=14400,
                 rebalance_bars=240, hold_bars=50400, max_weight=0.03, **_):
