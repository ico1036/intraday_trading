"""is_120_ts_zrevert_30m_60m — extreme z-score mean reversion.
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_zrevert_30m_60m",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_zrevert_30m_60m.md"]


class TsZrevert30m60mStrategy:
    def __init__(self, symbols, window_bars=30, hold_bars=60,
                 rebalance_bars=15, entry_z=2.0, max_weight=0.07,
                 history_bars=2880, **_):
