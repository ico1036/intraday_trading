"""Session extreme revert multi_day topk composite."""
...
class SextMultidayTopkCompDollarStrategy:
    def __init__(self, symbols, top_k=3, lookback_days=3, history_size=30, entry_thr=0.4, max_weight=0.25, **_):
