"""is_560_xs_mom_rank_l5d_k1_r7d — cross-section past-5d return rank, long top-1 / short bottom-1."""
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_mom_rank_l5d_k1_r7d",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_mom_rank.md"]


class XsMomRankL5dK1R7dStrategy:
    def __init__(self, symbols, lookback_bars=7200, rebalance_bars=10080,
