"""Session extreme revert pair neutral_zone z_score."""
...
class SextPairNeutralZscoreStrategy:
    def __init__(self, symbols, pair=("BTCUSDT", "ETHUSDT"), history_size=30, entry_z=0.3,
