"""xs_factor_return28d_rev_c05 — auto-generated XS factor.

Signal: return_28d  direction=rev  concentration=0.05
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_return_28d_rev_c05",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorReturn28dRevC05(XsFactorBase):
