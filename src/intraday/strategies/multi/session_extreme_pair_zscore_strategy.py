"""Session extreme revert pair z_score."""
...
class SessionExtremePairZscoreStrategy:
    def __init__(self, symbols, pair=("BTCUSDT", "ETHUSDT"), history_size=30, entry_z=0.0, max_weight=0.4, **_):
