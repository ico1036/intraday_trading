"""xs_factor_closetohigh20d_rev_c30 — auto-generated XS factor.

Signal: close_to_high_20d  direction=rev  concentration=0.3
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_close_to_high_20d_rev_c30",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorClosetohigh20dRevC30(XsFactorBase):
