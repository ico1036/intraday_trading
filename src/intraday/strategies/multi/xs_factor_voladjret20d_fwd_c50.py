"""xs_factor_voladjret20d_fwd_c50 — auto-generated XS factor.

Signal: vol_adj_ret_20d  direction=fwd  concentration=0.5
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_vol_adj_ret_20d_fwd_c50",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorVoladjret20dFwdC50(XsFactorBase):
