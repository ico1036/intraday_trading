"""xs_factor_logdollarvolume_rev_c40 — auto-generated XS factor.

Signal: log_dollar_volume  direction=rev  concentration=0.4
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_log_dollar_volume_rev_c40",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorLogdollarvolumeRevC40(XsFactorBase):
