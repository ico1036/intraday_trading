"""xs_factor_momminusrev25221_rev_c50 — auto-generated XS factor.

Signal: mom_minus_rev_252_21  direction=rev  concentration=0.5
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_mom_minus_rev_252_21_rev_c50",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorMomminusrev25221RevC50(XsFactorBase):
