"""is_284_ts_donchian_long_persist_1d10d_h28d_w040 — long-only persist Donchian variant (round 17)."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_long_persist_1d10d_h28d_w040",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_long_persist_1d10d_h28d_w040.md"]


class TsDonchianLongPersistR171D10DH28dW040Strategy:
