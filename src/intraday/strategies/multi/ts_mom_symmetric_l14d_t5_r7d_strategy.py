"""is_674_ts_mom_symmetric_l14d_t5_r7d — TS-mom symmetric: long if past 14d return > 0.5%, short if < -0.5%."""
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "ts_mom_symmetric_l14d_t5_r7d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_mom_symmetric.md"]


class TsMomSymmetricL14dT5R7dStrategy:
    def __init__(self, symbols, lookback_bars=20160, rebalance_bars=10080,
                 entry_threshold=0.005, exit_threshold=0.0015, max_weight=0.3, **_):
