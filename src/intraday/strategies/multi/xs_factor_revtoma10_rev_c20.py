"""xs_factor_revtoma10_rev_c20 — auto-generated XS factor.

Signal: rev_to_ma10  direction=rev  concentration=0.2
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_rev_to_ma10_rev_c20",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorRevtoma10RevC20(XsFactorBase):
