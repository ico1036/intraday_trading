"""xs_factor_maxlottery10d_rev_c50 — auto-generated XS factor.

Signal: max_lottery_10d  direction=rev  concentration=0.5
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_max_lottery_10d_rev_c50",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorMaxlottery10dRevC50(XsFactorBase):
