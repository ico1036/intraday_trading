"""is_130_ts_donchian_persist_5d2week_h10d_w05 — persist Donchian, smaller position."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_persist_5d2week_h10d_w05",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_persist_5d2week_h10d_w05.md"]


class TsDonchianPersist5d2weekH10dW05Strategy:
    def __init__(self, symbols, fast_channel_bars=7200, slow_channel_bars=20160,
                 rebalance_bars=240, hold_bars=14400, max_weight=0.05, **_):
