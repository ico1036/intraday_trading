"""xs_factor_cci20d_rev_c40 — auto-generated XS factor.

Signal: cci_20d  direction=rev  concentration=0.4
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_cci_20d_rev_c40",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorCci20dRevC40(XsFactorBase):
