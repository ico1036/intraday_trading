"""is_112_ts_zrevert_60m_60m — extreme z-score mean reversion.
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_zrevert_60m_60m",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_zrevert_60m_60m.md"]


class TsZrevert60m60mStrategy:
    def __init__(self, symbols, window_bars=60, hold_bars=60,
