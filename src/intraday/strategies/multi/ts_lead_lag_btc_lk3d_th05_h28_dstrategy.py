"""is_637_ts_lead_lag_btc_lk3d_th05_h28d — long alts if BTC recently up."""
...
ALPHA_CELL = {
    ...
    "idea_family": "ts_lead_lag_btc_lk3d_th05_h28d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_lead_lag_btc_lk3d_th05_h28d.md"]


class TsLeadLagBtcLk3dTh05H28DStrategy:
