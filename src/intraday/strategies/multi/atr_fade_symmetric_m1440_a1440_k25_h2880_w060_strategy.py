"""atr_fade_symmetric_m1440_a1440_k25_h2880_w060 — ATR-channel fade symmetric (k=2.5 ATRs from EMA mean)."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "atr_fade_symmetric_m1440_a1440_k25_h2880_w060",
}
SOURCE_NOTES: list[str] = ["research/notes/atr_fade_symmetric.md"]


class AtrFadeSymmetricM1440A1440K25H2880W060Strategy:
    def __init__(self, symbols, mean_bars=1440, atr_bars=1440,
                 k_atr=2.5, rebalance_bars=60,
                 hold_bars=2880, max_weight=0.06, **_):
