"""is_342_ts_donchian_symmetric_f7d_s28d_h14d — symmetric Donchian persist (long upper-break + short lower-break)."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_symmetric_f7d_s28d_h14d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_symmetric.md"]


class TsDonchianSymmetricF7dS28dH14dStrategy:
    def __init__(self, symbols, fast_channel_bars=10080, slow_channel_bars=40320,
