"""xs_factor_highlowmom20d_rev_c50 — auto-generated XS factor.

Signal: high_low_mom_20d  direction=rev  concentration=0.5
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_high_low_mom_20d_rev_c50",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorHighlowmom20dRevC50(XsFactorBase):
