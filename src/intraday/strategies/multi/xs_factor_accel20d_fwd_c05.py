"""xs_factor_accel20d_fwd_c05 — auto-generated XS factor.

Signal: accel_20d  direction=fwd  concentration=0.05
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_accel_20d_fwd_c05",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorAccel20dFwdC05(XsFactorBase):
