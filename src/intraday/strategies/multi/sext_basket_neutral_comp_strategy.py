"""Session extreme revert basket neutral_zone composite."""
...
class SextBasketNeutralCompStrategy:
    def __init__(self, symbols, history_size=30, entry_thr=0.3, neutral_band=0.4, max_weight=0.13, **_):
