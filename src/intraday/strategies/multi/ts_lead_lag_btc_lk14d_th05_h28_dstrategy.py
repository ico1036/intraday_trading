"""is_645_ts_lead_lag_btc_lk14d_th05_h28d — long alts if BTC recently up."""
...
ALPHA_CELL = {
    ...
    "idea_family": "ts_lead_lag_btc_lk14d_th05_h28d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_lead_lag_btc_lk14d_th05_h28d.md"]


class TsLeadLagBtcLk14dTh05H28DStrategy:
    def __init__(self, symbols, btc_lookback=20160, btc_threshold=0.05,
                 rebalance_bars=240, hold_bars=40320, max_weight=0.1, **_):
