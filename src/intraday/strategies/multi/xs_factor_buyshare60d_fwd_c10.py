"""xs_factor_buyshare60d_fwd_c10 — auto-generated XS factor.

Signal: buy_share_60d  direction=fwd  concentration=0.1
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_buy_share_60d_fwd_c10",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorBuyshare60dFwdC10(XsFactorBase):
