"""xs_factor_udvolratio20d_fwd_c10 — auto-generated XS factor.

Signal: ud_vol_ratio_20d  direction=fwd  concentration=0.1
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_ud_vol_ratio_20d_fwd_c10",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorUdvolratio20dFwdC10(XsFactorBase):
