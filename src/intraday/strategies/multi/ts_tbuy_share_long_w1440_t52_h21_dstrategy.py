"""is_724_ts_tbuy_share_long_w1440_t52_h21d — taker-buy volume fraction long."""
...
ALPHA_CELL = {
    ...
    "idea_family": "ts_tbuy_share_long_w1440_t52_h21d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_tbuy_share_long_w1440_t52_h21d.md"]


class TsTbuyShareLongW1440T52H21DStrategy:
    def __init__(self, symbols, window=1440, imb_threshold=0.52,
