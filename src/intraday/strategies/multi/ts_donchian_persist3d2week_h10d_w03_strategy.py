"""is_131_ts_donchian_persist_3d2week_h10d_w03 — persist Donchian, smaller position."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_persist_3d2week_h10d_w03",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_persist_3d2week_h10d_w03.md"]


class TsDonchianPersist3d2weekH10dW03Strategy:
    def __init__(self, symbols, fast_channel_bars=4320, slow_channel_bars=20160,
                 rebalance_bars=240, hold_bars=14400, max_weight=0.03, **_):
