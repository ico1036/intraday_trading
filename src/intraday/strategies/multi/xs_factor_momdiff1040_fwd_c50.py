"""xs_factor_momdiff1040_fwd_c50 — auto-generated XS factor.

Signal: mom_diff_10_40  direction=fwd  concentration=0.5
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_mom_diff_10_40_fwd_c50",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorMomdiff1040FwdC50(XsFactorBase):
