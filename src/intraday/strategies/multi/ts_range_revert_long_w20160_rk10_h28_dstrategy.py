"""is_524_ts_range_revert_long_w20160_rk10_h28d — range-position mean revert long, hold 28d."""
...
ALPHA_CELL = {
    ...
    "idea_family": "ts_range_revert_long_w20160_rk10_h28d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_range_revert_long_w20160_rk10_h28d.md"]


class TsRangeRevertLongW20160Rk10H28DStrategy:
    def __init__(self, symbols, window_bars=20160, rank_threshold=0.1,
