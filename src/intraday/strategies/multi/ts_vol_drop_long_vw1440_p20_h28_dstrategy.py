"""is_903_ts_vol_drop_long_vw1440_p20_h28d — vol drop below percentile long."""
...
ALPHA_CELL = {
    ...
    "idea_family": "ts_vol_drop_long_vw1440_p20_h28d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_vol_drop_long_vw1440_p20_h28d.md"]


class TsVolDropLongVw1440P20H28DStrategy:
    def __init__(self, symbols, vol_w=1440, norm_w=43200, pct=0.2,
