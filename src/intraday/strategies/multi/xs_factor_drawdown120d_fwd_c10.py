"""xs_factor_drawdown120d_fwd_c10 — auto-generated XS factor.

Signal: drawdown_120d  direction=fwd  concentration=0.1
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_drawdown_120d_fwd_c10",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorDrawdown120dFwdC10(XsFactorBase):
