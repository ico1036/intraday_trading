"""xs_reg_mom_a1p0_t60_fwd_c30 — auto-generated ridge cross-sectional regression alpha.
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_reg_mom_a1p0_t60_fwd_c30",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_regression_zoo.md"]


class XsRegMomA1p0T60FwdC30(XsRegressionBase):
