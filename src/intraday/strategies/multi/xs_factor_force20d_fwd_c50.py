"""xs_factor_force20d_fwd_c50 — auto-generated XS factor.

Signal: force_20d  direction=fwd  concentration=0.5
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_force_20d_fwd_c50",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorForce20dFwdC50(XsFactorBase):
