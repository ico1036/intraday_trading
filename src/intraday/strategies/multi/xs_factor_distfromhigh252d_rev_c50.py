"""xs_factor_distfromhigh252d_rev_c50 — auto-generated XS factor.

Signal: dist_from_high_252d  direction=rev  concentration=0.5
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_dist_from_high_252d_rev_c50",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorDistfromhigh252dRevC50(XsFactorBase):
