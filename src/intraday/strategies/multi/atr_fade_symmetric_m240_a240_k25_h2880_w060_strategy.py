"""atr_fade_symmetric_m240_a240_k25_h2880_w060 — ATR-channel fade symmetric (k=2.5 ATRs from EMA mean)."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "atr_fade_symmetric_m240_a240_k25_h2880_w060",
}
SOURCE_NOTES: list[str] = ["research/notes/atr_fade_symmetric.md"]


class AtrFadeSymmetricM240A240K25H2880W060Strategy:
    def __init__(self, symbols, mean_bars=240, atr_bars=240,
