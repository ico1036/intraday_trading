"""Session extreme revert basket time_stop percentile."""
...
class SextBasketFullTsPctStrategy:
    def __init__(self, symbols, history_size=30, pct=0.5, max_weight=0.13, hold_bars=180, **_):
