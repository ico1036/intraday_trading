"""is_959_ts_disp_low_long_lk1440_dp40_h28d — low-dispersion long basket."""
...
ALPHA_CELL = {
    ...
    "idea_family": "ts_disp_low_long_lk1440_dp40_h28d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_disp_low_long_lk1440_dp40_h28d.md"]


class TsDispLowLongLk1440Dp40H28DStrategy:
    def __init__(self, symbols, lookback=1440, disp_pct=0.4,
