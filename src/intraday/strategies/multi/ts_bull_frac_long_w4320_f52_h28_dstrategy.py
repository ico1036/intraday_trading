"""is_717_ts_bull_frac_long_w4320_f52_h28d — bullish-bar fraction long."""
...
ALPHA_CELL = {
    ...
    "idea_family": "ts_bull_frac_long_w4320_f52_h28d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_bull_frac_long_w4320_f52_h28d.md"]


class TsBullFracLongW4320F52H28DStrategy:
    def __init__(self, symbols, window=4320, frac=0.52,
