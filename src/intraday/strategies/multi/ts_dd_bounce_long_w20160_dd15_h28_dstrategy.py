"""is_516_ts_dd_bounce_long_w20160_dd15_h28d — drawdown bounce long, hold 28d."""
...
ALPHA_CELL = {
    ...
    "idea_family": "ts_dd_bounce_long_w20160_dd15_h28d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_dd_bounce_long_w20160_dd15_h28d.md"]


class TsDdBounceLongW20160Dd15H28DStrategy:
    def __init__(self, symbols, window_bars=20160, dd_threshold=-0.15,
