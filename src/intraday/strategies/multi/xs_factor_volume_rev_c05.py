"""xs_factor_volume_rev_c05 — auto-generated XS factor.

Signal: volume  direction=rev  concentration=0.05
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_volume_rev_c05",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorVolumeRevC05(XsFactorBase):
