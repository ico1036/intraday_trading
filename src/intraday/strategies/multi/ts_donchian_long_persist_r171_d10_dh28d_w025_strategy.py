"""is_282_ts_donchian_long_persist_1d10d_h28d_w025 — long-only persist Donchian variant (round 17)."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_long_persist_1d10d_h28d_w025",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_long_persist_1d10d_h28d_w025.md"]


class TsDonchianLongPersistR171D10DH28dW025Strategy:
