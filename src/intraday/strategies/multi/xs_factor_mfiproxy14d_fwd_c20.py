"""xs_factor_mfiproxy14d_fwd_c20 — auto-generated XS factor.

Signal: mfi_proxy_14d  direction=fwd  concentration=0.2
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_mfi_proxy_14d_fwd_c20",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorMfiproxy14dFwdC20(XsFactorBase):
