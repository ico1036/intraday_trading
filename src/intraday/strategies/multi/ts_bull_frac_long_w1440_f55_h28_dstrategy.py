"""is_715_ts_bull_frac_long_w1440_f55_h28d — bullish-bar fraction long."""
...
ALPHA_CELL = {
    ...
    "idea_family": "ts_bull_frac_long_w1440_f55_h28d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_bull_frac_long_w1440_f55_h28d.md"]


class TsBullFracLongW1440F55H28DStrategy:
    def __init__(self, symbols, window=1440, frac=0.55,
