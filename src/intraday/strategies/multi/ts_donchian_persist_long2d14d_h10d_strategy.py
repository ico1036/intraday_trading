"""is_138_ts_donchian_persist_long2d14d_h10d — long-only persist Donchian (no shorts)."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_persist_long2d14d_h10d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_persist_long2d14d_h10d.md"]


class TsDonchianPersistLong2d14dH10dStrategy:
