"""ORB-fade basket_full time_stop rolling_rank."""
...
class OrbFadeBasketFullTsRrankStrategy:
    def __init__(self, symbols, or_minutes=60, flat_at_minute=1410, history_size=30, rank_threshold=0.30, max_weight=0.13, **_):
