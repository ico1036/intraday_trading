"""xs_factor_volosc520_fwd_c40 — auto-generated XS factor.

Signal: vol_osc_5_20  direction=fwd  concentration=0.4
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_vol_osc_5_20_fwd_c40",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorVolosc520FwdC40(XsFactorBase):
