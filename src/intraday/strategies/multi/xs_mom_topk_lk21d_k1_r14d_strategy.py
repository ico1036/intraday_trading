"""is_605_xs_mom_topk_lk21d_k1_r14d — XS momentum: long top-K by 30d return."""
...
ALPHA_CELL = {
    ...
    "idea_family": "xs_mom_topk_lk21d_k1_r14d",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_mom_topk_lk21d_k1_r14d.md"]


class XsMomTopkLk21dK1R14dStrategy:
