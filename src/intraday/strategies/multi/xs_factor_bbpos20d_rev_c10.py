"""xs_factor_bbpos20d_rev_c10 — auto-generated XS factor.

Signal: bb_pos_20d  direction=rev  concentration=0.1
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_bb_pos_20d_rev_c10",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorBbpos20dRevC10(XsFactorBase):
