"""xs_factor_eom5d_fwd_c50 — auto-generated XS factor.

Signal: eom_5d  direction=fwd  concentration=0.5
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_eom_5d_fwd_c50",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorEom5dFwdC50(XsFactorBase):
