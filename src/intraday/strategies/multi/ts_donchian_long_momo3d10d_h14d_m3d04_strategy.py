"""is_153_ts_donchian_long_momo_3d10d_h14d_m3d_w04 — long-only persist Donchian, momentum-confirmed re-entry."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_long_momo_3d10d_h14d_m3d_w04",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_long_momo_3d10d_h14d_m3d_w04.md"]


class TsDonchianLongMomo3d10dH14dM3d04Strategy:
