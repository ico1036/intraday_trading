"""xs_factor_volreal60d_fwd_c50 — auto-generated XS factor.

Signal: vol_real_60d  direction=fwd  concentration=0.5
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_vol_real_60d_fwd_c50",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorVolreal60dFwdC50(XsFactorBase):
