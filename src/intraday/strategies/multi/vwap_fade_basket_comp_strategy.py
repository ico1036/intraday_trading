"""VWAP fade basket composite (z + rank)."""
...
class VwapFadeBasketCompStrategy:
    def __init__(self, symbols, history_size=60, entry_thr=0.7, max_weight=0.13, **_):
