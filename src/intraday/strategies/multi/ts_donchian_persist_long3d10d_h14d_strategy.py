"""is_136_ts_donchian_persist_long3d10d_h14d — long-only persist Donchian (no shorts)."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_persist_long3d10d_h14d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_persist_long3d10d_h14d.md"]


class TsDonchianPersistLong3d10dH14dStrategy:
