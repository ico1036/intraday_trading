"""xs_factor_trixproxy15d_fwd_c20 — auto-generated XS factor.

Signal: trix_proxy_15d  direction=fwd  concentration=0.2
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_trix_proxy_15d_fwd_c20",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorTrixproxy15dFwdC20(XsFactorBase):
