"""Session extreme revert basket ewma_residual."""
...
class SessionExtremeRevertBasketEwmaStrategy:
    def __init__(
        self,
        symbols: list[str],
        ...
        **_: Any,
        ...
        self.ema_window = max(3, int(ema_window))
        ...
        self._ema_stretch: dict[str, float] = {s: 0.0 for s in self.symbols}
    ...
    def generate_order(self, state: MarketState) -> PortfolioOrder | None:
        ...
        for s in self.symbols:
            ...
            self._ema_stretch[s] = self.alpha_ema * stretch + (1 - self.alpha_ema) * self._ema_stretch[s]
            residual = stretch - self._ema_stretch[s]
            if residual <= 0:
                continue
