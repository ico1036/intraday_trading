"""is_118_ts_zrevert_1d_60m — extreme z-score mean reversion.
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_zrevert_1d_60m",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_zrevert_1d_60m.md"]


class TsZrevert1d60mStrategy:
    def __init__(self, symbols, window_bars=1440, hold_bars=60,
