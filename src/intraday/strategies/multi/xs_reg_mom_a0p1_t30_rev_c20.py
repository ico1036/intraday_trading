"""xs_reg_mom_a0p1_t30_rev_c20 — auto-generated ridge cross-sectional regression alpha.
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_reg_mom_a0p1_t30_rev_c20",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_regression_zoo.md"]


class XsRegMomA0p1T30RevC20(XsRegressionBase):
