"""xs_factor_aroonup14d_fwd_c50 — auto-generated XS factor.

Signal: aroon_up_14d  direction=fwd  concentration=0.5
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_aroon_up_14d_fwd_c50",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorAroonup14dFwdC50(XsFactorBase):
