"""is_017_ts_donchian_3day — 3-day Donchian breakout, 3-day hold."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_3day",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_3day.md"]


class TsDonchian3dayStrategy:
    def __init__(self, symbols, channel_bars=4320, rebalance_bars=240, hold_bars=4320, max_weight=0.14, **_):
