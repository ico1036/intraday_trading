"""is_607_xs_mom_topk_lk21d_k2_r14d — XS momentum: long top-K by 30d return."""
...
ALPHA_CELL = {
    ...
    "idea_family": "xs_mom_topk_lk21d_k2_r14d",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_mom_topk_lk21d_k2_r14d.md"]


class XsMomTopkLk21dK2R14dStrategy:
    def __init__(self, symbols, lookback_bars=30240, top_k=2,
                 rebalance_bars=20160, max_weight=0.3, **_):
