"""xs_factor_hightohigh60d_fwd_c40 — auto-generated XS factor.

Signal: high_to_high_60d  direction=fwd  concentration=0.4
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_high_to_high_60d_fwd_c40",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorHightohigh60dFwdC40(XsFactorBase):
    HISTORY_FIELDS = ('high',)
    HISTORY_LEN = 80
