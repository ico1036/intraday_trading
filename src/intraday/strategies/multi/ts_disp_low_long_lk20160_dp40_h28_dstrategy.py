"""is_977_ts_disp_low_long_lk20160_dp40_h28d — low-dispersion long basket."""
...
ALPHA_CELL = {
    ...
    "idea_family": "ts_disp_low_long_lk20160_dp40_h28d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_disp_low_long_lk20160_dp40_h28d.md"]


class TsDispLowLongLk20160Dp40H28DStrategy:
    def __init__(self, symbols, lookback=20160, disp_pct=0.4,
