"""xs_factor_mfiproxy14d_rev_c05 — auto-generated XS factor.

Signal: mfi_proxy_14d  direction=rev  concentration=0.05
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_mfi_proxy_14d_rev_c05",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorMfiproxy14dRevC05(XsFactorBase):
