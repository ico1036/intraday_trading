"""is_546_ts_mtf_trend_long_s1440_l10080_h28d — multi-timeframe trend confluence, hold 28d."""
...
ALPHA_CELL = {
    ...
    "idea_family": "ts_mtf_trend_long_s1440_l10080_h28d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_mtf_trend_long_s1440_l10080_h28d.md"]


class TsMtfTrendLongS1440L10080H28DStrategy:
    def __init__(self, symbols, short_window=1440, long_window=10080,
