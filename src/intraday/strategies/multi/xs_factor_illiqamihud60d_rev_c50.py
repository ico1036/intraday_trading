"""xs_factor_illiqamihud60d_rev_c50 — auto-generated XS factor.

Signal: illiq_amihud_60d  direction=rev  concentration=0.5
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_illiq_amihud_60d_rev_c50",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorIlliqamihud60dRevC50(XsFactorBase):
