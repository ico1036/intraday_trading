"""xs_factor_obv5d_fwd_c05 — auto-generated XS factor.

Signal: obv_5d  direction=fwd  concentration=0.05
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_obv_5d_fwd_c05",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorObv5dFwdC05(XsFactorBase):
