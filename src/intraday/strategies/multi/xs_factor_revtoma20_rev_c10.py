"""xs_factor_revtoma20_rev_c10 — auto-generated XS factor.

Signal: rev_to_ma20  direction=rev  concentration=0.1
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_rev_to_ma20_rev_c10",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorRevtoma20RevC10(XsFactorBase):
