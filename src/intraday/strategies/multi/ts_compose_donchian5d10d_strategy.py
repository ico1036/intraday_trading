"""is_058_ts_compose_donchian_5d10d — composite Donchian: enters only when fast AND slow channel agree."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_compose_donchian_5d10d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_compose_donchian_5d10d.md"]


class TsComposeDonchian5d10dStrategy:
