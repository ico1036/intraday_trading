"""xs_factor_revtoma20_rev_c30 — auto-generated XS factor.

Signal: rev_to_ma20  direction=rev  concentration=0.3
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_rev_to_ma20_rev_c30",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorRevtoma20RevC30(XsFactorBase):
