"""is_243_ts_donchian_long_persist_4d14d_h42d_w030 — long-only persist Donchian variant."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_long_persist_4d14d_h42d_w030",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_long_persist_4d14d_h42d_w030.md"]


class TsDonchianLongPersist4D14DH42dW030Strategy:
