"""is_340_ts_donchian_symmetric_f7d_s21d_h28d — symmetric Donchian persist (long upper-break + short lower-break)."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_symmetric_f7d_s21d_h28d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_symmetric.md"]


class TsDonchianSymmetricF7dS21dH28dStrategy:
    def __init__(self, symbols, fast_channel_bars=10080, slow_channel_bars=30240,
