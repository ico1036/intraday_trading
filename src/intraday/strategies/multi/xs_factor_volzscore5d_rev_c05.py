"""xs_factor_volzscore5d_rev_c05 — auto-generated XS factor.

Signal: vol_zscore_5d  direction=rev  concentration=0.05
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_vol_zscore_5d_rev_c05",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorVolzscore5dRevC05(XsFactorBase):
