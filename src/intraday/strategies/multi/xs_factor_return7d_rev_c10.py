"""xs_factor_return7d_rev_c10 — auto-generated XS factor.

Signal: return_7d  direction=rev  concentration=0.1
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_return_7d_rev_c10",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorReturn7dRevC10(XsFactorBase):
