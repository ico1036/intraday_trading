"""ORB-fade basket signal_flip with broader top_k=5 (composite scoring)."""
...
class OrbFadeBasketFullSignalTopk5Strategy:
    def __init__(self, symbols, top_k=4, or_minutes=30, history_size=30, entry_thr=0.3,
                 neutral_band=0.3, max_weight=0.2, **_):
