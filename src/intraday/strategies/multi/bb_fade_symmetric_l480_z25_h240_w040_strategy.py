"""bb_fade_symmetric_l480_z25_h240_w040 — BB-band fade symmetric (Z>τ short, Z<-τ long), hold N bars."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "bb_fade_symmetric_l480_z25_h240_w040",
}
SOURCE_NOTES: list[str] = ["research/notes/bb_fade_symmetric.md"]


class BbFadeSymmetricL480Z25H240W040Strategy:
