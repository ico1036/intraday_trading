"""xs_factor_closetohigh5d_rev_c40 — auto-generated XS factor.

Signal: close_to_high_5d  direction=rev  concentration=0.4
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_close_to_high_5d_rev_c40",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorClosetohigh5dRevC40(XsFactorBase):
