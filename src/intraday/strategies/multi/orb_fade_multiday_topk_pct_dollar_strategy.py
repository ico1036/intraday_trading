"""ORB-fade multi_day topk percentile."""
...
class OrbFadeMultidayTopkPctDollarStrategy:
    def __init__(self, symbols, top_k=3, or_minutes=30, lookback_days=3, history_size=30, pct=0.5,
                 max_weight=0.25, **_):
