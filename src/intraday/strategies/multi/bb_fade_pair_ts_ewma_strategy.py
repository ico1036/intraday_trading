"""BB-fade pair time_stop ewma_residual."""
...
class BbFadePairTsEwmaStrategy:
    def __init__(self, symbols, leg_a="BTCUSDT", leg_b="ETHUSDT", window=1440, k=2.0, ema_window=20, flat_at_minute=1410, rebalance_bars=60, max_weight=0.30, **_):
        ...
        self._ema_z = {s: 0.0 for s in self.active}
        self._bar_count = 0
