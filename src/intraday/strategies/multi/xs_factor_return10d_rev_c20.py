"""xs_factor_return10d_rev_c20 — auto-generated XS factor.

Signal: return_10d  direction=rev  concentration=0.2
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_return_10d_rev_c20",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorReturn10dRevC20(XsFactorBase):
