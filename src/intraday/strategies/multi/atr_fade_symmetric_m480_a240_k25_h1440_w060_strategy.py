"""atr_fade_symmetric_m480_a240_k25_h1440_w060 — ATR-channel fade symmetric (k=2.5 ATRs from EMA mean)."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "atr_fade_symmetric_m480_a240_k25_h1440_w060",
}
SOURCE_NOTES: list[str] = ["research/notes/atr_fade_symmetric.md"]


class AtrFadeSymmetricM480A240K25H1440W060Strategy:
    def __init__(self, symbols, mean_bars=480, atr_bars=240,
