"""xs_factor_return2d_rev_c05 — auto-generated XS factor.

Signal: return_2d  direction=rev  concentration=0.05
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_return_2d_rev_c05",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorReturn2dRevC05(XsFactorBase):
