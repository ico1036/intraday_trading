"""is_038_ts_donchian_5day_2week_hold — Donchian breakout variant."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_5day_2week_hold",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_5day_2week_hold.md"]


class TsDonchian5day2weekHoldStrategy:
    def __init__(self, symbols, channel_bars=7200, rebalance_bars=240, hold_bars=20160, max_weight=0.14, **_):
