"""xs_reg_mix4_a1p0_t30_fwd_c20 — auto-generated ridge cross-sectional regression alpha.
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_reg_mix4_a1p0_t30_fwd_c20",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_regression_zoo.md"]


class XsRegMix4A1p0T30FwdC20(XsRegressionBase):
