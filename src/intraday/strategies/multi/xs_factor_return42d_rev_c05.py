"""xs_factor_return42d_rev_c05 — auto-generated XS factor.

Signal: return_42d  direction=rev  concentration=0.05
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_return_42d_rev_c05",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorReturn42dRevC05(XsFactorBase):
