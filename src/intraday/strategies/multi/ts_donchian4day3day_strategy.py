"""is_048_ts_donchian_4day_3day — Donchian breakout asymmetric variant."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_4day_3day",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_4day_3day.md"]


class TsDonchian4day3dayStrategy:
    def __init__(self, symbols, channel_bars=5760, rebalance_bars=240, hold_bars=4320, max_weight=0.14, **_):
