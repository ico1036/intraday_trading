"""is_587_xs_mom_rank_l28d_k2_r7d — cross-section past-28d return rank, long top-2 / short bottom-2."""
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_mom_rank_l28d_k2_r7d",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_mom_rank.md"]


class XsMomRankL28dK2R7dStrategy:
