"""xs_factor_retskew252d_fwd_c30 — auto-generated XS factor.

Signal: ret_skew_252d  direction=fwd  concentration=0.3
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_ret_skew_252d_fwd_c30",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorRetskew252dFwdC30(XsFactorBase):
