"""xs_factor_mom18021_fwd_c10 — auto-generated XS factor.

Signal: mom_180_21  direction=fwd  concentration=0.1
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_mom_180_21_fwd_c10",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorMom18021FwdC10(XsFactorBase):
