"""xs_reg_mix6_a10p0_t30_rev_c10 — auto-generated ridge cross-sectional regression alpha.
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_reg_mix6_a10p0_t30_rev_c10",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_regression_zoo.md"]


class XsRegMix6A10p0T30RevC10(XsRegressionBase):
