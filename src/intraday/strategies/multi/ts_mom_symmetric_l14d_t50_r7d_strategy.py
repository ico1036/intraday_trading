"""is_683_ts_mom_symmetric_l14d_t50_r7d — TS-mom symmetric: long if past 14d return > 5.0%, short if < -5.0%."""
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "ts_mom_symmetric_l14d_t50_r7d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_mom_symmetric.md"]


class TsMomSymmetricL14dT50R7dStrategy:
    def __init__(self, symbols, lookback_bars=20160, rebalance_bars=10080,
                 entry_threshold=0.05, exit_threshold=0.015, max_weight=0.3, **_):
