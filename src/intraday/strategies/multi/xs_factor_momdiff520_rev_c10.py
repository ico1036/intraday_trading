"""xs_factor_momdiff520_rev_c10 — auto-generated XS factor.

Signal: mom_diff_5_20  direction=rev  concentration=0.1
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_mom_diff_5_20_rev_c10",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorMomdiff520RevC10(XsFactorBase):
