"""xs_factor_revtoma60_rev_c05 — auto-generated XS factor.

Signal: rev_to_ma60  direction=rev  concentration=0.05
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_rev_to_ma60_rev_c05",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorRevtoma60RevC05(XsFactorBase):
