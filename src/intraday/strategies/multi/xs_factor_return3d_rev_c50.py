"""xs_factor_return3d_rev_c50 — auto-generated XS factor.

Signal: return_3d  direction=rev  concentration=0.5
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_return_3d_rev_c50",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorReturn3dRevC50(XsFactorBase):
