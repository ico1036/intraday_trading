"""xs_factor_volratio2060_fwd_c50 — auto-generated XS factor.

Signal: vol_ratio_20_60  direction=fwd  concentration=0.5
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_vol_ratio_20_60_fwd_c50",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorVolratio2060FwdC50(XsFactorBase):
