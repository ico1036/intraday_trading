"""is_702_ts_range_exp_long_w1440_m20_h21d — HL range expansion long."""
...
ALPHA_CELL = {
    ...
    "idea_family": "ts_range_exp_long_w1440_m20_h21d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_range_exp_long_w1440_m20_h21d.md"]


class TsRangeExpLongW1440M20H21DStrategy:
    def __init__(self, symbols, window=1440, mult=2.0,
