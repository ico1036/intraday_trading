"""xs_factor_marefficiency252d_rev_c50 — auto-generated XS factor.

Signal: mar_efficiency_252d  direction=rev  concentration=0.5
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_mar_efficiency_252d_rev_c50",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorMarefficiency252dRevC50(XsFactorBase):
