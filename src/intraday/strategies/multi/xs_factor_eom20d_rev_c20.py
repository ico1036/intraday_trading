"""xs_factor_eom20d_rev_c20 — auto-generated XS factor.

Signal: eom_20d  direction=rev  concentration=0.2
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_eom_20d_rev_c20",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorEom20dRevC20(XsFactorBase):
