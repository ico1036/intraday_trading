"""xs_factor_retskew120d_fwd_c10 — auto-generated XS factor.

Signal: ret_skew_120d  direction=fwd  concentration=0.1
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_ret_skew_120d_fwd_c10",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorRetskew120dFwdC10(XsFactorBase):
