"""ts_mom_symmetric_v2_l10d_t50_r7d_w040 — TS-mom symmetric (v2), tuned position sizing."""
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "ts_mom_symmetric_v2_l10d_t50_r7d_w040",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_mom_symmetric.md"]


class TsMomSymmetricV2L10dT50R7dW040Strategy:
    def __init__(self, symbols, lookback_bars=14400, rebalance_bars=10080,
                 entry_threshold=0.05, exit_threshold=0.015, max_weight=0.04, **_):
