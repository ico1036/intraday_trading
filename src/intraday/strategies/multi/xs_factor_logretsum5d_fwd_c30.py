"""xs_factor_logretsum5d_fwd_c30 — auto-generated XS factor.

Signal: log_ret_sum_5d  direction=fwd  concentration=0.3
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_log_ret_sum_5d_fwd_c30",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorLogretsum5dFwdC30(XsFactorBase):
