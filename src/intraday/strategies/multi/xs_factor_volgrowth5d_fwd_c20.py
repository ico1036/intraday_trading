"""xs_factor_volgrowth5d_fwd_c20 — auto-generated XS factor.

Signal: vol_growth_5d  direction=fwd  concentration=0.2
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_vol_growth_5d_fwd_c20",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorVolgrowth5dFwdC20(XsFactorBase):
