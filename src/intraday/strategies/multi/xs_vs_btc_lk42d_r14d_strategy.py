"""is_623_xs_vs_btc_lk42d_r14d — basket top vs BTC spread."""
...
ALPHA_CELL = {
    ...
    "idea_family": "xs_vs_btc_lk42d_r14d",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_vs_btc_lk42d_r14d.md"]


class XsVsBtcLk42dR14dStrategy:
    def __init__(self, symbols, lookback_bars=60480, rebalance_bars=20160, max_weight=0.3, **_):
