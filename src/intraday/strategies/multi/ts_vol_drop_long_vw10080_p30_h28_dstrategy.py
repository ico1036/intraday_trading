"""is_917_ts_vol_drop_long_vw10080_p30_h28d — vol drop below percentile long."""
...
ALPHA_CELL = {
    ...
    "idea_family": "ts_vol_drop_long_vw10080_p30_h28d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_vol_drop_long_vw10080_p30_h28d.md"]


class TsVolDropLongVw10080P30H28DStrategy:
    def __init__(self, symbols, vol_w=10080, norm_w=43200, pct=0.3,
