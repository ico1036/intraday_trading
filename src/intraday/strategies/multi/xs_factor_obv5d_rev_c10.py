"""xs_factor_obv5d_rev_c10 — auto-generated XS factor.

Signal: obv_5d  direction=rev  concentration=0.1
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_obv_5d_rev_c10",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorObv5dRevC10(XsFactorBase):
