"""is_937_xs_accel_topk_s10_l42_k1_r14d — basket-relative accel long top-K."""
...
ALPHA_CELL = {
    ...
    "idea_family": "xs_accel_topk_s10_l42_k1_r14d",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_accel_topk_s10_l42_k1_r14d.md"]


class XsAccelTopkS10L42K1R14dStrategy:
    def __init__(self, symbols, short_w=14400, long_w=60480, top_k=1,
