"""is_609_xs_mom_topk_lk28d_k1_r14d — XS momentum: long top-K by 30d return."""
...
ALPHA_CELL = {
    ...
    "idea_family": "xs_mom_topk_lk28d_k1_r14d",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_mom_topk_lk28d_k1_r14d.md"]


class XsMomTopkLk28dK1R14dStrategy:
    def __init__(self, symbols, lookback_bars=40320, top_k=1,
