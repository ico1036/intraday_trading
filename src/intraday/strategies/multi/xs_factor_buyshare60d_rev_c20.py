"""xs_factor_buyshare60d_rev_c20 — auto-generated XS factor.

Signal: buy_share_60d  direction=rev  concentration=0.2
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_buy_share_60d_rev_c20",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorBuyshare60dRevC20(XsFactorBase):
