"""is_034_ts_donchian_4week_1week_hold — Donchian breakout variant."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_4week_1week_hold",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_4week_1week_hold.md"]


class TsDonchian4week1weekHoldStrategy:
    def __init__(self, symbols, channel_bars=40320, rebalance_bars=240, hold_bars=10080, max_weight=0.14, **_):
