"""is_041_ts_donchian_weekly_2day_hold — Donchian breakout variant."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_weekly_2day_hold",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_weekly_2day_hold.md"]


class TsDonchianWeekly2dayHoldStrategy:
    def __init__(self, symbols, channel_bars=10080, rebalance_bars=240, hold_bars=2880, max_weight=0.14, **_):
