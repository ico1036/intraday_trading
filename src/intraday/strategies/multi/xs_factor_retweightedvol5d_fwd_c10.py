"""xs_factor_retweightedvol5d_fwd_c10 — auto-generated XS factor.

Signal: ret_weighted_vol_5d  direction=fwd  concentration=0.1
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_ret_weighted_vol_5d_fwd_c10",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorRetweightedvol5dFwdC10(XsFactorBase):
