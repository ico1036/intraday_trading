"""xs_factor_upsidevol20d_fwd_c50 — auto-generated XS factor.

Signal: upside_vol_20d  direction=fwd  concentration=0.5
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_upside_vol_20d_fwd_c50",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorUpsidevol20dFwdC50(XsFactorBase):
