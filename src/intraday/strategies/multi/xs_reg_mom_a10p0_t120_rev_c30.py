"""xs_reg_mom_a10p0_t120_rev_c30 — auto-generated ridge cross-sectional regression alpha.

Features: ['ret1d', 'ret5d', 'ret20d', 'ret60d']  ridge α=10.0  train window=120d
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_reg_mom_a10p0_t120_rev_c30",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_regression_zoo.md"]


class XsRegMomA10p0T120RevC30(XsRegressionBase):
