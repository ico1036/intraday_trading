"""xs_factor_atrproxy7d_fwd_c20 — auto-generated XS factor.

Signal: atr_proxy_7d  direction=fwd  concentration=0.2
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_atr_proxy_7d_fwd_c20",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorAtrproxy7dFwdC20(XsFactorBase):
