"""xs_factor_illiqamihud20d_rev_c40 — auto-generated XS factor.

Signal: illiq_amihud_20d  direction=rev  concentration=0.4
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_illiq_amihud_20d_rev_c40",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorIlliqamihud20dRevC40(XsFactorBase):
