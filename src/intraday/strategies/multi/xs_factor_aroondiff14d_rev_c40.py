"""xs_factor_aroondiff14d_rev_c40 — auto-generated XS factor.

Signal: aroon_diff_14d  direction=rev  concentration=0.4
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_aroon_diff_14d_rev_c40",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorAroondiff14dRevC40(XsFactorBase):
