"""is_066_ts_donchian_trend_3d14d — Donchian trend-filter: slow regime + fast entry."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_trend_3d14d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_trend_3d14d.md"]


class TsDonchianTrend3d14dStrategy:
