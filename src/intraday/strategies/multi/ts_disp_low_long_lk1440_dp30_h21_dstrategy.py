"""is_956_ts_disp_low_long_lk1440_dp30_h21d — low-dispersion long basket."""
...
ALPHA_CELL = {
    ...
    "idea_family": "ts_disp_low_long_lk1440_dp30_h21d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_disp_low_long_lk1440_dp30_h21d.md"]


class TsDispLowLongLk1440Dp30H21DStrategy:
    def __init__(self, symbols, lookback=1440, disp_pct=0.3,
