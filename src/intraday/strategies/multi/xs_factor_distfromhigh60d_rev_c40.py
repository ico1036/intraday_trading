"""xs_factor_distfromhigh60d_rev_c40 — auto-generated XS factor.

Signal: dist_from_high_60d  direction=rev  concentration=0.4
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_dist_from_high_60d_rev_c40",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorDistfromhigh60dRevC40(XsFactorBase):
