"""xs_factor_illiqamihud5d_fwd_c20 — auto-generated XS factor.

Signal: illiq_amihud_5d  direction=fwd  concentration=0.2
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_illiq_amihud_5d_fwd_c20",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorIlliqamihud5dFwdC20(XsFactorBase):
