"""xs_factor_return126d_fwd_c20 — auto-generated XS factor.

Signal: return_126d  direction=fwd  concentration=0.2
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_return_126d_fwd_c20",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorReturn126dFwdC20(XsFactorBase):
