"""xs_factor_volzscore20d_fwd_c20 — auto-generated XS factor.

Signal: vol_zscore_20d  direction=fwd  concentration=0.2
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_vol_zscore_20d_fwd_c20",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorVolzscore20dFwdC20(XsFactorBase):
