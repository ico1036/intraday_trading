"""is_974_ts_disp_low_long_lk20160_dp30_h21d — low-dispersion long basket."""
...
ALPHA_CELL = {
    ...
    "idea_family": "ts_disp_low_long_lk20160_dp30_h21d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_disp_low_long_lk20160_dp30_h21d.md"]


class TsDispLowLongLk20160Dp30H21DStrategy:
    def __init__(self, symbols, lookback=20160, disp_pct=0.3,
