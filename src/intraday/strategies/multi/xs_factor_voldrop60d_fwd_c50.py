"""xs_factor_voldrop60d_fwd_c50 — auto-generated XS factor.

Signal: vol_drop_60d  direction=fwd  concentration=0.5
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_vol_drop_60d_fwd_c50",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorVoldrop60dFwdC50(XsFactorBase):
