"""atr_fade_symmetric_m2880_a240_k15_h480_w040 — ATR-channel fade symmetric (k=1.5 ATRs from EMA mean)."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "atr_fade_symmetric_m2880_a240_k15_h480_w040",
}
SOURCE_NOTES: list[str] = ["research/notes/atr_fade_symmetric.md"]


class AtrFadeSymmetricM2880A240K15H480W040Strategy:
