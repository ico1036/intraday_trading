"""xs_factor_roc6d_rev_c10 — auto-generated XS factor.

Signal: roc_6d  direction=rev  concentration=0.1
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_roc_6d_rev_c10",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorRoc6dRevC10(XsFactorBase):
