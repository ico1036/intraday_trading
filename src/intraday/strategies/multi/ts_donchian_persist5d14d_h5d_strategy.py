"""is_090_ts_donchian_persist_5d14d_h5d — Donchian trend-filter with regime-persistent re-entry.
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_persist_5d14d_h5d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_persist_5d14d_h5d.md"]


class TsDonchianPersist5d14dH5dStrategy:
