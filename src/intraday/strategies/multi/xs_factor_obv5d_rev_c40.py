"""xs_factor_obv5d_rev_c40 — auto-generated XS factor.

Signal: obv_5d  direction=rev  concentration=0.4
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_obv_5d_rev_c40",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorObv5dRevC40(XsFactorBase):
