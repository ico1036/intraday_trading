"""BB-fade single BTC time_stop composite."""
...
class BbFadeSingleBtcTsCompStrategy:
    def __init__(self, symbols, target="BTCUSDT", window=1440, k=2.0, flat_at_minute=1410, rebalance_bars=60, max_weight=0.5, composite_threshold=0.10, **_):
