"""is_193_ts_donchian_long_persist_2d10d_h28d_w035 — long-only persist Donchian variant."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_long_persist_2d10d_h28d_w035",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_long_persist_2d10d_h28d_w035.md"]


class TsDonchianLongPersist2D10DH28dW035Strategy:
