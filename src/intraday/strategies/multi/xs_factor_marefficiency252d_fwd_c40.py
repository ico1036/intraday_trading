"""xs_factor_marefficiency252d_fwd_c40 — auto-generated XS factor.

Signal: mar_efficiency_252d  direction=fwd  concentration=0.4
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_mar_efficiency_252d_fwd_c40",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorMarefficiency252dFwdC40(XsFactorBase):
