"""xs_factor_amihud60d_fwd_c05 — auto-generated XS factor.

Signal: amihud_60d  direction=fwd  concentration=0.05
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_amihud_60d_fwd_c05",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorAmihud60dFwdC05(XsFactorBase):
