"""xs_factor_streak5dsigned_fwd_c50 — auto-generated XS factor.

Signal: streak_5d_signed  direction=fwd  concentration=0.5
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_streak_5d_signed_fwd_c50",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorStreak5dsignedFwdC50(XsFactorBase):
