"""xs_reg_vol_a1p0_t60_rev_c30 — auto-generated ridge cross-sectional regression alpha.
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_reg_vol_a1p0_t60_rev_c30",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_regression_zoo.md"]


class XsRegVolA1p0T60RevC30(XsRegressionBase):
