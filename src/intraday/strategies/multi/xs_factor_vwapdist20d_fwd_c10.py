"""xs_factor_vwapdist20d_fwd_c10 — auto-generated XS factor.

Signal: vwap_dist_20d  direction=fwd  concentration=0.1
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_vwap_dist_20d_fwd_c10",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorVwapdist20dFwdC10(XsFactorBase):
