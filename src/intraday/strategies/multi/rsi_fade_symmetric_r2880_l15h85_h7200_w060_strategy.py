"""rsi_fade_symmetric_r2880_l15h85_h7200_w060 — RSI extreme fade (long RSI<15, short RSI>85)."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "rsi_fade_symmetric_r2880_l15h85_h7200_w060",
}
SOURCE_NOTES: list[str] = ["research/notes/rsi_fade_symmetric.md"]


class RsiFadeSymmetricR2880L15h85H7200W060Strategy:
    def __init__(self, symbols, rsi_bars=2880, rebalance_bars=60,
                 low_threshold=15, high_threshold=85,
