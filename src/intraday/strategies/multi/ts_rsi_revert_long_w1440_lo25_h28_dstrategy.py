"""is_508_ts_rsi_revert_long_w1440_lo25_h28d — RSI oversold long, hold 28d."""
...
ALPHA_CELL = {
    ...
    "idea_family": "ts_rsi_revert_long_w1440_lo25_h28d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_rsi_revert_long_w1440_lo25_h28d.md"]


class TsRsiRevertLongW1440Lo25H28DStrategy:
    def __init__(self, symbols, rsi_window=1440, rsi_lower=25,
