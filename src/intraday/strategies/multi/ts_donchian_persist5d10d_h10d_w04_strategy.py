"""is_133_ts_donchian_persist_5d10d_h10d_w04 — persist Donchian, smaller position."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_persist_5d10d_h10d_w04",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_persist_5d10d_h10d_w04.md"]


class TsDonchianPersist5d10dH10dW04Strategy:
