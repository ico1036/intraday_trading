"""Session extreme revert multi_day topk rolling_rank."""
...
class SextMultidayTopkRrankDollarStrategy:
    def __init__(self, symbols, top_k=3, lookback_days=3, history_size=30, rank_thr=0.5, max_weight=0.25, **_):
