"""xs_factor_return7d_fwd_c40 — auto-generated XS factor.

Signal: return_7d  direction=fwd  concentration=0.4
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_return_7d_fwd_c40",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorReturn7dFwdC40(XsFactorBase):
