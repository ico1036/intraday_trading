"""is_132_ts_donchian_persist_3d2week_h10d_w05 — persist Donchian, smaller position."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_persist_3d2week_h10d_w05",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_persist_3d2week_h10d_w05.md"]


class TsDonchianPersist3d2weekH10dW05Strategy:
