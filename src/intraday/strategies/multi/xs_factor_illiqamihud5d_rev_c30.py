"""xs_factor_illiqamihud5d_rev_c30 — auto-generated XS factor.

Signal: illiq_amihud_5d  direction=rev  concentration=0.3
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_illiq_amihud_5d_rev_c30",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorIlliqamihud5dRevC30(XsFactorBase):
