"""Session extreme revert basket neutral_zone percentile."""
...
class SextBasketNeutralPctStrategy:
    def __init__(self, symbols, history_size=30, pct=0.5, neutral_band=0.4, max_weight=0.13, **_):
