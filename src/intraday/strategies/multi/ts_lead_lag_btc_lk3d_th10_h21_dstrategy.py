"""is_638_ts_lead_lag_btc_lk3d_th10_h21d — long alts if BTC recently up."""
...
ALPHA_CELL = {
    ...
    "idea_family": "ts_lead_lag_btc_lk3d_th10_h21d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_lead_lag_btc_lk3d_th10_h21d.md"]


class TsLeadLagBtcLk3dTh10H21DStrategy:
