"""ts_donchian_symmetric_v3_f3d_s12d_h49d_w030 — symmetric Donchian persist (v3 fine-tune around v2 working zone)."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_symmetric_v3_f3d_s12d_h49d_w030",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_symmetric.md"]


class TsDonchianSymmetricV3F3dS12dH49dW030Strategy:
