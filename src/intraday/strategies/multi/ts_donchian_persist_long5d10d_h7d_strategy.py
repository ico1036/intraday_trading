"""is_142_ts_donchian_persist_long5d10d_h7d — long-only persist Donchian (no shorts)."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_persist_long5d10d_h7d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_persist_long5d10d_h7d.md"]


class TsDonchianPersistLong5d10dH7dStrategy:
    def __init__(self, symbols, fast_channel_bars=7200, slow_channel_bars=14400,
                 rebalance_bars=240, hold_bars=10080, max_weight=0.07, **_):
