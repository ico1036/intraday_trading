"""xs_factor_volreal126d_rev_c10 — auto-generated XS factor.

Signal: vol_real_126d  direction=rev  concentration=0.1
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_vol_real_126d_rev_c10",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorVolreal126dRevC10(XsFactorBase):
