"""xs_factor_eom5d_rev_c05 — auto-generated XS factor.

Signal: eom_5d  direction=rev  concentration=0.05
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_eom_5d_rev_c05",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorEom5dRevC05(XsFactorBase):
