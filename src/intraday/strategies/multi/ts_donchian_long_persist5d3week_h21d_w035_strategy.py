"""is_179_ts_donchian_long_persist_5d3week_h21d_w035 — long-only persist Donchian, smaller weight."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_long_persist_5d3week_h21d_w035",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_long_persist_5d3week_h21d_w035.md"]


class TsDonchianLongPersist5d3weekH21dW035Strategy:
