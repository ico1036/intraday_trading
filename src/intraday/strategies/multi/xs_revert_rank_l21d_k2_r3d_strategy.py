"""is_620_xs_revert_rank_l21d_k2_r3d — cross-section past-21d reversal rank, long bottom-2 / short top-2."""
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_revert_rank_l21d_k2_r3d",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_revert_rank.md"]


class XsRevertRankL21dK2R3dStrategy:
