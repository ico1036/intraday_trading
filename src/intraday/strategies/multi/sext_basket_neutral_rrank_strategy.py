"""Session extreme revert basket neutral_zone rolling_rank."""
...
class SextBasketNeutralRrankStrategy:
    def __init__(self, symbols, history_size=30, rank_thr=0.5, neutral_band=0.4, max_weight=0.13, **_):
