"""xs_reg_vol_a10p0_t120_fwd_c30 — auto-generated ridge cross-sectional regression alpha.
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_reg_vol_a10p0_t120_fwd_c30",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_regression_zoo.md"]


class XsRegVolA10p0T120FwdC30(XsRegressionBase):
