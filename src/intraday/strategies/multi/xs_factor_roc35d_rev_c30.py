"""xs_factor_roc35d_rev_c30 — auto-generated XS factor.

Signal: roc_35d  direction=rev  concentration=0.3
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_roc_35d_rev_c30",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorRoc35dRevC30(XsFactorBase):
