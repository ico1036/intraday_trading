"""xs_factor_return3d_fwd_c10 — auto-generated XS factor.

Signal: return_3d  direction=fwd  concentration=0.1
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_return_3d_fwd_c10",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorReturn3dFwdC10(XsFactorBase):
