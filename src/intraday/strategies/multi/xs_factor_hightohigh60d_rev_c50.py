"""xs_factor_hightohigh60d_rev_c50 — auto-generated XS factor.

Signal: high_to_high_60d  direction=rev  concentration=0.5
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_high_to_high_60d_rev_c50",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorHightohigh60dRevC50(XsFactorBase):
    HISTORY_FIELDS = ('high',)
    HISTORY_LEN = 80
