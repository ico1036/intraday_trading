"""VWAP fade basket z_score on deviation history."""
...
class VwapFadeBasketZscoreStrategy:
    def __init__(self, symbols, history_size=60, entry_z=1.0, max_weight=0.13, **_):
    ...
    def generate_order(self, state):
        ...
        for s in self.symbols:
            ...
            if len(hist) >= 10:
                ...
                z = dev / sd
                tgt = None
                if z >= self.entry_z: tgt = "SHORT"
                elif z <= -self.entry_z: tgt = "LONG"
