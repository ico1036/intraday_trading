"""ts_donchian_symmetric_v2_f1d_s21d_h28d_w060 — symmetric Donchian persist (long upper + short lower), tuned position sizing."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_symmetric_v2_f1d_s21d_h28d_w060",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_symmetric.md"]


class TsDonchianSymmetricV2F1dS21dH28dW060Strategy:
    def __init__(self, symbols, fast_channel_bars=1440, slow_channel_bars=30240,
                 rebalance_bars=240, hold_bars=40320, max_weight=0.06, **_):
