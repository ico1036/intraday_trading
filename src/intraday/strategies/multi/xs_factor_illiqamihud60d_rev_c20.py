"""xs_factor_illiqamihud60d_rev_c20 — auto-generated XS factor.

Signal: illiq_amihud_60d  direction=rev  concentration=0.2
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_illiq_amihud_60d_rev_c20",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorIlliqamihud60dRevC20(XsFactorBase):
