"""xs_factor_return21d_fwd_c30 — auto-generated XS factor.

Signal: return_21d  direction=fwd  concentration=0.3
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_return_21d_fwd_c30",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorReturn21dFwdC30(XsFactorBase):
