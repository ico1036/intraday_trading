"""is_164_ts_donchian_long_persist_3d10d_h21d_w04 — long-only persist Donchian, very long hold."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_long_persist_3d10d_h21d_w04",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_long_persist_3d10d_h21d_w04.md"]


class TsDonchianLongPersist3d10dH21dW04Strategy:
