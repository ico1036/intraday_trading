"""xs_factor_retsign1d_rev_c05 — auto-generated XS factor.

Signal: ret_sign_1d  direction=rev  concentration=0.05
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_ret_sign_1d_rev_c05",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorRetsign1dRevC05(XsFactorBase):
