"""Donchian fade basket neutral_zone."""
...
class DonchianFadeBasketNeutralStrategy:
    def __init__(self, symbols, lookback=240, neutral_band=0.4, max_weight=0.13, **_):
