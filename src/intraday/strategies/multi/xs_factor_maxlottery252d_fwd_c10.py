"""xs_factor_maxlottery252d_fwd_c10 — auto-generated XS factor.

Signal: max_lottery_252d  direction=fwd  concentration=0.1
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_max_lottery_252d_fwd_c10",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorMaxlottery252dFwdC10(XsFactorBase):
