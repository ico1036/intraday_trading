"""is_953_xs_accel_topk_s14_l56_k3_r14d — basket-relative accel long top-K."""
...
ALPHA_CELL = {
    ...
    "idea_family": "xs_accel_topk_s14_l56_k3_r14d",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_accel_topk_s14_l56_k3_r14d.md"]


class XsAccelTopkS14L56K3R14dStrategy:
    def __init__(self, symbols, short_w=20160, long_w=80640, top_k=3,
