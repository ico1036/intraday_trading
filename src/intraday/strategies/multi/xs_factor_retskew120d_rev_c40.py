"""xs_factor_retskew120d_rev_c40 — auto-generated XS factor.

Signal: ret_skew_120d  direction=rev  concentration=0.4
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_ret_skew_120d_rev_c40",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorRetskew120dRevC40(XsFactorBase):
