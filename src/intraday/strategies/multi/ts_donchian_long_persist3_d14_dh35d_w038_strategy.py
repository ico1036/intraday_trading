"""is_224_ts_donchian_long_persist_3d14d_h35d_w038 — long-only persist Donchian variant."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_long_persist_3d14d_h35d_w038",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_long_persist_3d14d_h35d_w038.md"]


class TsDonchianLongPersist3D14DH35dW038Strategy:
