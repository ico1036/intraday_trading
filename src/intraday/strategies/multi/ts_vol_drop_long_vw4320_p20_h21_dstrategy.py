"""is_908_ts_vol_drop_long_vw4320_p20_h21d — vol drop below percentile long."""
...
ALPHA_CELL = {
    ...
    "idea_family": "ts_vol_drop_long_vw4320_p20_h21d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_vol_drop_long_vw4320_p20_h21d.md"]


class TsVolDropLongVw4320P20H21DStrategy:
    def __init__(self, symbols, vol_w=4320, norm_w=43200, pct=0.2,
