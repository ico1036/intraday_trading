"""is_771_ts_new_high_long_w40320_h42d_r7d — new-high follow-through long."""
...
ALPHA_CELL = {
    ...
    "idea_family": "ts_new_high_long_w40320_h42d_r7d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_new_high_long_w40320_h42d_r7d.md"]


class TsNewHighLongW40320H42DR7DStrategy:
    def __init__(self, symbols, window=40320,
