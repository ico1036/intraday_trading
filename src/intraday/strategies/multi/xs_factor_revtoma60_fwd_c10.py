"""xs_factor_revtoma60_fwd_c10 — auto-generated XS factor.

Signal: rev_to_ma60  direction=fwd  concentration=0.1
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_rev_to_ma60_fwd_c10",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorRevtoma60FwdC10(XsFactorBase):
