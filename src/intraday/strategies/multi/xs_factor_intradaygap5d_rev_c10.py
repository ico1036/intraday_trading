"""xs_factor_intradaygap5d_rev_c10 — auto-generated XS factor.

Signal: intraday_gap_5d  direction=rev  concentration=0.1
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_intraday_gap_5d_rev_c10",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorIntradaygap5dRevC10(XsFactorBase):
