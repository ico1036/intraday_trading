"""is_101_ts_donchian_persist_3d2week_h10d — persist Donchian, longer hold."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_persist_3d2week_h10d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_persist_3d2week_h10d.md"]


class TsDonchianPersist3d2weekH10dStrategy:
