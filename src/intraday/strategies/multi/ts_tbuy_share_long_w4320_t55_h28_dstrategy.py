"""is_733_ts_tbuy_share_long_w4320_t55_h28d — taker-buy volume fraction long."""
...
ALPHA_CELL = {
    ...
    "idea_family": "ts_tbuy_share_long_w4320_t55_h28d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_tbuy_share_long_w4320_t55_h28d.md"]


class TsTbuyShareLongW4320T55H28DStrategy:
    def __init__(self, symbols, window=4320, imb_threshold=0.55,
