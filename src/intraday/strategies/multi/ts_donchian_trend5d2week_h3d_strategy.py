"""is_079_ts_donchian_trend_5d2week_h3d — Donchian trend-filter variant."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_trend_5d2week_h3d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_trend_5d2week_h3d.md"]


class TsDonchianTrend5d2weekH3dStrategy:
