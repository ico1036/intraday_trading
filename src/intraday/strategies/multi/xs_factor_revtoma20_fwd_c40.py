"""xs_factor_revtoma20_fwd_c40 — auto-generated XS factor.

Signal: rev_to_ma20  direction=fwd  concentration=0.4
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_rev_to_ma20_fwd_c40",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorRevtoma20FwdC40(XsFactorBase):
