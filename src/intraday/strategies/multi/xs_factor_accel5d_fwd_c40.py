"""xs_factor_accel5d_fwd_c40 — auto-generated XS factor.

Signal: accel_5d  direction=fwd  concentration=0.4
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_accel_5d_fwd_c40",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorAccel5dFwdC40(XsFactorBase):
