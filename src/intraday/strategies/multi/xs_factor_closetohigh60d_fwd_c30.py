"""xs_factor_closetohigh60d_fwd_c30 — auto-generated XS factor.

Signal: close_to_high_60d  direction=fwd  concentration=0.3
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_close_to_high_60d_fwd_c30",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorClosetohigh60dFwdC30(XsFactorBase):
