"""is_522_xs_donchian_rank_c14d_k1_r7d — cross-section Donchian channel-position rank, long top-K / short bottom-K."""
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_donchian_rank_c14d_k1_r7d",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_donchian_rank.md"]


class XsDonchianRankC14dK1R7dStrategy:
    def __init__(self, symbols, channel_bars=20160, rebalance_bars=10080,
