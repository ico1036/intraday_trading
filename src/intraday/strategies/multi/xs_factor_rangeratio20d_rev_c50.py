"""xs_factor_rangeratio20d_rev_c50 — auto-generated XS factor.

Signal: range_ratio_20d  direction=rev  concentration=0.5
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_range_ratio_20d_rev_c50",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorRangeratio20dRevC50(XsFactorBase):
