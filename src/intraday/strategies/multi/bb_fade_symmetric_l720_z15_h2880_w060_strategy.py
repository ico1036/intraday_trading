"""bb_fade_symmetric_l720_z15_h2880_w060 — BB-band fade symmetric (Z>τ short, Z<-τ long), hold N bars."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "bb_fade_symmetric_l720_z15_h2880_w060",
}
SOURCE_NOTES: list[str] = ["research/notes/bb_fade_symmetric.md"]


class BbFadeSymmetricL720Z15H2880W060Strategy:
    def __init__(self, symbols, lookback_bars=720, rebalance_bars=60,
                 entry_z=1.5, hold_bars=2880, max_weight=0.06, **_):
