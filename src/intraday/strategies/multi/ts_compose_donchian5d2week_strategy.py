"""is_060_ts_compose_donchian_5d2week — composite Donchian: enters only when fast AND slow channel agree."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_compose_donchian_5d2week",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_compose_donchian_5d2week.md"]


class TsComposeDonchian5d2weekStrategy:
