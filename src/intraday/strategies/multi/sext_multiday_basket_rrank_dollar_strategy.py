"""Session extreme revert multi_day basket rolling_rank."""
...
class SextMultidayBasketRrankDollarStrategy:
    def __init__(self, symbols, lookback_days=3, history_size=30, rank_thr=0.5, max_weight=0.13, **_):
