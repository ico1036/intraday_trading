"""xs_factor_momminusrev25221_fwd_c20 — auto-generated XS factor.

Signal: mom_minus_rev_252_21  direction=fwd  concentration=0.2
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_mom_minus_rev_252_21_fwd_c20",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorMomminusrev25221FwdC20(XsFactorBase):
