"""xs_factor_retkurt60d_fwd_c40 — auto-generated XS factor.

Signal: ret_kurt_60d  direction=fwd  concentration=0.4
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_ret_kurt_60d_fwd_c40",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorRetkurt60dFwdC40(XsFactorBase):
