"""xs_factor_accel10d_rev_c05 — auto-generated XS factor.

Signal: accel_10d  direction=rev  concentration=0.05
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_accel_10d_rev_c05",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorAccel10dRevC05(XsFactorBase):
