"""is_865_ts_skew_long_w20160_st10_h28d — negative skew capitulation long."""
...
ALPHA_CELL = {
    ...
    "idea_family": "ts_skew_long_w20160_st10_h28d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_skew_long_w20160_st10_h28d.md"]


class TsSkewLongW20160St10H28DStrategy:
    def __init__(self, symbols, window=20160, skew_threshold=-1.0,
