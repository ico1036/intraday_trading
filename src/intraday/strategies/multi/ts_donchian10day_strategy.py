"""is_023_ts_donchian_10day — Donchian breakout variant."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_10day",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_10day.md"]


class TsDonchian10dayStrategy:
    def __init__(self, symbols, channel_bars=14400, rebalance_bars=240, hold_bars=14400, max_weight=0.14, **_):
