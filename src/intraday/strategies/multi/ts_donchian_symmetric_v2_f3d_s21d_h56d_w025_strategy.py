"""ts_donchian_symmetric_v2_f3d_s21d_h56d_w025 — symmetric Donchian persist (long upper + short lower), tuned position sizing."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_symmetric_v2_f3d_s21d_h56d_w025",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_symmetric.md"]


class TsDonchianSymmetricV2F3dS21dH56dW025Strategy:
    def __init__(self, symbols, fast_channel_bars=4320, slow_channel_bars=30240,
                 rebalance_bars=240, hold_bars=80640, max_weight=0.025, **_):
