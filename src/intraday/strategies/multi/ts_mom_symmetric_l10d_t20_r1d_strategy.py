"""is_666_ts_mom_symmetric_l10d_t20_r1d — TS-mom symmetric: long if past 10d return > 2.0%, short if < -2.0%."""
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "ts_mom_symmetric_l10d_t20_r1d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_mom_symmetric.md"]


class TsMomSymmetricL10dT20R1dStrategy:
