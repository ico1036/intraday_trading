"""is_770_ts_new_high_long_w40320_h42d_r1d — new-high follow-through long."""
...
ALPHA_CELL = {
    ...
    "idea_family": "ts_new_high_long_w40320_h42d_r1d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_new_high_long_w40320_h42d_r1d.md"]


class TsNewHighLongW40320H42DR1DStrategy:
    def __init__(self, symbols, window=40320,
                 rebalance_bars=1440, hold_bars=60480, max_weight=0.035, **_):
