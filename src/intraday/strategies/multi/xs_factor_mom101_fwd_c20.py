"""xs_factor_mom101_fwd_c20 — auto-generated XS factor.

Signal: mom_10_1  direction=fwd  concentration=0.2
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_mom_10_1_fwd_c20",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorMom101FwdC20(XsFactorBase):
