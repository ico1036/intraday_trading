"""is_051_ts_donchian_8day_3day — Donchian breakout asymmetric variant."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_8day_3day",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_8day_3day.md"]


class TsDonchian8day3dayStrategy:
    def __init__(self, symbols, channel_bars=11520, rebalance_bars=240, hold_bars=4320, max_weight=0.14, **_):
