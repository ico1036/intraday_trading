"""is_767_ts_new_high_long_w40320_h21d_r7d — new-high follow-through long."""
...
ALPHA_CELL = {
    ...
    "idea_family": "ts_new_high_long_w40320_h21d_r7d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_new_high_long_w40320_h21d_r7d.md"]


class TsNewHighLongW40320H21DR7DStrategy:
    def __init__(self, symbols, window=40320,
                 rebalance_bars=10080, hold_bars=30240, max_weight=0.035, **_):
