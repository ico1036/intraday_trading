"""xs_factor_retweightedvol20d_fwd_c20 — auto-generated XS factor.

Signal: ret_weighted_vol_20d  direction=fwd  concentration=0.2
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_ret_weighted_vol_20d_fwd_c20",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorRetweightedvol20dFwdC20(XsFactorBase):
