"""xs_factor_vwapdist5d_fwd_c50 — auto-generated XS factor.

Signal: vwap_dist_5d  direction=fwd  concentration=0.5
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_vwap_dist_5d_fwd_c50",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorVwapdist5dFwdC50(XsFactorBase):
