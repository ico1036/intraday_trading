"""ts_donchian_symmetric_v2_f3d_s21d_h28d_w025 — symmetric Donchian persist (long upper + short lower), tuned position sizing."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_symmetric_v2_f3d_s21d_h28d_w025",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_symmetric.md"]


class TsDonchianSymmetricV2F3dS21dH28dW025Strategy:
