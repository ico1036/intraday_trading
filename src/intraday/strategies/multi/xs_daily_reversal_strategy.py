"""is_003_xs_daily_reversal — daily cross-sectional return reversal.

Cell-distinct from is_002_xs_daily_momentum (different idea_family). Direction
is inverted: long the worst-performing symbol of the past 24h, short the
best. Same daily rebalance cadence keeps round-trip fees small.
"""
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_daily_reversal",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_daily_reversal.md"]


class XsDailyReversalStrategy:
    def __init__(
        self,
        symbols: list[str],
    ...
    def generate_order(self, state: MarketState) -> PortfolioOrder | None:
        ...
        # Reversal: invert sign vs is_002.
