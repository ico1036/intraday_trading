"""xs_factor_marefficiency20d_rev_c30 — auto-generated XS factor.

Signal: mar_efficiency_20d  direction=rev  concentration=0.3
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_mar_efficiency_20d_rev_c30",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorMarefficiency20dRevC30(XsFactorBase):
