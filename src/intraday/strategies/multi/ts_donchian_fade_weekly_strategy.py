"""is_019_ts_donchian_fade_weekly — fade 7-day breakouts (mean-revert)."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_fade_weekly",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_fade_weekly.md"]


class TsDonchianFadeWeeklyStrategy:
    def __init__(self, symbols, channel_bars=10080, rebalance_bars=240, hold_bars=10080, max_weight=0.14, **_):
    ...
    def generate_order(self, state):
        ...
        if self._bar_count % self.rebalance_bars == 0:
            ...
            for s in self.symbols:
                ...
                cs = self._side(state, s)
                # FADE: SHORT new high, LONG new low.
                if close >= hi and cs != "SHORT": cands.append((s, "SHORT"))
                elif close <= lo and cs != "LONG": cands.append((s, "LONG"))
