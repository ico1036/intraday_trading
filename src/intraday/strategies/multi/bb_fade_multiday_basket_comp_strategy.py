"""BB band fade multi_day basket composite."""
...
class BbFadeMultidayBasketCompStrategy:
    def __init__(self, symbols, lookback=720, k=2.0, history_size=30, entry_thr=0.5, max_weight=0.13, **_):
