"""xs_factor_calmarproxy20d_rev_c10 — auto-generated XS factor.

Signal: calmar_proxy_20d  direction=rev  concentration=0.1
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_calmar_proxy_20d_rev_c10",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorCalmarproxy20dRevC10(XsFactorBase):
