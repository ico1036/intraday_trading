"""xs_factor_rsi9d_fwd_c30 — auto-generated XS factor.

Signal: rsi_9d  direction=fwd  concentration=0.3
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_rsi_9d_fwd_c30",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorRsi9dFwdC30(XsFactorBase):
