"""is_302_ts_donchian_long_persist_r18_a1 — long-only persist Donchian (round 18)."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_long_persist_r18_a1",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_long_persist_r18_a1.md"]


class TsDonchianLongPersistR18A1Strategy:
