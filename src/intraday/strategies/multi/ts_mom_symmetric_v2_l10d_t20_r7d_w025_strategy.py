"""ts_mom_symmetric_v2_l10d_t20_r7d_w025 — TS-mom symmetric (v2), tuned position sizing."""
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "ts_mom_symmetric_v2_l10d_t20_r7d_w025",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_mom_symmetric.md"]


class TsMomSymmetricV2L10dT20R7dW025Strategy:
