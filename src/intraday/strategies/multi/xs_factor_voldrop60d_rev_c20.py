"""xs_factor_voldrop60d_rev_c20 — auto-generated XS factor.

Signal: vol_drop_60d  direction=rev  concentration=0.2
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_vol_drop_60d_rev_c20",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorVoldrop60dRevC20(XsFactorBase):
