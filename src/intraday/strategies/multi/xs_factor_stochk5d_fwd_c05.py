"""xs_factor_stochk5d_fwd_c05 — auto-generated XS factor.

Signal: stoch_k_5d  direction=fwd  concentration=0.05
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_stoch_k_5d_fwd_c05",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorStochk5dFwdC05(XsFactorBase):
