"""xs_factor_tradecountzscore20d_fwd_c50 — auto-generated XS factor.

Signal: trade_count_zscore_20d  direction=fwd  concentration=0.5
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_trade_count_zscore_20d_fwd_c50",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorTradecountzscore20dFwdC50(XsFactorBase):
