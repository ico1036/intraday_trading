"""is_964_ts_disp_low_long_lk4320_dp40_h21d — low-dispersion long basket."""
...
ALPHA_CELL = {
    ...
    "idea_family": "ts_disp_low_long_lk4320_dp40_h21d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_disp_low_long_lk4320_dp40_h21d.md"]


class TsDispLowLongLk4320Dp40H21DStrategy:
    def __init__(self, symbols, lookback=4320, disp_pct=0.4,
