"""xs_factor_distfromhigh252d_fwd_c20 — auto-generated XS factor.

Signal: dist_from_high_252d  direction=fwd  concentration=0.2
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_dist_from_high_252d_fwd_c20",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorDistfromhigh252dFwdC20(XsFactorBase):
