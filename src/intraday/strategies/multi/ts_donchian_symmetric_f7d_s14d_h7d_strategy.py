"""is_335_ts_donchian_symmetric_f7d_s14d_h7d — symmetric Donchian persist (long upper-break + short lower-break)."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_symmetric_f7d_s14d_h7d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_symmetric.md"]


class TsDonchianSymmetricF7dS14dH7dStrategy:
    def __init__(self, symbols, fast_channel_bars=10080, slow_channel_bars=20160,
                 rebalance_bars=240, hold_bars=10080, max_weight=0.2, **_):
