"""BB band fade basket percentile transform on z."""
...
class BbFadeBasketPctileStrategy:
    def __init__(self, symbols, lookback=120, k=1.5, history_size=30, pct=0.6, max_weight=0.13, **_):
