"""xs_factor_tradecountgrowth5d_rev_c50 — auto-generated XS factor.

Signal: trade_count_growth_5d  direction=rev  concentration=0.5
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_trade_count_growth_5d_rev_c50",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorTradecountgrowth5dRevC50(XsFactorBase):
