"""Session extreme revert multi_day topk ewma_residual."""
...
class SextMultidayTopkEwmaStrategy:
    def __init__(self, symbols, top_k=3, lookback_days=3, alpha=0.1, entry_thr=0.05, max_weight=0.25, **_):
