"""xs_factor_tradecount1d_rev_c10 — auto-generated XS factor.

Signal: trade_count_1d  direction=rev  concentration=0.1
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_trade_count_1d_rev_c10",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorTradecount1dRevC10(XsFactorBase):
