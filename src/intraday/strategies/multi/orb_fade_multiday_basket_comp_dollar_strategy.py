"""ORB-fade multi_day basket composite."""
...
class OrbFadeMultidayBasketCompDollarStrategy:
    def __init__(self, symbols, or_minutes=30, lookback_days=3, history_size=30, entry_thr=0.5,
                 max_weight=0.13, **_):
