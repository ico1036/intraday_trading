"""xs_factor_tradecountgrowth5d_fwd_c40 — auto-generated XS factor.

Signal: trade_count_growth_5d  direction=fwd  concentration=0.4
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_trade_count_growth_5d_fwd_c40",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorTradecountgrowth5dFwdC40(XsFactorBase):
