"""xs_factor_bouncefromlow60d_fwd_c10 — auto-generated XS factor.

Signal: bounce_from_low_60d  direction=fwd  concentration=0.1
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_bounce_from_low_60d_fwd_c10",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorBouncefromlow60dFwdC10(XsFactorBase):
