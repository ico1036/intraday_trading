"""is_108_ts_ensemble_trend_v5 — ensemble of 3 trend-filter slots."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_ensemble_trend_v5",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_ensemble_trend_v5.md"]

_SLOTS = [(2880, 14400, 4320), (4320, 14400, 7200), (7200, 14400, 10080)]  # list of (fast, slow, hold)


class TsEnsembleTrendV5Strategy:
