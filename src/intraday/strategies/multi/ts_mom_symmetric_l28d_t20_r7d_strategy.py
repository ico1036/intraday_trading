"""is_704_ts_mom_symmetric_l28d_t20_r7d — TS-mom symmetric: long if past 28d return > 2.0%, short if < -2.0%."""
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "ts_mom_symmetric_l28d_t20_r7d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_mom_symmetric.md"]


class TsMomSymmetricL28dT20R7dStrategy:
