"""is_576_xs_mom_rank_l21d_k1_r1d — cross-section past-21d return rank, long top-1 / short bottom-1."""
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_mom_rank_l21d_k1_r1d",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_mom_rank.md"]


class XsMomRankL21dK1R1dStrategy:
