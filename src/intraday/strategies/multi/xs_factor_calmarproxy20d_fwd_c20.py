"""xs_factor_calmarproxy20d_fwd_c20 — auto-generated XS factor.

Signal: calmar_proxy_20d  direction=fwd  concentration=0.2
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_calmar_proxy_20d_fwd_c20",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorCalmarproxy20dFwdC20(XsFactorBase):
