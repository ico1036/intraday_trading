"""xs_factor_drawdown60d_rev_c30 — auto-generated XS factor.

Signal: drawdown_60d  direction=rev  concentration=0.3
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_drawdown_60d_rev_c30",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorDrawdown60dRevC30(XsFactorBase):
