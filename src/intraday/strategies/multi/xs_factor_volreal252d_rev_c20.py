"""xs_factor_volreal252d_rev_c20 — auto-generated XS factor.

Signal: vol_real_252d  direction=rev  concentration=0.2
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_vol_real_252d_rev_c20",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorVolreal252dRevC20(XsFactorBase):
