"""xs_factor_logvolume_rev_c20 — auto-generated XS factor.

Signal: log_volume  direction=rev  concentration=0.2
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_log_volume_rev_c20",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorLogvolumeRevC20(XsFactorBase):
