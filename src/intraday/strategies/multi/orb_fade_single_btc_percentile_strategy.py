"""ORB-fade single BTC with percentile transform.

Cell transform/universe values both differ from is_023.
"""
...
class OrbFadeSingleBtcPercentileStrategy:
    def __init__(
        self,
        symbols: list[str],
        target: str = "BTCUSDT",
        ...
        **_: Any,
        ...
        self._mag_history: deque[float] = deque(maxlen=self.history_size)
