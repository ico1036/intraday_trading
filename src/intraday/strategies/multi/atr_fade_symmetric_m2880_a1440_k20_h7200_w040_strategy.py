"""atr_fade_symmetric_m2880_a1440_k20_h7200_w040 — ATR-channel fade symmetric (k=2.0 ATRs from EMA mean)."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "atr_fade_symmetric_m2880_a1440_k20_h7200_w040",
}
SOURCE_NOTES: list[str] = ["research/notes/atr_fade_symmetric.md"]


class AtrFadeSymmetricM2880A1440K20H7200W040Strategy:
    def __init__(self, symbols, mean_bars=2880, atr_bars=1440,
                 k_atr=2.0, rebalance_bars=60,
                 hold_bars=7200, max_weight=0.04, **_):
