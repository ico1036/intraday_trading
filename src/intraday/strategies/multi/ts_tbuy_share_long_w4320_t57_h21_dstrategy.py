"""is_734_ts_tbuy_share_long_w4320_t57_h21d — taker-buy volume fraction long."""
...
ALPHA_CELL = {
    ...
    "idea_family": "ts_tbuy_share_long_w4320_t57_h21d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_tbuy_share_long_w4320_t57_h21d.md"]


class TsTbuyShareLongW4320T57H21DStrategy:
    def __init__(self, symbols, window=4320, imb_threshold=0.58,
