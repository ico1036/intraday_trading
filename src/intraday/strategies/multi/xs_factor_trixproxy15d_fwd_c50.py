"""xs_factor_trixproxy15d_fwd_c50 — auto-generated XS factor.

Signal: trix_proxy_15d  direction=fwd  concentration=0.5
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_trix_proxy_15d_fwd_c50",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorTrixproxy15dFwdC50(XsFactorBase):
