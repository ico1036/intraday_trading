"""xs_factor_return84d_rev_c40 — auto-generated XS factor.

Signal: return_84d  direction=rev  concentration=0.4
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_return_84d_rev_c40",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorReturn84dRevC40(XsFactorBase):
