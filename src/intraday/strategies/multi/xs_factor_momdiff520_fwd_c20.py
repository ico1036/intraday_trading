"""xs_factor_momdiff520_fwd_c20 — auto-generated XS factor.

Signal: mom_diff_5_20  direction=fwd  concentration=0.2
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_mom_diff_5_20_fwd_c20",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorMomdiff520FwdC20(XsFactorBase):
