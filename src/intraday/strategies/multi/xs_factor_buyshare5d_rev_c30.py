"""xs_factor_buyshare5d_rev_c30 — auto-generated XS factor.

Signal: buy_share_5d  direction=rev  concentration=0.3
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_buy_share_5d_rev_c30",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorBuyshare5dRevC30(XsFactorBase):
