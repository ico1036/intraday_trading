"""xs_factor_return84d_fwd_c05 — auto-generated XS factor.

Signal: return_84d  direction=fwd  concentration=0.05
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_return_84d_fwd_c05",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorReturn84dFwdC05(XsFactorBase):
