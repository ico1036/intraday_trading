"""xs_factor_return2d_fwd_c20 — auto-generated XS factor.

Signal: return_2d  direction=fwd  concentration=0.2
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_return_2d_fwd_c20",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorReturn2dFwdC20(XsFactorBase):
