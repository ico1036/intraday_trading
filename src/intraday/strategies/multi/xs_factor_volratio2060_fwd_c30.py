"""xs_factor_volratio2060_fwd_c30 — auto-generated XS factor.

Signal: vol_ratio_20_60  direction=fwd  concentration=0.3
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_vol_ratio_20_60_fwd_c30",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorVolratio2060FwdC30(XsFactorBase):
