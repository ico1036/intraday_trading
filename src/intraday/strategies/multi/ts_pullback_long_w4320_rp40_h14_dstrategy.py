"""is_803_ts_pullback_long_w4320_rp40_h14d — pullback-in-uptrend long."""
...
ALPHA_CELL = {
    ...
    "idea_family": "ts_pullback_long_w4320_rp40_h14d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_pullback_long_w4320_rp40_h14d.md"]


class TsPullbackLongW4320Rp40H14DStrategy:
    def __init__(self, symbols, window=4320, range_pct=0.4,
