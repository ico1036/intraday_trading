"""xs_factor_streak5dsigned_rev_c40 — auto-generated XS factor.

Signal: streak_5d_signed  direction=rev  concentration=0.4
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_streak_5d_signed_rev_c40",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorStreak5dsignedRevC40(XsFactorBase):
