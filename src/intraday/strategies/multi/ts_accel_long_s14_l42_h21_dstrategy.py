"""is_634_ts_accel_long_s14_l42_h21d — return acceleration long."""
...
ALPHA_CELL = {
    ...
    "idea_family": "ts_accel_long_s14_l42_h21d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_accel_long_s14_l42_h21d.md"]


class TsAccelLongS14L42H21DStrategy:
    def __init__(self, symbols, short_window=20160, long_window=60480,
