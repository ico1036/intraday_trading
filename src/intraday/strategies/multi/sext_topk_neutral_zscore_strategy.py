"""Session extreme revert topk neutral_zone z_score."""
...
class SextTopkNeutralZscoreStrategy:
    def __init__(self, symbols, top_k=3, history_size=30, entry_z=0.3, neutral_band=0.4, max_weight=0.25, **_):
    ...
    def generate_order(self, state):
        ...
        if state.positions:
            for s, info in state.positions.items():
                ...
                cl, mid, sw = snap
                if abs(cl - mid) <= self.neutral_band * sw:
