"""ts_donchian_symmetric_v3_f1d_s18d_h35d_w045 — symmetric Donchian persist (v3 fine-tune around v2 working zone)."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_symmetric_v3_f1d_s18d_h35d_w045",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_symmetric.md"]


class TsDonchianSymmetricV3F1dS18dH35dW045Strategy:
    def __init__(self, symbols, fast_channel_bars=1440, slow_channel_bars=25920,
                 rebalance_bars=240, hold_bars=50400, max_weight=0.045, **_):
