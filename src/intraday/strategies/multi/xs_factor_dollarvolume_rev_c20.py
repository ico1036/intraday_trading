"""xs_factor_dollarvolume_rev_c20 — auto-generated XS factor.

Signal: dollar_volume  direction=rev  concentration=0.2
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_dollar_volume_rev_c20",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorDollarvolumeRevC20(XsFactorBase):
