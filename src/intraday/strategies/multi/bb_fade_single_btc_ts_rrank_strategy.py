"""BB-fade single BTC time_stop rolling_rank."""
...
class BbFadeSingleBtcTsRrankStrategy:
    def __init__(self, symbols, target="BTCUSDT", window=1440, history_size=30, rank_threshold=0.30, flat_at_minute=1410, rebalance_bars=60, max_weight=0.5, **_):
    ...
    def generate_order(self, state):
        ...
        if len(hist) >= 5:
            ...
            if rank < (1.0 - self.rank_threshold): return None
