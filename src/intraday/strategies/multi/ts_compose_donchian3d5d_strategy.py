"""is_056_ts_compose_donchian_3d5d — composite Donchian: enters only when fast AND slow channel agree."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_compose_donchian_3d5d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_compose_donchian_3d5d.md"]


class TsComposeDonchian3d5dStrategy:
    def __init__(self, symbols, fast_channel_bars=4320, slow_channel_bars=7200,
