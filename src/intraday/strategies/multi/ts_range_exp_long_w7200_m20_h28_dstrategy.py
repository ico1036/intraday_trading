"""is_709_ts_range_exp_long_w7200_m20_h28d — HL range expansion long."""
...
ALPHA_CELL = {
    ...
    "idea_family": "ts_range_exp_long_w7200_m20_h28d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_range_exp_long_w7200_m20_h28d.md"]


class TsRangeExpLongW7200M20H28DStrategy:
    def __init__(self, symbols, window=7200, mult=2.0,
