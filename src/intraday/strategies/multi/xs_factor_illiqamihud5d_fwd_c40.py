"""xs_factor_illiqamihud5d_fwd_c40 — auto-generated XS factor.

Signal: illiq_amihud_5d  direction=fwd  concentration=0.4
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_illiq_amihud_5d_fwd_c40",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorIlliqamihud5dFwdC40(XsFactorBase):
