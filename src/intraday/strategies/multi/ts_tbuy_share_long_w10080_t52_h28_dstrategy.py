"""is_737_ts_tbuy_share_long_w10080_t52_h28d — taker-buy volume fraction long."""
...
ALPHA_CELL = {
    ...
    "idea_family": "ts_tbuy_share_long_w10080_t52_h28d",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_tbuy_share_long_w10080_t52_h28d.md"]


class TsTbuyShareLongW10080T52H28DStrategy:
    def __init__(self, symbols, window=10080, imb_threshold=0.52,
