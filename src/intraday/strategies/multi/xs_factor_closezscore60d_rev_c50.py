"""xs_factor_closezscore60d_rev_c50 — auto-generated XS factor.

Signal: close_zscore_60d  direction=rev  concentration=0.5
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_close_zscore_60d_rev_c50",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorClosezscore60dRevC50(XsFactorBase):
