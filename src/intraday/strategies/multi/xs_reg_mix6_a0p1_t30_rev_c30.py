"""xs_reg_mix6_a0p1_t30_rev_c30 — auto-generated ridge cross-sectional regression alpha.

Features: ['ret1d', 'ret5d', 'ret20d', 'vol20d', 'rev_ma20', 'logvol']  ridge α=0.1  train window=30d
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_reg_mix6_a0p1_t30_rev_c30",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_regression_zoo.md"]


class XsRegMix6A0p1T30RevC30(XsRegressionBase):
