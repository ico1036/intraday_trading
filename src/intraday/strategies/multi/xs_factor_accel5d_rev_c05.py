"""xs_factor_accel5d_rev_c05 — auto-generated XS factor.

Signal: accel_5d  direction=rev  concentration=0.05
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_accel_5d_rev_c05",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorAccel5dRevC05(XsFactorBase):
