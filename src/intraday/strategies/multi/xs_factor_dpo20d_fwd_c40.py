"""xs_factor_dpo20d_fwd_c40 — auto-generated XS factor.

Signal: dpo_20d  direction=fwd  concentration=0.4
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_dpo_20d_fwd_c40",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorDpo20dFwdC40(XsFactorBase):
