"""is_027_ts_donchian_4week — Donchian breakout variant."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_4week",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_4week.md"]


class TsDonchian4weekStrategy:
    def __init__(self, symbols, channel_bars=40320, rebalance_bars=240, hold_bars=40320, max_weight=0.14, **_):
