"""xs_factor_tradecountlog1d_rev_c40 — auto-generated XS factor.

Signal: trade_count_log_1d  direction=rev  concentration=0.4
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_trade_count_log_1d_rev_c40",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorTradecountlog1dRevC40(XsFactorBase):
