"""Session extreme revert multi_day topk z_score."""
...
class SextMultidayTopkZscoreDollarStrategy:
    def __init__(self, symbols, top_k=3, lookback_days=3, history_size=30, entry_z=0.4, max_weight=0.25, **_):
