"""xs_factor_marefficiency20d_fwd_c40 — auto-generated XS factor.

Signal: mar_efficiency_20d  direction=fwd  concentration=0.4
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_mar_efficiency_20d_fwd_c40",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorMarefficiency20dFwdC40(XsFactorBase):
