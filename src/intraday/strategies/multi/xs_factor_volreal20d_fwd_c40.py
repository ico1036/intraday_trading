"""xs_factor_volreal20d_fwd_c40 — auto-generated XS factor.

Signal: vol_real_20d  direction=fwd  concentration=0.4
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_vol_real_20d_fwd_c40",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorVolreal20dFwdC40(XsFactorBase):
