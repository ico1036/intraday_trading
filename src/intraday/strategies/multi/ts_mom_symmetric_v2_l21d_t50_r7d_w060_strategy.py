"""ts_mom_symmetric_v2_l21d_t50_r7d_w060 — TS-mom symmetric (v2), tuned position sizing."""
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "ts_mom_symmetric_v2_l21d_t50_r7d_w060",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_mom_symmetric.md"]


class TsMomSymmetricV2L21dT50R7dW060Strategy:
