"""xs_factor_volzscore5d_fwd_c10 — auto-generated XS factor.

Signal: vol_zscore_5d  direction=fwd  concentration=0.1
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_vol_zscore_5d_fwd_c10",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorVolzscore5dFwdC10(XsFactorBase):
