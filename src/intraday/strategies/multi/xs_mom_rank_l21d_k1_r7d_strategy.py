"""is_578_xs_mom_rank_l21d_k1_r7d — cross-section past-21d return rank, long top-1 / short bottom-1."""
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_mom_rank_l21d_k1_r7d",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_mom_rank.md"]


class XsMomRankL21dK1R7dStrategy:
