"""ts_donchian_symmetric_v3_f4d_s16d_h63d_w030 — symmetric Donchian persist (v3 fine-tune around v2 working zone)."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_symmetric_v3_f4d_s16d_h63d_w030",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_symmetric.md"]


class TsDonchianSymmetricV3F4dS16dH63dW030Strategy:
    def __init__(self, symbols, fast_channel_bars=5760, slow_channel_bars=23040,
                 rebalance_bars=240, hold_bars=90720, max_weight=0.03, **_):
