"""Donchian fade session basket_full with z_score transform.

Cell transform differs from is_038 (raw → z_score). Z-score on break magnitude
relative to per-symbol break-magnitude history.
"""
...
class DonchianFadeBasketZscoreStrategy:
    def __init__(
        self,
        symbols: list[str],
