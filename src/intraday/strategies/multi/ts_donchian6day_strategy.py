"""is_029_ts_donchian_6day — Donchian breakout variant."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_6day",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_6day.md"]


class TsDonchian6dayStrategy:
    def __init__(self, symbols, channel_bars=8640, rebalance_bars=240, hold_bars=8640, max_weight=0.14, **_):
