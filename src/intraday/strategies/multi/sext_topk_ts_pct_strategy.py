"""Session extreme revert topk time_stop percentile."""
...
class SextTopkTsPctStrategy:
    def __init__(self, symbols, top_k=3, history_size=30, pct=0.5, max_weight=0.25, hold_bars=180, **_):
