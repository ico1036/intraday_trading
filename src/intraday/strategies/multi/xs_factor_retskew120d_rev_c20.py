"""xs_factor_retskew120d_rev_c20 — auto-generated XS factor.

Signal: ret_skew_120d  direction=rev  concentration=0.2
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_ret_skew_120d_rev_c20",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorRetskew120dRevC20(XsFactorBase):
