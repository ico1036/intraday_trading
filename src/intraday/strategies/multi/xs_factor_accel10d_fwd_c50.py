"""xs_factor_accel10d_fwd_c50 — auto-generated XS factor.

Signal: accel_10d  direction=fwd  concentration=0.5
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_accel_10d_fwd_c50",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorAccel10dFwdC50(XsFactorBase):
