"""is_109_ts_ensemble_trend_v6 — ensemble of 3 trend-filter slots."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_ensemble_trend_v6",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_ensemble_trend_v6.md"]

_SLOTS = [(4320, 20160, 5760), (4320, 20160, 7200), (4320, 20160, 10080)]  # list of (fast, slow, hold)


class TsEnsembleTrendV6Strategy:
