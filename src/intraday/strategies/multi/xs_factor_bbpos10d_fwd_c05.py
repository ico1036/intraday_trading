"""xs_factor_bbpos10d_fwd_c05 — auto-generated XS factor.

Signal: bb_pos_10d  direction=fwd  concentration=0.05
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_bb_pos_10d_fwd_c05",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorBbpos10dFwdC05(XsFactorBase):
