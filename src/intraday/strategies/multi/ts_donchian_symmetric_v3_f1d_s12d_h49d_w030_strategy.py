"""ts_donchian_symmetric_v3_f1d_s12d_h49d_w030 — symmetric Donchian persist (v3 fine-tune around v2 working zone)."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_symmetric_v3_f1d_s12d_h49d_w030",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_symmetric.md"]


class TsDonchianSymmetricV3F1dS12dH49dW030Strategy:
    def __init__(self, symbols, fast_channel_bars=1440, slow_channel_bars=17280,
                 rebalance_bars=240, hold_bars=70560, max_weight=0.03, **_):
