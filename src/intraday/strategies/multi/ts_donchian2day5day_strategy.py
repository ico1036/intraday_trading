"""is_046_ts_donchian_2day_5day — Donchian breakout asymmetric variant."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "ts_donchian_2day_5day",
}
SOURCE_NOTES: list[str] = ["research/notes/ts_donchian_2day_5day.md"]


class TsDonchian2day5dayStrategy:
    def __init__(self, symbols, channel_bars=2880, rebalance_bars=240, hold_bars=7200, max_weight=0.14, **_):
