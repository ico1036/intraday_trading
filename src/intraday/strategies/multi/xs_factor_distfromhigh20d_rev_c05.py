"""xs_factor_distfromhigh20d_rev_c05 — auto-generated XS factor.

Signal: dist_from_high_20d  direction=rev  concentration=0.05
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_dist_from_high_20d_rev_c05",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorDistfromhigh20dRevC05(XsFactorBase):
