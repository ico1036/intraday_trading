"""xs_factor_aroondown14d_rev_c20 — auto-generated XS factor.

Signal: aroon_down_14d  direction=rev  concentration=0.2
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_aroon_down_14d_rev_c20",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorAroondown14dRevC20(XsFactorBase):
