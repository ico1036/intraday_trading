"""xs_factor_mom121_fwd_c40 — auto-generated XS factor.

Signal: mom_12_1  direction=fwd  concentration=0.4
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_mom_12_1_fwd_c40",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorMom121FwdC40(XsFactorBase):
