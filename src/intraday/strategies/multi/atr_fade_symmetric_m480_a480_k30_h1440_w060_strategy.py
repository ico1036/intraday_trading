"""atr_fade_symmetric_m480_a480_k30_h1440_w060 — ATR-channel fade symmetric (k=3.0 ATRs from EMA mean)."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "atr_fade_symmetric_m480_a480_k30_h1440_w060",
}
SOURCE_NOTES: list[str] = ["research/notes/atr_fade_symmetric.md"]


class AtrFadeSymmetricM480A480K30H1440W060Strategy:
