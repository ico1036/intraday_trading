"""Session extreme revert multi_day basket ewma_residual."""
...
class SextMultidayBasketEwmaStrategy:
    def __init__(self, symbols, lookback_days=3, alpha=0.1, entry_thr=0.05, max_weight=0.13, **_):
