"""atr_fade_symmetric_m2880_a1440_k15_h1440_w060 — ATR-channel fade symmetric (k=1.5 ATRs from EMA mean)."""
...
ALPHA_CELL = {
    ...
    "exit": "time_stop",
    "idea_family": "atr_fade_symmetric_m2880_a1440_k15_h1440_w060",
}
SOURCE_NOTES: list[str] = ["research/notes/atr_fade_symmetric.md"]


class AtrFadeSymmetricM2880A1440K15H1440W060Strategy:
    def __init__(self, symbols, mean_bars=2880, atr_bars=1440,
                 k_atr=1.5, rebalance_bars=60,
                 hold_bars=1440, max_weight=0.06, **_):
