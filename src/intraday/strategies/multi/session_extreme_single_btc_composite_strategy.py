"""Session extreme revert single BTC composite."""
...
class SessionExtremeSingleBtcCompositeStrategy:
    def __init__(self, symbols, target="BTCUSDT", history_size=30, entry_thr=0.5, max_weight=0.5, **_):
