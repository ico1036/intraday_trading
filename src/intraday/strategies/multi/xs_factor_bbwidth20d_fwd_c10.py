"""xs_factor_bbwidth20d_fwd_c10 — auto-generated XS factor.

Signal: bb_width_20d  direction=fwd  concentration=0.1
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_bb_width_20d_fwd_c10",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorBbwidth20dFwdC10(XsFactorBase):
