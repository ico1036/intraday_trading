"""xs_factor_minlottery60d_rev_c10 — auto-generated XS factor.

Signal: min_lottery_60d  direction=rev  concentration=0.1
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_min_lottery_60d_rev_c10",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorMinlottery60dRevC10(XsFactorBase):
