"""xs_factor_eom5d_rev_c10 — auto-generated XS factor.

Signal: eom_5d  direction=rev  concentration=0.1
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_eom_5d_rev_c10",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorEom5dRevC10(XsFactorBase):
