"""is_618_xs_vs_btc_lk21d_r7d — basket top vs BTC spread."""
...
ALPHA_CELL = {
    ...
    "idea_family": "xs_vs_btc_lk21d_r7d",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_vs_btc_lk21d_r7d.md"]


class XsVsBtcLk21dR7dStrategy:
    def __init__(self, symbols, lookback_bars=30240, rebalance_bars=10080, max_weight=0.3, **_):
