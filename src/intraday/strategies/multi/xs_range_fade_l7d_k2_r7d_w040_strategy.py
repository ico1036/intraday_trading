"""xs_range_fade_l7d_k2_r7d_w040 — cross-section: rank by close position in N-day range, fade extremes."""
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_range_fade_l7d_k2_r7d_w040",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_range_position_fade.md"]


class XsRangeFadeL7dK2R7dW040Strategy:
    def __init__(self, symbols, lookback_bars=10080, rebalance_bars=10080,
