"""xs_factor_return252d_rev_c05 — auto-generated XS factor.

Signal: return_252d  direction=rev  concentration=0.05
...
ALPHA_CELL = {
    ...
    "exit": "signal_flip",
    "idea_family": "xs_factor_return_252d_rev_c05",
}
SOURCE_NOTES: list[str] = ["research/notes/xs_factor_zoo.md"]


class XsFactorReturn252dRevC05(XsFactorBase):
