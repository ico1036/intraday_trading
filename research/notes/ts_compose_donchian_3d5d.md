---
topic: ts_compose_donchian_3d5d
status: open
hypothesis: "Composite Donchian: enter only when fast (channel=4320m) AND slow (channel=7200m) channels agree on direction. Filters single-horizon noise."
