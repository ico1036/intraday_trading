---
topic: ts_zrevert_4h_1d
status: open
hypothesis: "Short-window extreme z-score mean reversion: window=240m, hold=1440m, rebalance=60m, entry_z=2.0. Many small-edge trades; targets N >> 500 with tight per-trade variance."
