---
topic: ts_donchian_trend_2d2week
status: open
hypothesis: "Donchian trend-filter: slow channel (20160m) sets regime, fast channel (2880m) provides entry triggers within that regime. Multiple re-entries during a slow trend → boost N while preserving per-trade quality."
