---
topic: ts_donchian_long_persist_3d14d_h28d_w04
status: open
hypothesis: "Long-only persist with very long hold (h28.0d): fewer cycles per regime → expected higher PF and tighter DD per-trade variance."
