---
topic: ts_zrevert_1d_60m
status: open
hypothesis: "Short-window extreme z-score mean reversion: window=1440m, hold=60m, rebalance=60m, entry_z=2.5. Many small-edge trades; targets N >> 500 with tight per-trade variance."
