---
topic: ts_donchian_long_persist_3d14d_h21d_w038
status: open
hypothesis: "Long-only persist h21d/h28d with reduced max_weight=0.038 — DD scales linearly so DD<12% achievable while preserving t-stat/PF."
