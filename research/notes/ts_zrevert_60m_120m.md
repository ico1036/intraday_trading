---
topic: ts_zrevert_60m_120m
status: open
hypothesis: "Short-window extreme z-score mean reversion: window=60m, hold=120m, rebalance=30m, entry_z=2.0. Many small-edge trades; targets N >> 500 with tight per-trade variance."
