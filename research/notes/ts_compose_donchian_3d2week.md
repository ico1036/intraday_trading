---
topic: ts_compose_donchian_3d2week
status: open
hypothesis: "Composite Donchian: enter only when fast (channel=4320m) AND slow (channel=20160m) channels agree on direction. Filters single-horizon noise."
