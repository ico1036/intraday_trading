---
topic: ts_compose_donchian_7d14d
status: open
hypothesis: "Composite Donchian: enter only when fast (channel=10080m) AND slow (channel=20160m) channels agree on direction. Filters single-horizon noise."
