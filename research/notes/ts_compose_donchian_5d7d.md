---
topic: ts_compose_donchian_5d7d
status: open
hypothesis: "Composite Donchian: enter only when fast (channel=7200m) AND slow (channel=10080m) channels agree on direction. Filters single-horizon noise."
