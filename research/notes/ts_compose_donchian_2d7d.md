---
topic: ts_compose_donchian_2d7d
status: open
hypothesis: "Composite Donchian: enter only when fast (channel=2880m) AND slow (channel=10080m) channels agree on direction. Filters single-horizon noise."
