---
topic: ts_ensemble_trend_v7
status: open
hypothesis: "Ensemble of 4 trend-filter slots, each with independent (fast, slow, hold). Slots aggregate into single per-symbol position; each slot adds entries → N multiplied without per-slot quality loss."
